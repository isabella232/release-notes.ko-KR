...
| [!UICONTROL 장치] 및 [!UICONTROL 지역] 차원 | 2020년 10월 30일 | [!UICONTROL 장치] 및 [!UICONTROL 지역] 차원은 이제 Adobe Analytics 원본 커넥터의 [전역 조회](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/global-lookups.html?lang=ko-KR#cja-usecases) 지원 프로젝트의 일부로 기본적으로 사용할 수 있습니다. 이렇게 많이 요청되는 추가는 [Adobe Analytics와 CJA 간의 패리티](https://docs.adobe.com/content/help/ko-KR/analytics-platform/using/cja-overview/cja-aa.html)를 증가시킵니다. |
