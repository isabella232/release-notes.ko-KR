...
# Adobe Experience Cloud 릴리스 노트 - 2021년 3월
...
2021년 2월 릴리스 - [Journey Orchestration 릴리스 노트](https://docs.adobe.com/content/help/ko-KR/journeys/using/release-notes/release-notes.html)의 최신 기능, 개선 사항 및 수정 사항에 대해 자세히 알아보십시오.
...
## ![아이콘](/assets/experience_platform_appicon_24.png) 오퍼 결정  {#offer-decisioning}

[!UICONTROL 오퍼 ] 결정은 Adobe Experience Platform과 통합된 응용 프로그램 서비스입니다. [!UICONTROL Offer decisioning]을 사용하여 모든 접점에서 적시에 고객에게 최상의 제안과 경험을 제공할 수 있습니다.

### 최신 제품 릴리스

2021년 2월 릴리스 - [Offer decisioning 릴리스 노트](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html?lang=en#new)의 최신 기능에 대한 자세한 내용을 살펴보십시오.

### offer decisioning에 대한 추가 리소스

[설명서](https://experienceleague.adobe.com/docs/offer-decisioning/using/offer-decisioning-home.html?lang=en)  -  [사용 방법 비디오](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/overview.html?lang=en)
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   Cloud Service의 새로운 기능은 무엇입니까?

   * **Experience Manager 사이트를 Cloud Service으로 저장**

      * [RemotePage 구성 요소](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html?lang=en):Experience Manager 내에서 외부 SPA을 보고 편집할 수 있도록 지원이 추가되었습니다.
   ...
   * **Cloud Service의 Experience Manager 상거래**
      ...
      * 최신 CIF 핵심 구성 요소 버전 1.8.0을 포함하는 CIF Venia 참조 사이트 - 2021.02.24. 자세한 내용은 [CIF Venia 참조 사이트 2021.02.24](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.02.24)을 참조하십시오.
      * CIF 핵심 구성 요소 버전 1.8.0. 자세한 내용은 [CIF 핵심 구성 요소 1.8.0](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.8.0)을 참조하십시오.
   * **Cloud Manager**

      * [IP 허용 목록](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/ip-allow-lists/check-ip-allow-list-status.html?lang=en#pre-existing-cdn), [SSL 인증서](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/manage-ssl-certificates/check-status-ssl-certificate.html?lang=en#pre-existing-cdn) 및 [사용자 지정 도메인 이름](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/custom-domain-names/check-domain-name-status.html?lang=en#pre-existing-cdn)에 대해 기존 사용자 지정 도메인 이름 구성을 가진 환경 고객은 이제 이전에 기존 구성에 대한 메시지를 볼 수 있습니다. 또한 유저 인터페이스를 통해 셀프 서비스를 제공할 수 있습니다.
      * 이제 필요한 권한을 가진 사용자는 셀프 서비스 방식으로 프로그램을 편집할 수 있습니다.
         * 자산 또는 반대로 기존 프로그램에 사이트 솔루션을 추가합니다.
         * 사이트와 자산이 모두 포함된 기존 프로그램에서 사이트 또는 자산을 제거합니다.
         * 사용하지 않은 두 번째 솔루션 권한을 기존 프로그램 또는 새 프로그램으로 추가합니다.
      * **이제** 파이프라인 실행과 활성화 화면 모두에 대해 AEM 푸시  *업데이트* 가능 ** 이 표시됩니다.
      * 환경이 최대 절전 모드이지만 사용 가능한 Experience Manager 업데이트가 있는 경우 **최대 절전 모드** 상태가 **사용 가능한 업데이트**&#x200B;보다 우선합니다.
      * 이제 사용자는 통합 셸의 사용자 프로필 아이콘(오른쪽 상단)으로 이동한 후 **클라우드 관리자 역할 보기**&#x200B;를 선택하여 클라우드 관리자 역할을 볼 수 있습니다.
      ...
      * 클래스 및 메서드 사용 중단 목록은 Experience Manager Cloud Service SDK의 `2021.3.4997.20210303T022849Z-210225` 버전을 기준으로 업데이트되었습니다.
      * 이제 클라우드 관리자 프로덕션 파이프라인에 [사용자 지정 UI 테스트](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/functional-testing.html?lang=en#custom-ui-testing) 기능이 포함됩니다.
...
* **Adobe Developers Live 2021 | 전체 세션 목록**
   ...
   [](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-developers-live-2021-complete-session-list/m-p/394595#M27875) 다음은  **Adobe 개발자 라이브에서 발생하는 모든 Experience Manager 세션의 집계 목록입니다**.

* **Adobe Summit 2021 | 전체 Experience Manager 세션 목록**

   [](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344) 다음은  **Adobe Summit 2021에서 발생하는 모든 Experience Manager 세션의 집계 목록입니다**.
...
| 2021년 2월 23일 | [제공 가능성 - 바운스 수](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/bounces.html) | Campaign Classic/표준 | 다양한 유형의 바운스에 대해 알아보기. |
| 2021년 2월 23일 | [배달 가능성 - 불만 사항](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/complaints.html) | Campaign Classic/표준 | 사용자가 이메일을 원하지 않거나 예상치 않은 경우 등록되는 컴플레인에 대해 알아봅니다. |
| 2021년 2월 23일 | [제공 가능성 - 스팸 트랩](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/spam-traps.html) | Campaign Classic/표준 | 다양한 유형의 바운스에 대해 알아보기. |
| 2021년 2월 23일 | [배달 가능성 - 불링 및 차단](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/bulking-and-blocking.html) | Campaign Classic/표준 | ISP가 이메일 메시지를 벌크 폴더로 이동하거나 차단하는 이유를 알아봅니다. |
...
| 2021년 3월 5일 | [멋진 그라디언트 및 Adobe Stock 에셋을 사용하여 일관된 브랜드 이미지 제작](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/brandgradients.html) | 비디오 | Adobe Stock용 편집 가능한 벡터가 포함된 애니메이션을 뉴스레터 그래픽으로 가져올 수 있습니다. |
| 2021년 3월 5일 | [Adobe Stock 및 Photoshop을 사용하여 이메일에 사용할 애니메이션 만들기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/animationemail.html) | 비디오 | Adobe Stock 및 Photoshop을 사용하면 중단 없는 애니메이션 기능으로 이메일을 더욱 돋보이게 할 수 있습니다. |
| 2021년 3월 5일 | [Adobe Stock 및 XD를 사용하여 인터랙티브한 관광 사진 만들기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/interactivetourismphoto.html) | 비디오 | Adobe Stock 및 XD를 사용하여 웹 사이트 프로토타입 내에서 인터랙티브한 사진을 신속하게 만들 수 있습니다. |
