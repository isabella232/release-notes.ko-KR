...
* [!DNL Analytics](#analytics) (**업데이트 날짜: 2020년 1월 21일**)
...
| 기능 | 설명 |
| -----------| ---------- |
| 분석 작업 공간 - 향상된 사용자 인터페이스 | 2020년 1월 16일, 분석 작업 공간은 몇 개월 동안 사용자 인터페이스가 개선되기 시작합니다. 이러한 변경 사항의 목표는 Adobe Experience Cloud에서 보다 일관성 있는 경험을 제공할 뿐만 아니라 사용자가 애플리케이션을 보다 쉽게 액세스할 수 있도록 하는 것입니다. |
