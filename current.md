...
* [!DNL Analytics](#analytics) (**업데이트 날짜: 2019년 11월 26일**)
...
도움말 홈을 찾고 계십니까? [Experience Cloud 학습 및 지원](https://helpx.adobe.com/kr/support/experience-cloud.html)을 참조하십시오.
...
* [Analytics 관리자에 대한 중요 공지](#aa-notices) (**업데이트 날짜: 2019년 11월 26일**)
* [AppMeasurement](#appm)
...
| -----------| ---------- | ---------- |
| 월 및 분기 차원 레이블로 업데이트 | 2019년 11월 26일 | 2020년 1월 16일에 월 및 분기 차원 레이블이 표준 달력 연도를 반영하도록 업데이트됩니다. 사용자 지정 달력 설정(**[!UICONTROL 관리&gt; 보고서 세트&gt; 설정 편집&gt; 일반**&#x200B;에서 정의됨)은 보고서에 반환되는 월을 계속 결정합니다.<br>예를 들어 2020년에 대한 사용자 지정 달력이 2019년 10월-2020년 9월로 정의된 경우에는 월 및 분기는 보고서에서 다음과 같이 표시됩니다.<ul><li>분기 - 2019년 10월-2019년 12월, 2020년 1월-2020년 3월, 2020년 4월-2020년 6월, 2020년 7월-2020년 9월</li><li>월 - 2019년 10월, 2019년 11월, 2019년 12월, 2020년 1월, 2020년 2월 등</li><li>이전에는 위의 모든 항목이 2019년을 반영하여 최종 사용자에게 혼란을 주었습니다.</li></ul>이러한 값을 찾는 보고서 필터 또는 세그먼트가 있는 경우 별도의 작업을 수행할 필요가 없습니다. 새 이름 지정 규칙을 반영하도록 업데이트됩니다. |
| **[!UICONTROL IP 로그인 제한 적용]** 옵션 EOL | 2019년 11월 21일 | **[!UICONTROL 관리자 &gt; 회사 설정 &gt; 보안]** 메뉴에서 IP 로그인 허용 목록(**[!UICONTROL IP 로그인 제한 적용]**) 기능에 대한 종료 날짜를 *2020년 10월*&#x200B;로 발표합니다. (원래 2020년 1월에 종료한다고 발표되었습니다.) |
...
* **AEM Forms 자동화된 변환 서비스**
   ...
   [Adobe Experience Manager Forms 자동화된 변환 서비스](https://docs.adobe.com/content/help/ko-KR/aem-forms-automated-conversion-service/table-of-contents/introduction.html)를 참조하십시오.
...
* Adobe Campaign Standard: [설명서](https://helpx.adobe.com/kr/support/campaign/standard.html) - [릴리스 노트](https://docs.adobe.com/content/help/ko-KR/campaign-standard/using/release-notes/release-notes.html) - [기능 비디오](https://docs.adobe.com/content/help/ko-KR/campaign-learn/campaign-standard-tutorials/overview.html) - [릴리스 계획](https://helpx.adobe.com/kr/campaign/kb/acs-release-planning.html)
* Adobe Campaign Classic: [설명서](https://helpx.adobe.com/kr/support/campaign/classic.html) - [릴리스 노트](https://docs.campaign.adobe.com/doc/AC/kr/RN.html) - [기능 비디오](https://docs.adobe.com/content/help/ko-KR/campaign-learn/campaign-classic-tutorials/overview.html)
