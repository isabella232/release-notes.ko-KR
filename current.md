...
# 2021년 8월 Adobe Experience Cloud 릴리스 노트 
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 8월 | [대상에 프로필 및 세그먼트 활성화](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-profiles-and-segments-to-a-destination.html?lang=en) | 비디오 | 마케터가 실시간 CDP에서 대상으로 대상 세그먼트를 활성화하는 데 필요한 단계를 알아봅니다. 가장 편리한 [!UICONTROL 대상] 또는 [!UICONTROL 세그먼트] 인터페이스에서 이 워크플로우를 시작하는 방법을 참조하십시오. |
| 2021년 8월 | [파일 기반 클라우드 스토리지 또는 이메일 마케팅 대상 구성](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html?lang=en) | 비디오 | Adobe의 실시간 CDP(Customer Data Platform)에서 파일 기반 대상을 구성하는 연습을 통해 팁을 얻을 수 있습니다. |
...
* 업데이트 날짜: 2021년 7월 - [Journey Orchestration 릴리스 노트](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en)

### 새로운 Journey Orchestration 자습서 및 교육 과정 {#tutorials-ajo}

Adobe Campaign에 대해 게시된 새로운 비디오, 자습서 또는 교육 과정
...
* **2021년 6월 릴리스:**  AI 등급을 사용하면 비즈니스 목표에 따라 다른 등급 전략을 생성할 수 있습니다. 이러한 전략은 숙련된 모델 시스템에서 주어진 프로필에 표시할 적합한 오퍼의 등급을 지정하는 데 사용할 수 있습니다.
...
* 가상 보고서 세트가 게시 목록 관리자에 표시되지 않던 문제를 수정했습니다. (AN-262683)
...
AppMeasurement 릴리스(버전 2.22.1)에 대한 최신 업데이트는 [AppMeasurement for JavaScript 릴리스 노트](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ko-KR)를 참조하십시오.
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 8월 | [ 산포도 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/scatterplot-visualization.html?lang=en) | 비디오 | 이 시각화를 사용하면 X/Y 플롯에서 항목을 그래프로 작성하면서 차원의 여러 지표 간의 관계를 볼 수 있습니다. 비즈니스 결정을 내리는 데 도움이 되는 이상치 및 통찰력을 살펴봅니다. |
| 2021년 8월 | [트리맵 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/treemap-visualization.html?lang=en) | 비디오 | Analysis Workspace 프로젝트에서 [!UICONTROL 트리맵] 시각화를 추가하고 구성하는 방법을 알아봅니다. 이 시각화는 많은 데이터 포인트를 한 번에 시각적으로 분석하는 데 도움이 될 수 있습니다. |
| 2021년 8월 | [데이터를 Analysis Workspace 프로젝트에 포함시키는 방법 이해](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/understanding-how-data-gets-into-your-analysis-workspace-project.html?lang=en) | 비디오 | Chrome에서 Adobe Experience Platform [!UICONTROL Debugger] 확장을 사용하여 페이지에서 Analysis Workspace의 표 및 시각화로의 데이터 흐름을 보는 방법을 알아봅니다. |
| 2021년 8월 | [요약 번호 및 요약 변경 사항 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/summary-number-and-summary-change-visualizations-2021.html?lang=en#) | 비디오 | Analysis Workspace에서 [!UICONTROL 요약 번호] 및 [!UICONTROL 요약 변경] 시각화를 추가하고 구성하는 방법을 알아봅니다. |
| 2021년 8월 | [Analysis Workspace의 벤 다이어그램 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/venn-diagram-visualization.html?lang=en) | 비디오 | 벤 다이어그램 시각화를 사용하여 Analysis Workspace에서 세그먼트의 겹치기 및 교차를 시각적으로 표시할 수 있습니다. 놀랍고 통찰력 있는 벤 다이어그램을 단 몇 초 만에 만드는 것은 쉽습니다. |
| 2021년 8월 | [Analysis Workspace의 글머리 기호 그래프 시각화](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/bullet-graph-visualization.html?lang=en) | 비디오 |  글머리 기호 그래프는 분석에서 목표를 향해 또는 그 이상을 진행하는 데 유용한 방법입니다. 조직의 성공을 시각화하는 다른 방법을 제공합니다. |
...
* [벌크 관리 도구](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html)를 사용하는 고객이 보고한 문제를 수정했습니다. 세그먼트-대상 매핑을 업데이트할 때 `traitAlias` 필드로 인해 고객이 오류가 발생했습니다. (AAM-58789)
* 데이터 피드에 대한 액세스가 취소되거나 취소될 때 발생하는 문제를 수정했습니다. 제거된 사용자에게 보낸 전자 메일에 **Bcc** 대신 **받는 사람** 필드에 수신자가 있었습니다. (AAM-58512)
...
* **Experience Manager as a Cloud Service**
   ...
   추가된 기능의 요약이 필요하면 [2021년 7월 릴리스 개요](https://video.tv.adobe.com/v/335580) 비디오를 재생하십시오.

   * **[!UICONTROL Cloud Acceleration Manager]**

      * [!UICONTROL Cloud Acceleration ] Manager는 Cloud Service에서 시작하여 전환 여정 전반에 걸쳐 IT 팀을 안내하도록 설계된 클라우드 기반 애플리케이션입니다. Adobe 권장 우수 사례, 팁, 설명서 및 도구를 사용하여 여정의 모든 단계에서 Cloud Service으로 Experience Manager하는 데 도움이 되도록 성공적인 마이그레이션을 위해 팀을 설정하십시오. [Cloud Acceleration Manager 시작](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-acceleration-manager/using-cam/getting-started-cam.html?lang=en)을 참조하십시오.
      [Cloud Acceleration Manager](https://video.tv.adobe.com/v/335547) 데모 비디오를 재생합니다.

   * **Experience Manager as a Cloud Service 기반**

      * 보다 유연한 [!UICONTROL Dispatcher] 구성: 프로젝트를 보다 쉽게 구성할 수 있습니다. 예를 들어 사이트 구조를 반영하는 여러 재작성 규칙 파일을 포함할 수 있습니다. [Dispatcher 구성을](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/content-delivery/disp-overview.html?lang=en#validation-debug) 활용하여 구성하는 방법을 비롯하여 이 유연한 모드에 대해 알아보십시오.
      * 복제 에이전트의 [!UICONTROL 분배] 탭 아래에 있는 트리 복제 UI는 더 이상 사용되지 않는 것으로 간주되어야 합니다. 이 디자이너는 2021년 9월 30일 이후에 제거될 예정입니다. [대체 복제 전략에 대해 알아봅니다](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=en#tree-activation).
      * Sling 데이터 소스 지원용 `org.apache.sling.datasource-1.0.4.jar` 번들은 오래된 기능이며 고객이 사용하지 않으므로 제거되었습니다.
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Experience Manager 자산에는 기본적으로 PDF 문서를 미리 보기 위한 Document Cloud PDF 뷰어가 포함되어 있습니다. 이 기능을 사용하면 파일 처리나 변환 없이 다중 페이지 PDF 파일을 미리 볼 수 있습니다. 또한 Experience Manager 6.5와의 패리티를 개선합니다. 뷰어에서 사용할 수 있는 컨트롤에는 확대/축소, 페이지로 이동, 컨트롤 도킹 해제 및 전체 화면 보기가 포함됩니다. 사용자는 페이지 및 책갈피를 미리 보고 이동할 수도 있습니다. 파일 자체에 대한 주석이 지원되며 PDF 파일 내의 컨텐츠에 대한 주석 및 주석이 향후 릴리스에서 추가됩니다.
      * 링크 공유 다운로드 기능은 다운로드 속도를 높이는 비동기 다운로드를 사용합니다. 도움말 항목 [링크 공유를 사용하여 공유된 자산 다운로드](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/download-assets-from-aem.html?lang=ko-KR#link-share-download)를 참조하십시오.
      * 보기 설정이 개선되어 사용자가 기본 보기와 기본 정렬 매개 변수를 선택할 수 있습니다.
      * 사용자는 속성 설명을 기반으로 폴더를 검색하고 필터링할 수 있습니다.

      Assets 사전 릴리스 채널에서 사용할 수 있는 새로운 기능
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * 적응형 양식 구성 요소와 관련된 오류를 표시하는 별도의 패널을 템플릿 편집기에 추가했습니다. 모든 적응형 양식 오류를 한 위치에서 통합하고 해결 시간을 줄이는 데 도움이 됩니다.
      ...
      Forms 사전 릴리스 채널에서 사용할 수 있는 새로운 기능

      * **Forms을 Cloud Service으로 Experience Manager - 커뮤니케이션**  -  [AEM Forms을 Cloud Service으로 사용 - XDP 템플릿과 XML ](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/aem-forms-cloud-service-communications.html?lang=en) 데이터를 결합하여 다양한 형식으로 인쇄 문서를 생성합니다. 이 서비스를 사용하면 동기화 모드에서 문서를 생성할 수 있습니다. API를 사용하면 다음과 같은 기능을 제공하는 애플리케이션을 만들 수 있습니다.
         * XML 데이터로 템플릿 파일을 채워 문서를 생성합니다.
         * 비대화형 PDF 인쇄 스트림을 포함하여 다양한 형식의 출력 양식을 생성합니다.
         * XFA 양식 PDF 및 Adobe Acrobat 양식에서 인쇄 PDF 파일을 생성합니다.
      * **[!UICONTROL Variable Data Externalizer]**  - 조직에서 관리하는 외부 스토리지 시스템에 Experience Manager Workflow 변수의 데이터를 저장할 수 있습니다.
      * **[!UICONTROL Acroform 기반 레코드 문서]**  - XFA 기반 양식 템플릿 외에 Adobe Acrobat 양식 PDF(Acroform PDF) [를 기록 문서 템플릿으로 ](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/create-an-adaptive-form/generate-document-of-record-for-non-xfa-based-adaptive-forms.html?lang=en) 사용할 수도 있습니다.
         **Microsoft® Azure 데이터 저장소 커넥터**  - 이제 양식 데이터 모델을 Microsoft® Azure 저장소에  [연결할 수 있습니다](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/use-form-data-model/configure-azure-storage.html?lang=en). 적응형 양식 데이터를 검색하고 BLOB으로 Microsoft® Azure 저장소에 저장할 수 있습니다.
   * **[!UICONTROL Cloud Manager]**

      * 이제 고객은 [!UICONTROL Cloud Manager] 빌드 프로세스에 Azul 8 및 11개의 JDK를 사용할 수 있습니다. 도구 체인 호환 Maven 플러그인 또는 전체 Maven 프로세스 실행에 이러한 JDK 중 하나를 사용하도록 선택할 수 있습니다.
      * 이제 아웃바운드 송신 IP가 빌드 단계 로그 파일에 기록됩니다.
      * 이전 버전의 Experience Manager을 실행하는 단계 및 프로덕션 환경에서는 **Update Available** 상태를 보고합니다.
      * 지원되는 최대 SSL 인증서는 프로그램당 20개로 증가했습니다.
      * 구성할 수 있는 최대 도메인 수가 환경당 500개로 늘어났습니다.
      * **[!UICONTROL Git]** 관리 단추가 **[!UICONTROL Access Git Info]**&#x200B;로 변경되었으며 대화 상자가 시각적으로 새로 고침되었습니다.
      * Cloud Manager에서 사용하는 Experience Manager 프로젝트 원형 버전이 버전 28로 업데이트되었습니다.
...
* [Experience League의 최신 Adobe Experience Manager 콘텐츠 목록 | 2021년 8월](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/list-of-latest-adobe-experience-manager-content-on-experience/m-p/418396/thread-id/29620)
   ...
   최신 문서의 전체 목록은 [여기](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/list-of-latest-adobe-experience-manager-content-on-experience/m-p/418396/thread-id/29620)입니다.
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 8월 | [Adobe Asset Link 3.0](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/adobe-asset-link.html?lang=en) | 비디오 | [!UICONTROL Adobe Creative Cloud for enterprise] 용 Asset Linkextension은 Creative Cloud 애플리케이션 내에서 Experience Manager 자산의 메타데이터를 검색 및 탐색, 정렬, 미리 보기, 업로드, 체크아웃, 수정, 체크인 및 볼 수 있는 기능을 확장합니다. |
| 2021년 8월 | [Assets Essentials](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/managing.html?lang=en) | 비디오 | 폴더 구조, 이동, 복사 및 이름 변경과 같은 기본 작업 등 Asset Essentials에 대해 알아봅니다. 새 비디오에는 [assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/using.html?lang=en), [컨텐츠](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/creating.html?lang=en) 및 [주석, 작업 등을 사용하여 자산 관리에 공동 작업하는 방법도 포함됩니다.](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/creating.html?lang=en) |
| 2021년 8월 | [Assets Essentials](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/using.html?lang=en) | 비디오 | Assets Essentials에서 자산을 필터링, 검색 및 다운로드하는 방법을 학습합니다. |
| 2021년 8월 | [파이프라인 개요 - 투어 안내서](https://video.tv.adobe.com/v/335668) | 비디오 | AEM as a Cloud Service [!UICONTROL Cloud Manager 파이프라인]에 대한 개요를 살펴보십시오. |
| 2021년 8월 | [파이프라인 구성 및 실행 - 투어 안내서](https://video.tv.adobe.com/v/335667) | 비디오 | 파이프라인을 구성하고 실행하는 방법을 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 8월 | [사용 사례 레서피](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/recipes.html) | 비디오 | 이러한 정부 및 상용 전자 서명 예를 사용하여 조직의 디지털 워크플로우를 가속화합니다. |
| 2021년 8월 | [사용 사례 쇼케이스](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/use-case/use-case-showcase.html) | 기록된 세션 | 사용 사례 쇼케이스는 새로운 Adobe Sign 사용 사례, 트렌드를 소개합니다. 또한 조직이 이를 구현하고 이를 통해 얻을 수 있는 이점을 보여주는 라이브 스트리밍 세트입니다. 매달 새 주제가 강조 표시됩니다. |
| 2021년 8월 | [Adobe Sign Skill Builder](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/innovation/innovation-series.html) | 기록된 세션 | Adobe Sign Skill Builder는 30분 동안 별도의 작업을 추가하지 않고도 전자 서명을 사용할 수 있도록 설계되었습니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| ----------| --------- | --------- | --------- |
| 2021년 8월 | [Adobe Stock 라이선스 내역 검색](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/searchstock.html) | 비디오 | Creative Cloud for enterprise에서 조직의 Adobe Stock 라이선스 내역을 빠르게 검색하는 방법을 알아봅니다. |
| 2021년 8월 | [팀을 위한 Creative Cloud 라이브러리와 브랜딩 자산 공유](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/cceoverview/ccetutorials/sharecclibraries.html) | 비디오 | 팀용 Creative Cloud 라이브러리를 사용하여 그룹 또는 팀을 위한 브랜딩 자산을 생성, 사용 및 공유하는 방법을 알아봅니다. |
| 2021년 8월 | [팀을 위한 Creative Cloud 라이브러리 만들기](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/cceoverview/ccetutorials/ccteamlibraries.html) | 비디오 | 팀을 위한 Creative Cloud 라이브러리를 사용하여 그룹 또는 팀 내에서 자산을 공유하는 방법을 알아봅니다. |
| 2021년 8월 | [Adobe Acrobat Skill Builder 웨비나](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/skill-builders/skill-builder-webinars.html) | 웨비나 | Adobe Acrobat Skill Builder는 PDf 워크플로우를 한 단계 향상시키도록 디자인된 30분 세션입니다. 매달 새 주제가 강조 표시됩니다. |
