---
title: Adobe Experience Cloud 기술 설명서 릴리스 정보
description: 2019 년 7 월 Experience Cloud Tech DOC 릴리스 노트
doc-type: 릴리스 노트
...
| 구성 요소 | 설명 |
| -----------| ---------- |   
| Analysis Workspace - Cohort Analysis 개선 사항 | New [Cohort Analysis settings](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/cohort-table/t-cohort.html) have been added: <ul><li>백분율만 표시</li><li>백분율 반올림</li><li>평균 백분율 행 표시</li></ul> |
