...
* [!DNL Analytics](#analytics) (**2019년 8월 12일** 업데이트됨)
...
* [AppMeasurement](#appm) (**2019년 8월 12일 업데이트됨**)
...
| 기여도 IQ에 대해 A4T 활동 노출 횟수 및 활동 전환율이 활성화됨 | 기여도 IQ에 대해 두 개의 A4T(Analytics for Target) 지표(활동 노출 횟수 및 활동 전환율)를 활성화했습니다. 현재까지 Analysis Workspace에서 이러한 지표는 Reports &amp; Analytics와 비교하여 부풀려졌습니다. 이러한 변화를 통해 사용자는 이제 "동일한 터치" 기여도 모델을 적용할 수 있으므로 Reports &amp; Analytics와 함께 Analysis Workspace를 가져오게 됩니다. |
...
2019년 8월 15일 [!UICONTROL AppMeasurement] 2.16.0 릴리스(이전에 표시된 대로 8월 8일 아님)
...
Digital Publishing Suite Classic(DPSC)은 2019년 8월 31일에 사용이 종료됩니다. 자세한 내용은 [Digital Publishing Suite Classic 사용 종료 FAQ](https://helpx.adobe.com/digital-publishing-suite/help/eol-statement-for-dpsc.html)를 참조하십시오.
...
[새 제어판 기능](https://helpx.adobe.com/kr/campaign/kb/control-panel-instance-settings.html)에는 데이터/파일 전송을 위해 Campaign Classic이 연결되는 URL을 추가하는 기능이 포함되어 있습니다.
