...
| 기능 | 설명 |
| -----------| ---------- |  
| SameSite 쿠키 설정 지원 | [SameSite 쿠키 설정](https://web.dev/samesite-cookies-explained)이 Analytics에서 설정된 모든 쿠키 집합에 추가됩니다. 이 변경 사항에 따라 SameSite 쿠키 필드를 요구하는 Chrome 변경 사항을 준수하게 됩니다. Analytics 쿠키는 기본적으로 `none`(으)로 설정됩니다. 자사 도메인(예: status.domain.com)을 독점적으로 사용하는 경우, Adobe 고객 지원 센터를 자사 수집 도메인에 대해 `lax`(으)로 설정할 수 있습니다. |
...
2019년 8월 23일에 [!UICONTROL AppMeasurement] 2.17.0이 출시됩니다.
...
2019년 8월 8일에 [!UICONTROL AppMeasurement] 2.16.0이 출시됩니다.
