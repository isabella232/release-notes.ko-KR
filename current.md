...
# 조기 액세스 - Adobe Experience Cloud 릴리스 노트 - 2020년 4월
...
| 기능 | 설명 |
| -----------| ---------- |
| [!UICONTROL Customer Journey Analytics]: [!UICONTROL 자동화된 데이터 세트 채우기] | 이 새 옵션을 사용하면 [!UICONTROL Customer Journey Analytics]에서 연결에 대한 모든 이전 데이터를 가져올 수 있습니다. (참조할 설명서) |
