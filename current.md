...
| 공지 | 추가 또는 업데이트 날짜 | 설명 |
| -----------| ---------- | ---------- |
| &quot;Data Warehouse에서 적용된 세그먼트&quot; 확인 제거됨 | 2020년 4월 16일 | 2020년 4월 16일부터 세그먼트 빌더 내에서 세그먼트가 Data Warehouse 요청에서 적용되었는지 확인하지 않습니다. 이전에는 해당 확인이 Data Warehouse 요청에서 적용된 단일 세그먼트를 검색했으며(적용된 여러 세그먼트 제외함), true면 경고 알림을 반환했습니다. 변경 사항은 세그먼트에 대한 Data Warehouse 제품 호환성 확인에 영향을 주지 않습니다. |
