...
* [!DNL Analytics](#analytics) (2019 년 **8 월 12 일 업데이트됨**)
...
[!UICONTROL 2019 년 8 월 15 일 (8 월 8 일이 아닌 8 월 15 일) 에 Appmeasurement] 2.16.0 릴리스.
...
Digital Publishing Suite Classic (DPSC) 는 2019 년 8 월 31 일에 사용이 종료됩니다. 자세한 내용은 [Digital Publishing Suite Classic의 사용 종료 FAQ](https://helpx.adobe.com/digital-publishing-suite/help/eol-statement-for-dpsc.html)를 참조하십시오.
...
업데이트 날짜: 2019년 8월 9일(2017년 8월 10일 릴리스용)

* (Advertising Cloud Conversion Tracking Service를 사용하는 광고주) 5 월에 출시된 Apple의 Intelligent Tracking Prevention (ITP) 2.2를 사용하면 24 시간 후에 Apple Safari 브라우저에서 자동으로 Advertising Cloud 전환 추적 쿠키가 삭제됩니다. 그러나 Advertising Cloud 에는 새로운 ITP 솔루션이 포함되어 있으므로 원본 클릭 후 24 시간 동안 Safari 내에서 발생하는 전환을 추적할 수 있습니다. 이 솔루션은 로컬 저장소 및 iframe 기술을 사용합니다. 구현 지침은 Advertising Cloud Search 계정 관리자에게 문의하십시오.
* 이제 검색 &gt; 고급 (ACM) 에서 Google 텍스트 광고 및 쇼핑 광고 템플릿을 위한 캠페인 수준 최종 URL 접미어를 구성할 수 있습니다.
* Google 광고 계정이 있는 Google 광고 계정이 있는 광고주는 이제 다음을 수행할 수 있습니다.
   * Adobe 고객 세그먼트의 사용자 ID를 사용하여 Google 광고 고객 일치 대상을 만듭니다. 이 기능을 보려면 광고주 계정을 허용하도록 구성해야 합니다.
   * 고객 데이터 파일을 업로드하여 Google 광고 고객 일치 대상을 만듭니다. 파일은 연락처 정보 (이메일 주소, 우편 주소 또는 전화 번호), 사용자 ID 또는 모바일 장치 ID로 구성될 수 있습니다. 일부 유형의 연락처 정보는 SHA -256 알고리즘을 사용하여 해시해야 합니다.
   * Adobe 대상에서 만든 대상을 제외한 모든 Google 고객 일치 대상을 업데이트합니다. 추가, 삭제 또는 대상에 대한 기존 데이터를 모두 대체하도록 데이터를 업로드할 수 있습니다. 모든 연락처 정보는 SHA -256 알고리즘을 사용하여 해시해야 합니다.
* 대상 &gt; 타겟 및 대상 &gt; 제외 보기에는 "유형" 열이 포함됩니다.
