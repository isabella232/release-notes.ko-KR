...
| DIL 9.3 | Audience Manager 모듈을 DIL 9.3으로 업데이트했습니다. |
...
[새로운 제어판 기능에는](https://helpx.adobe.com/campaign/kb/control-panel-instance-settings.html) Campaign Classic에서 데이터/파일 전송을 위해 연결하는 URL을 추가하는 기능이 포함됩니다.
