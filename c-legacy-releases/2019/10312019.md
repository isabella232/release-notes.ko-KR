...
| 모바일 브라우저 버전 번호 | 2019년 2월 7일 | 2019년 1월 8일부터 모바일 브라우저 버전 번호의 잘라내기 수준이 2에서 1로 변경되었습니다. 이후 버전에는 처음 두 수준(예: Firefox 64.0.2 _가_ 이제 Firefox 64.0 _으로_&#x200B;보고됨)만 표시됩니다. |
