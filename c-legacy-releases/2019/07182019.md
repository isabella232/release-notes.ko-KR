...
# Adobe Experience Cloud 릴리스 노트 - 2019 년 7 월
...
누적 릴리스 노트는 [Experience Cloud ID 서비스를](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) 참조하십시오.
...
AEM 6.5 clientlibs 캐시 무효화에 대한 중요한 AEM 패치 기능은 [AEM 6.5.1.0 업데이트](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) 또는 이 [기술 자료 아티클에서 사용할 수](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)있습니다.
