...
누적 [릴리스 노트는 Experience](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) Cloud ID Service를 참조하십시오.
...
AEM 6.5 clientlibs 캐시 무효화에 대한 중요한 AEM 패치는 AEM 6.5. [1.0 업데이트](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) 또는 이 KB 문서를 [통해 사용할](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)수 있습니다.
