...
| 보호, 견고성 및 확장성 | 일련의 향상된 기능이 Campaign Classic에 추가되었습니다. Guardrail, robustness and scalability improvements are listed in [Campaign Classic Release Notes](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
