...
| 보호, 견고성 및 확장성 | 일련의 향상된 기능이 Campaign Classic에 추가되었습니다. 보호, 견고성 및 확장성 개선사항은 [Campaign Classic 릴리스 노트](https://docs.campaign.adobe.com/doc/AC/ko/RN.html)에 나열되어 있습니다. |
