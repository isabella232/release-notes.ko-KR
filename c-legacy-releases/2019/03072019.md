...
| 중국 지역 가속 | 이제 Analytics 보고서 세트 설정에서 중국 가속 옵션을 사용할 수 있습니다. 이 옵션을 사용하면 중국 본토 사용자의 Adobe Analytics 보고 사용자 환경이 개선됩니다. 각 Adobe Analytics 사용자는 이 옵션을 활성화하거나 비활성화할 수 있습니다. 성능에 부정적인 영향을 미치기 때문에 중국 본토 이외의 사용자를 위해 이 옵션을 선택하지 마십시오. [자세히](https://marketing.adobe.com/resources/help/ko_KR/sc/user/report_settings.html) |
...
* Analytics의 (마이그레이션된) 사용자 성/이름이 Experience Cloud의 사용자 Adobe ID에 연결된 이름과 다른 문제가 해결되었습니다. Analytics 이름을 Experience Cloud의 이름으로 업데이트하려면 **[!UICONTROL 관리자** > **!UICONTROL 사용자 관리(레거시)**>**!UICONTROL 사용자 편집**&#x200B;으로 이동하고 사용자 ID를 클릭하십시오. 그런 다음 **!UICONTROL Experience Cloud에서 업데이트를 클릭합니다&#x200B;**. (AN-172825)
...
| Ad Hoc Analysis 수명 종료 | 업데이트 날짜: 2019년 1월 29일 | 2018년 8월 6일, Adobe는 애드혹 분석을 종료할 계획을 발표했습니다. 수명 종료 날짜는 확정된 후 공유될 예정입니다.<br/>이 기간 동안의 Java 호환 버전 등 자세한 정보는 [Discover Workspace](https://adobe.ly/discoverworkspace)를 참조하십시오. |
...
| Ad Hoc Analysis 수명 종료 | 2018년 9월 8일 | 2018년 8월 6일, Adobe는 애드혹 분석을 종료할 계획을 발표했습니다. 수명 종료 날짜는 확정된 후 공유될 예정입니다. 자세한 내용은 [Discover Workspace](https://spark.adobe.com/page/S9Bhp66VJ2fEn/)를 참조하십시오. 이제부터 Java 9+ 지원을 위해 [!UICONTROL Ad Hoc Analysis]를 수정하지 않습니다. Java 9+로 업그레이드하면 [!UICONTROL Ad Hoc Analysis]가 작동 중지됩니다. Java 8만 지원됩니다. |
...
이 릴리스에는 Adobe Experience Platform Launch 및 Mobile SDK에서 일반적인 사용 가능한 Android(GA) 버전 및 Adobe Campaign Standard용 iOS 익스텐션과 Adobe Campaign의 통합이 포함되어 있습니다. 이러한 익스텐션은 푸시 메시지, 인앱 메시지 및 모바일 앱 프로필 업데이트를 지원합니다.
...
자세한 내용은 [AEM Assets 브랜드 포털](https://helpx.adobe.com/kr/experience-manager/brand-portal/using/whats-new.html) 및 릴리스 노트의 새로운 [기능을 참조하십시오](https://helpx.adobe.com/kr/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html).
