...
| **Ad Hoc Analysis:** Java 11과의 호환성 | Ad Hoc Analysis는 이제 Java 11과 호환됩니다. Learn how to run [Ad Hoc Analysis on Java 11](https://marketing.adobe.com/resources/help/en_US/dsc/adhoc-java.html). |
| **데이터 수집:** 새 s_ecid 쿠키 | Added a new [first-party server cookie](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor's ECID. |
...
* [!DNL Campaign Classic] 18.10.4 - 빌드 8983
* [!DNL Campaign Classic] 18.10.5 - 빌드 8984
