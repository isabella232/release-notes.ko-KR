...
* [!DNL Experience Platform]에 대한 최신 업데이트를 보려면 Adobe.io에서 [[!DNL Experience Platform] 릴리스 노트](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md)를 참조하십시오.

### Experience Platform Launch

* 최신 정보는 [[!DNL Experience Platform Launch]](https://docs.adobelaunch.com/)를 참조하십시오.
...
| **Analysis Workspace:** 새로 생성 _반복 인스턴스 포함_ 흐름 시각화 설정 | _반복 인스턴스 포함_ 흐름 설정은 페이지 다시 로드와 같은 반복된 인스턴스를 포함하거나 제외하는 옵션을 제공합니다. 또한 모든 흐름 시각화는 이제 인스턴스만 기반으로 합니다. |
| **Ad Hoc Analysis:** Java 11과의 호환성 | Ad Hoc Analysis는 이제 Java 11과 호환됩니다. [Java 11에서 Ad Hoc Analysis](https://marketing.adobe.com/resources/help/ko_KR/dsc/adhoc-java.html)를 실행하는 방법을 알아봅니다. |
| **데이터 수집:** 새 s_ecid 쿠키 | 데이터 수집이 방문자 ECID를 저장하는 새 [자사 서버 쿠키](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html) s_ecid를 추가했습니다. |
...
| 기능 | 설명 |
| -----------| ---------- |  
| [IP 주소 난독 처리](https://marketing.adobe.com/resources/help/ko_KR/aam/ip-obfuscation.html) | 회사에서 글로벌 개인 정보 보호 규정으로 인해 여러 국가의 IP 주소를 난독 처리하려고 할 수 있습니다. Audience Manager를 사용하면 글로벌 또는 국가별로 방문자 IP 주소를 난독 처리할 수 있습니다. |
| [사용자 지정 파트너 통합 - Oracle Data Cloud](https://marketing.adobe.com/resources/help/ko_KR/aam/custom-partner-integrations.html) | 이 페이지에 Audience Manager와 데이터 파트너 간의 사용자 지정 통합 목록이 표시됩니다. Audience Manager는 인바운드 데이터 파일을 통해 Oracle Data Cloud for Audience Marketplace의 쿠키 및 모바일 ID 데이터를 통합합니다. 이 페이지에 설명된 사용자 지정 통합 사양은 모바일 ID(IDFA 및 Android 장치 ID)가 포함된 인바운드 데이터 파일만을 참조합니다. |
...
* [Cloud Manager 2019.4.0의 릴리스 노트](https://docs.adobe.com/content/help/en/experience-manager-cloud-manager/using/release-notes/release-notes-current.html)
...
[AEM Forms 릴리스](https://helpx.adobe.com/kr/aem-forms/kb/aem-forms-releases.html)
...
자세한 내용은 [Amazon S3용 AWS 서명 버전 2 사용 중단의 영향](을 참조하십시오.https://helpx.adobe.com/kr/experience-manager/kb/the-impact-of-aws-signature-version-2-deprecation-for-amazon-s3.html)
...
[AEM RTE(리치 텍스트 편집기) 자세히 알아보기](를 참조하십시오.https://helpx.adobe.com/kr/experience-manager/kt/eseminars/gems/AEM-Rich-Text-Editor-RTE-Deep-Dive1.html)
...
오픈 소스 및 상용 버전 모두의 릴리스 노트는 [릴리스 노트](https://devdocs.magento.com/guides/v2.3/release-notes/bk-release-notes.html) 페이지에 있습니다.
