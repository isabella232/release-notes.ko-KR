...
| **데이터 수집:** 새 s_ecid 쿠키 | 데이터 수집에서 방문자의 ECID를 저장하는 새로운 자사 서버 쿠키인 s_ecid가 추가되었습니다. |
