...
| 기능 | 설명 |
| -----------| ---------- |  
| 고유 개수에 대한 세그멘테이션 | 이제 차원 내에서 항목의 고유 개수를 세그먼트화할 수 있습니다. 예: "5개 이상의 고유 제품을 본 방문자" 또는 "5개 이상의 고유 페이지를 본 방문 위치" (차원의 고유 카운트(예: 고객 수, 제품 수 등)인 지표를 만들려는 경우 계산된 지표에서 대략적인 카운트 고유 기능을 계속 사용할 수 있습니다.) |
| Java 11에 대한 Ad Hoc Analysis 지원 | Ad Hoc Analysis는 이제 Java 11과 호환됩니다. Java 11 사용에 대해 몇 가지 주의해야 할 사항이 있습니다. |
| Advertising Analytics 업데이트 | Advertising Analytics에 대한 몇 가지 업데이트를 릴리스 중입니다. <ul><li>Yahoo Gemini는 3월 31일에 Microsoft Bing에 병합되었습니다. 따라서 Yahoo Gemini 광고 계정 옵션은 더 이상 사용할 수 없습니다. </li><li>Google에서 새 추적 패턴을 구현했으므로 _추적 템플릿_ 대신 _최종 URL 접미사_&#x200B;를 사용합니다.</li></ul> |
