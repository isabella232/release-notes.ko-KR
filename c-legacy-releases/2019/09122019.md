...
에 가입하십시오. 출시 3-5일 전에 통지를 받게 됩니다. 릴리스 후 게시된 새 정보는 발행 날짜로 표시됩니다.
...
* 오류 보고와 관련된 문제가 해결되었습니다. 빨간색 오류 표시기 대신 더 구체적인 오류 메시지가 표시됩니다. 특히, 부하가 높거나 오류가 있거나 너무 복잡한 보고서 요청을 작성하여 문제가 발생하는 경우를 이해하는 데 도움이 됩니다. (AN-184135) [더 보기…](https://docs.adobe.com/content/help/ko-KR/analytics/analyze/analysis-workspace/optimizing-performance.html)
...
* [패키지 공유](https://helpx.adobe.com/kr/experience-manager/6-5/sites/administering/using/package-manager.html#PackageShare)는 모든 고객이 Software Distribution에 액세스할 수 있는 권한을 보유할 때까지 액세스가 가능한 상태로 유지됩니다.
...
[!DNL Digital Publishing Suite Classic] (DPSC)은 2019년 8월 31일에 사용이 종료됩니다. For more information, see the [[!DNL Digital Publishing Suite Classic] End-of-Life FAQ](https://helpx.adobe.com/kr/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
관리 사용자가 Campaign Classic 인스턴스에 IP 주소를 연결할 수 있도록 하는 새로운 기능이 추가되었습니다.
