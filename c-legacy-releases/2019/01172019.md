...
* [Target](https://marketing.adobe.com/resources/help/en_US/target/rn/target_release_notes.html) - 솔루션 도움말 링크
...
* [시작](https://docs.adobelaunch.com/) - 제품 도움말 링크
* [ID 서비스](#id-service)
...
8.1에서는 DIL이 Google Tag Manager의 더 엄격한 보안 정책을 준수하도록 했습니다. This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. 향후 버전에 이 변경 사항이 포함됩니다. (CORE-24189)
