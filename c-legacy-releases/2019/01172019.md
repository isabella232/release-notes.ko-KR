...
* [[! DNL Launch, by Adobe]](https://docs.adobelaunch.com/) - 제품 도움말에 대한 링크
* [ID 서비스](#id-service)
...
8.1에서는 DIL이 Google Tag Manager의 더 엄격한 보안 정책을 준수하도록 했습니다. 이 버전은 DTM, 독립 실행형 코드, NOT [!DNL Launch] 또는 appmeasurement 대상 관리 모듈에서만 사용할 수 있습니다. 향후 버전에 이 변경 사항이 포함됩니다. (CORE-24189)
