...
이 설정은 **[!UICONTROL 프로젝트]** &gt; **[!UICONTROL 프로젝트 정보 및 설정을 통해 액세스할]**수 있습니다.
...
* 관리: 관리자가 적절한 권한을 할당받았더라도 처리 규칙을 만들 수 없는 문제를 해결했습니다. (AN-170690)
