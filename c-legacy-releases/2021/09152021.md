...
| 게시일 | 이름 | 애플리케이션 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 9월 | [[!UICONTROL Campaign 컨트롤 패널] 문제 해결](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/troubleshooting.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널] 문제를 해결하는 방법을 알아봅니다. |
| 2021년 9월 | [데이터베이스 모니터링](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/performance-monitoring/monitor-databases.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널]을 사용하여 인스턴스의 데이터베이스 사용을 모니터링하는 방법을 알아봅니다. |
...
| 2021년 9월 | [허용 목록 IP 범위](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/allowlist-ip-range.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널]의 허용 목록에 IP 주소 범위를 추가하는 방법을 알아봅니다. |
| 2021년 9월 | [URL 권한 추가](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/instance-settings/add-url-permissions.html?lang=ko-KR) | Campaign V8 | Adobe Campaign Classic 인스턴스에서 외부 URL로 연결을 설정하는 방법을 알아봅니다. |
| 2021년 9월 | [SFTP 서버에 연결](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/connect-to-sftp-server.html?lang=ko-KR) | Campaign V8 | [!UICONTROL Campaign 컨트롤 패널]에 저장한 키를 사용하여 클라이언트 SFTP 애플리케이션을 통해 SFTP 서버에 연결하는 방법을 알아봅니다. |
| 2021년 9월 | [SSH 키 생성](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/generate-ssh-key.html?lang=ko-KR) | Campaign V8 | 터미널을 사용하여 SSH 키를 생성하는 방법과 [!UICONTROL Campaign 컨트롤 패널]에 키의 공개 버전을 저장하는 방법을 알아봅니다. |
| 2021년 9월 | [Campaign 컨트롤 패널 - 서버 용량 모니터링](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/sftp-management/monitor-server-capacity.html?lang=ko-KR) | Campaign V8 | SFTP 서버의 스토리지 용량을 모니터링하는 방법을 알아봅니다. |
...
| 2021년 9월 | [공개 리소스 URL을 http에서 https로 변경하는 단계별 방법](https://experienceleague.adobe.com/docs/campaign-standard-learn/troubleshooting/change-public-resource-url.html?lang=ko-KR) | Campaign Standard | 공개 리소스 URL을 http에서 https로 변경하는 방법을 알아봅니다 |
...
| 2021년 9월 | [스캔한 문서 및 복합 목록](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/accessibility-series/accessibilitysession4.html?lang=ko-KR) | 비디오 | 이 온디맨드 세션은 스캔한 문서 및 복합 목록과 같이 사람들이 자주 직면하는 보다 복잡한 문제를 해결합니다. |
...
| 2021년 9월 | [휴대폰에서 PPT 파일을 PDF로 변환](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/phone.html?lang=ko-KR) | 비디오 | 60초 길이의 이 비디오 튜토리얼에서는 휴대폰에서 이메일 PowerPoint 첨부 파일을 PDF로 변환하는 방법을 알아봅니다. 파일이 반환되면 파일을 보고 공유를 탭하여 팀에 보낼 수 있습니다. 이 모든 작업이 휴대폰에 PowerPoint 없이도 가능합니다. |
| 2021년 9월 | [순식간에 사진 PDF 만들기](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/photo.html?lang=ko-KR) | 비디오 | 60초 길이의 이 비디오 튜토리얼에서는 여러 JPG를 Acrobat 아이콘으로 드래그 앤 드롭하여 PDF를 만드는 방법을 알아봅니다. 다중 페이지 PDF를 생성하려면 예를 클릭합니다. 그런 다음 더 많은 JPG 파일을 페이지 패널로 드래그하여 PDF에 페이지를 추가할 수 있습니다. |
| 2021년 9월 | [한 번에 여러 PDF 파일 검색](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/search.html?lang=ko-KR) | 비디오 | 60초 길이의 이 비디오 튜토리얼에서는 PDF 파일에서 검색을 시작한 다음 고급 검색을 열고 PDF 파일의 전체 폴더를 검색하는 방법을 알아봅니다. |
| 2021년 9월 | [Acrobat 웹으로 PDF 편집](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/edit.html?lang=ko-KR) | 비디오 | 이 60초 길이의 비디오 튜토리얼에서는 PDF를 다운로드하지 않고도 텍스트와 이미지를 간단하게 편집하는 방법을 알아봅니다. |
| 2021년 9월 | [파일을 하나의 PDF로 결합](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/combine-to-one-pdf.html?lang=ko-KR) | 비디오 | 60초 길이의 이 비디오 튜토리얼에서는 여러 유형의 파일을 하나의 PDF로 결합하여 문서를 빠르게 만드는 방법을 알아봅니다. |
