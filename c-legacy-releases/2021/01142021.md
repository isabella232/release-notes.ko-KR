...
[Experience Cloud 서비스 및 관리 설명서에는 고객 속성, 대상 라이브러리([!UICONTROL People] 서비스), 활성화, 사용자 및 제품 관리, Experience Cloud 쿠키가 포함되어 있습니다.
...
다음에 적용되는 최신 업데이트를 보려면 [Experience Platform 릴리스 정보](http://www.adobe.com/go/platform-release-notes-en)를 참조하십시오.
...
| Ad Hoc Analysis Java™ 8 호환성 업데이트 | 2020년 8월 21일 | Ad Hoc Analysis은 현재 Java™ 8 버전 1.8.0_261+와 호환되지 않습니다. [종료 날짜](https://spark.adobe.com/page/S9Bhp66VJ2fEn/)에 도달하기 전에 이 도구에 대한 액세스가 중단되지 않도록 1.8.0_261 이전에 Java™ 8 버전을 유지하는 것이 좋습니다. |
