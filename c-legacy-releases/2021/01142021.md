...
Platform Launch에 대한 자세한 내용은 [Experience Platform Launch 릴리스 정보](https://experienceleague.adobe.com/docs/launch/using/release-notes/current.html?lang=ko-KR)를 참조하십시오.
...
| 2020년 12월 9일 | [Offer Decisioning에서 규칙 만들기](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-rules.html?lang=ko-KR) | 비디오 | [!UICONTROL Offer Decisioning]에서 규칙을 만드는 방법을 알아봅니다. 규칙은 플랫폼의 [!UICONTROL 실시간 고객 프로필]에 있는 이벤트와 특성을 사용하여 작성하며 오퍼의 자격 조건을 형성합니다. |
...
[설명서](https://docs.adobe.com/content/help/ko-KR/journeys/using/journey-orchestration-home.html) - [릴리스 정보](https://docs.adobe.com/content/help/ko/journeys/using/release-notes/release-notes.html) - [방법 비디오](https://docs.adobe.com/content/help/ko-KR/platform-learn/tutorials/journey-orchestration/introduction.html)
...
자세한 내용은 [CIF 핵심 구성 요소](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.6.0)를 참조하십시오.
   * **Cloud Manager**
      ...
      * [SSL 인증서](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/manage-ssl-certificates/introduction.html?lang=ko-KR) 및 [사용자 지정 도메인 이름](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/custom-domain-names/introduction.html?lang=ko-KR)의 셀프 서비스 관리.
      * [IP 허용 목록](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/ip-allow-lists/introduction.html?lang=ko-KR)의 셀프 서비스 관리.
...
| 2020년 12월 | [콘텐츠 조각 작성](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/author-content-fragments.html?lang=ko-KR) | 문서 | Adobe Experience Manager(AEM) 및 GraphQL을 시작합니다. [!UICONTROL 콘텐츠 조각 모델]을 기반으로 새 콘텐츠 조각을 만들고 편집합니다. [!UICONTROL 콘텐츠 조각]의 변형을 만드는 방법을 알아봅니다. |
| 2020년 12월 7일 | [콘텐츠 조각 모델 정의](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/content-fragment-models.html?lang=ko-KR) | 문서 | Adobe Experience Manager(AEM) 및 GraphQL을 시작합니다. AEM에서 콘텐츠 조각 모델을 사용하여 콘텐츠를 모델링하고 스키마를 구축하는 방법을 알아봅니다. 기존 모델을 검토하고 새 모델을 만듭니다. 스키마를 정의하는 데 사용할 수 있는 다양한 데이터 유형에 대해 알아봅니다. |
...
* [AEM Dispatcher 릴리스 정보](https://docs.adobe.com/content/help/ko/experience-manager-dispatcher/using/getting-started/release-notes.html)
...
| 2020년 12월 4일 | [Adobe PDF 도구 API를 OCR PDF 파일에 사용하기](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/ocr.html?lang=ko-KR) | 문서 | [!UICONTROL 광학 문자 인식(OCR)]을 사용하여 스캔한 PDF의 잠금을 해제하여 텍스트를 추출하고 검색 가능한 파일을 만드는 방법을 알아봅니다. |
| 2020년 12월 4일 | [Adobe PDF 도구 API 및 Java 시작하기](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/gettingstartedjava.html?lang=ko-KR) | 문서 | 개발자는 사용 가능한 모든 웹 서비스에 액세스하기 위해 제공된 샘플 파일을 바로 실행할 수 있으므로 몇 분 안에 작업을 시작할 수 있습니다. 이 튜토리얼에서는 PDF 도구 Java SDK를 사용하여 샘플 실행을 시작하는 모든 단계를 안내합니다. |
| 2020년 12월 4일 | [Adobe PDF 도구 API 및 .Net 시작하기](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/gettingstartednet.html?lang=ko-KR) | 문서 | 개발자는 사용 가능한 모든 웹 서비스에 액세스하기 위해 제공된 샘플 파일을 바로 실행할 수 있으므로 몇 분 안에 작업을 시작할 수 있습니다. 이 튜토리얼에서는 PDF 도구 .Net SDK를 사용하여 샘플 실행을 시작하는 모든 단계를 안내합니다. |
| 2020년 12월 4일 | [PDF 도구 API를 활용하여 PDF를 Word, PowerPoint 등으로 내보내기](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/exportpdf.html?lang=ko-KR) | 문서 | 콘텐츠를 편집하고 승인을 받은 후 서명을 받기 위해 나중에 PDF 파일을 MS Word로 변환하여 맞춤형 계약 워크플로를 만들 수 있습니다. 또는 송장 및 재무 계산 또는 데이터 분석을 위해 PDF 콘텐츠를 MS Excel 형식으로 내보낼 수 있습니다. |
| 2020년 12월 4일 | [PDF 도구 API 및 Node.js를 사용하여 몇 분 안에 HTML 또는 MS Office에서 PDF 만들기](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/createpdffromhtml.html?lang=ko-KR) | 문서 | 새로운 Adobe PDF 도구 API를 사용하여 문서 워크플로를 디지털화하는 방법에 대해 알아봅니다. 이 API는 복잡한 비즈니스 워크플로의 요구 사항을 충족하기 위해 개발자에게 강력한 여러 PDF 조작 서비스를 선택하고 선택할 수 있는 다양한 기능을 제공합니다. |
