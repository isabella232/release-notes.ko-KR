...
| [Customer Activity Hub 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture//customer-activity-hub/overview.html?lang=ko-KR) | 외부 애플리케이션이 Adobe Experience Platform의 [!UICONTROL 실시간 고객 프로필]에 액세스하는 방법에 대해 알아봅니다. |
...
| [프로필 강화를 위한 맞춤형 데이터 과학 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-science/overview.html?lang=ko-KR) | [!UICONTROL Data Science Workspace] 에서 Adobe Experience Platform의 데이터를 사용하여 모델을 교육하고 배포하고 평가하여 기계 학습 통찰력을 제공하는 방법에 대해 알아봅니다. |
...
| [엔터프라이즈 데이터 탐색 및 보고 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-exploration/overview.html?lang=ko-KR) | Experience Platform의 [!UICONTROL Query Service] 를 사용하면 데이터에 대해 SQL 쿼리를 수행할 수 있습니다. [!UICONTROL Data Science Workspace] 를 사용하여 데이터 탐색, 데이터 과학 및 기계 학습 워크로드를 데이터에서 수행하는 방법에 대해 알아봅니다. |
| [멀티채널 메시지 오케스트레이션 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/multi-channel-message-orchestration/overview.html?lang=ko-KR) | 브랜드가 이메일, SMS 및 모바일 알림과 같은 채널을 통해 주도적으로 고객과 관계를 맺고 소통할 수 있는 방법에 대해 알아봅니다. |
| [서버측 엔터프라이즈 데이터 수집 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/server-side-enterprise-data-collection/overview.html?lang=ko-KR) | Adobe Experience Platform 웹 및 Mobile SDK로 수집된 데이터를 Experience Platform [!UICONTROL Edge Network] 에서 원하는 대상으로 전달하는 방법에 대해 알아봅니다. |
...
| 2021년 3월 5일 | [Amazon S3로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-amazon-s3.html?lang=ko-KR) | 비디오 | 이 비디오는 원활하고 확장 가능한 방식으로 클라우드 스토리지 서비스의 데이터를 Adobe Experience Platform의 실시간 고객 프로필 및 데이터 레이크로 손쉽게 일괄 수집하는 방법을 보여 줍니다. |
| 2021년 3월 5일 | [Salesforce CRM으로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-salesforce-crm.html?lang=ko-KR) | 비디오 | 이 비디오는 원활하고 확장 가능한 방식으로 CRM 소스의 데이터를 Adobe Experience Platform의 실시간 고객 프로필 및 데이터 레이크로 손쉽게 일괄 수집하는 방법을 보여 줍니다. |
| 2021년 3월 5일 | [Adobe Analytics로부터 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-adobe-analytics.html?lang=ko-KR) | 비디오 | Adobe Analytics 소스 커넥터를 사용하면 원활하고 확장 가능한 방식으로 Adobe Analytics의 데이터를 Adobe Experience Platform의 실시간 고객 프로필 및 Experience Data Lake로 손쉽게 스트리밍할 수 있습니다. |
...
| 2021년 3월 5일 | [Adobe IO Console Export Postman 세부 정보](https://experienceleague.adobe.com/docs/platform-learn/tutorials/apis/postman.html?lang=ko-KR) | 비디오 | Experience Platform API를 인증하고 액세스하는 방법에 대해 알아봅니다. |
| 2021년 3월 5일 | [데이터 수집 이해](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/understanding-data-ingestion.html?lang=ko-KR#data-ingestion) | 비디오 | 실시간 고객 프로필을 관리하기 위해 데이터를 하나의 개방적이고 확장 가능한 플랫폼으로 통합할 수 있는 Experience Platform의 데이터 수집 기능에 대해 알아봅니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 3월 16일 | [프로필 업데이트 작업](https://experienceleague.adobe.com/docs/journey-orchestration-learn/tutorials/building-a-journey/update-profile-action.html?lang=ko-KR#building-a-journey) | 비디오 | 이벤트에서, 데이터 소스에서 또는 특정 값을 사용하여 가져온 정보로 기존 Experience Platform 프로필을 업데이트하는 방법을 알아 봅니다. |

### Journey Orchestration을 위한 추가 리소스

[설명서](https://docs.adobe.com/content/help/ko/journeys/using/journey-orchestration-home.html) - [릴리스 정보](https://docs.adobe.com/content/help/ko/journeys/using/release-notes/release-notes.html) - [방법 비디오](https://docs.adobe.com/content/help/ko/platform-learn/tutorials/journey-orchestration/introduction.html)
...
| 데이터 피드 및 Data Warehouse IP 주소 변경 사항 | 2021년 4월 6일 | 6월 17일부터 데이터 피드 및 Data Warehouse 전달 시스템이 데이터 센터 내에 재배치되어 외부 IP 주소가 변경되어 표시될 수 있습니다.  보고 및 피드가 제공되는 데이터 센터의 IP CIDR 블록은 제어되는 모든 대상 시스템의 방호벽에 존재합니다. [다음은 방화벽 허용 목록](https://experienceleague.adobe.com/docs/analytics/technotes/ip-addresses.html?lang=ko-KR#data-collection-and-ftp-ip-address-blocks)에 배치할 IP 주소 범위의 전체 목록입니다. |
...
| 게시일 | 이름 | 유형 | 설명 |
| -----------| ---------- | ---------- | ---------- |
| 2021년 3월 | [Experience Manager Cloud Service에서 콘텐츠 전달](https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/content/feb2021/content-delivery.html?lang=ko-KR#content) | 이벤트 | Adobe Experience Manager as a Cloud Service에는 강력한 사전 구성된 콘텐츠 전달 아키텍처가 있습니다. 최적화된 콘텐츠 전달 구성을 최대한 활용하는 방법 시연 |
...
| 2021년 3월 | [기초 - 워크플로 관리](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/workflow/use-workflow-management.html?lang=ko-KR#workflow) | 비디오 | 이 비디오에서는 워크플로 모델을 사용하여 이 기능 집합에 대해 보여 주지만 AEM Launcher에도 적용할 수 있습니다. |
