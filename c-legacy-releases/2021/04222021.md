...
| 2021년 4월 | [데이터 관리의 미래와 변화하는 환경- 이벤트](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/the-future-of-data-management-and-the-changing-environment.html?lang=ko-KR#industry) | 문서 | 시장이 Adobe의 디지털 환경에 변화를 가져오므로 기업은 데이터 거버넌스, ID 해결, 잠재 고객을 유도하고 의미 있는 컨텐츠로 익명의 방문자를 참여하는 방법에 관한 새로운 현실에 적응해야 합니다. |
