...
|  | 새 경고 유형, [!UICONTROL 캠페인 관리 UI 작업]를 사용할 수 있으며 포트폴리오, 제한, 분류 및 이벤트에 대한 일괄 편집 및 할당 변경 등을 포함하여 모든 백그라운드 작업의 최종 상태를 표시합니다. UI 작업에 대한 경고를 자동으로 구독합니다.<br><br>이 경고 유형은 결국 올바른 도구 모음에서 사용할 수 있는 기존 작업 상태 알림 (이전 작업 상태 알림)을 대체합니다. |
