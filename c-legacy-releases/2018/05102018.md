...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><b>중요: </b>2018년 5월 25일부터 GDPR이 발효되면서 Adobe은 데이터 커넥터(이전 Genesis) 파트너가 관리하는 FTP 계정에 남아 있는 파일을 <b>자동으로 삭제합니다.</b> (Analytics 고객에 속한 모든 FTP 계정에는 적용되지 않습니다.) 현재 FTP 폴더의 데이터는 무기한으로 유지되므로 기업이 GDPR에 대비하지 않을 위험이 있습니다. 2018년 5월 25일부터 Adobe는 데이터가 서버에 도착한 지 30일이 경과하면 데이터 커넥터 파트너 관리 FTP 서버에서 모든 파일을 삭제합니다.
   </p> </td> 
  </tr> 
  <tr> 
...
2018년 5월 7일이 있는 주에 Adobe는 [일반 데이터 보호 규정](https://www.eugdpr.org)(GDPR)을 지원하는 제품 업데이트를 릴리스했습니다. 다음 정보는 이러한 개선 사항을 이해하고 구현하고 필요한 정책과 절차를 업데이트하는 데 도움이 됩니다.
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="uicontrol"> 모바일 </span> SDK - <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/c_mob_privacy-gdpr-android.html" format="html" scope="external"> Android </a> 및 <a href="https://marketing.adobe.com/resources/help/en_US/mobile/ios/c_mob_privacy-gdpr-ios.html" format="html" scope="external"> iOS </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr.html" format="html" scope="external">  <span class="wintitle"> Audience Manager </span> 및 GDPR </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/kr/campaign/kb/campaign-privacy.html" format="html" scope="external"> 캠페인 </a> </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Analytics을 사용하면 검색 엔진 데이터를 Google AdWords, Yahoo! Bing과 같은 </p> <p>다음의 지표를 사용하여 나머지 Analytics 데이터와 나란히 보고할 수 있습니다. </p> 
    <ul id="ul_12C905738789481BA6C0C5CCF2151EC6"> 
     ...
     <li id="li_EB0B1A2DA6DE4774B6FEFA3BA6C6D35A">품질 점수입니다 </li> 
     <li id="li_68A012A841FF4A0E96FC7682B1A4A044">평균 위치 </li> 
    </ul> <p>또한 Analytics에서 다음 차원을 사용할 수 있습니다. </p> 
    <ul id="ul_D92898E28FEB4ADAB68869B3276182A9"> 
     <li id="li_B75433D55E0246C1AF2C86FDC830193A">키워드 일치 유형(AMO ID) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics 커넥터는 Power BI 데스크톱 경험에서 기본 데이터 커넥터로 사용할 수 있습니다. 실행 시 기존 Adobe ID을 사용하여 인증할 수 있습니다. 그런 다음 사용하기 쉬운 검색기에 액세스하여 보고서 세트 데이터 요소에 액세스하고 데이터 요청을 만들 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>컨텍스트 인식 세션을 통해 모바일 애널리스트 및 제품 관리자는 모바일 애플리케이션의 방문을 소급하여 처리하는 방법을 정의할 수 있습니다. 여기에는 방문 외부의 백그라운드 히트를 처리하고 앱 실행 시 방문을 시작하는 기능이 추가됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="uicontrol"> Analytics Workspace의 향상된 기능</span> </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   <td colname="col1"> <p>보고:방문자 Zip/우편 번호 차원으로 변경 </p> </td> 
   <td colname="col2"> <p>히트의 첫 번째 값이 해당 히트에 대한 크레딧을 받을 수 있도록 다른 지역 변수와 함께 방문자 우편번호 차원을 업데이트했습니다. </p> <p>예를 들어 도시 보고서를 실행하고 방문자 우편 번호별로 분류하면 각 히트에 대한 첫 번째 값만 분류에 표시됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>분류 변경 </p> </td> 
   <td colname="col2"> <p>분류 UI가 숫자 및 데이터 지원 분류 유형에 대한 지원을 종료하도록 업데이트되었습니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Analytics의 데이터 거버넌스 레이블 UI를 다음과 같이 변경했습니다. </p> 
    <ul id="ul_67929C32C8064D428216173D06C449BA"> 
     ...
     <li id="li_B6663A0FACA644A3AF11606892186CDC">레이블이 <span class="uicontrol">DEL-DEVICE</span>로 지정된 필드 값은 지정된 <span class="uicontrol">ID-DEVICE</span>가 이벤트에 있는 경우에만 익명으로 처리됩니다. 삭제되지 않는 이벤트에서 발생하는 이러한 값의 다른 인스턴스는 변경되지 않습니다. 따라서 필드의 고유 카운트를 계산하는 보고서가 변경될 수 있습니다. 공유 장치에서는 데이터 주체 이외의 다른 개인에 대한 식별자를 제거할 수 있습니다. </li> 
     <li id="li_3E30CF2F973B46229D3726FC2320868B"><span class="uicontrol">삭제하지 않음 </span>레이블이 제거되었습니다. </li> 
     <li id="li_BCB7DF19FA81459E9BE598B19C956460">변수의 데이터 거버넌스 레이블을 .csv 파일로 내보내는 기능을 추가했습니다. 따라서 법률 팀과 쉽게 레이블을 공유할 수 있습니다. </li> 
     <li id="li_CF202A81A675463BA3BC6783D9C9E0A1">차원에 대한 샘플 값이 추가되어 각 변수에 포함된 데이터 유형과 레이블 지정 방법을 쉽게 확인할 수 있습니다. </li> 
    </ul> <p>또한 </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>예정 릴리스 발효 2018년 5월 15일</b> </p> <p> <span class="term"> mc_audiences </span>열이 추가되었습니다. <span class="term"> mc_audiences </span> 는 Adobe <span class="wintitle"> Audience Manager의 Audience Analytics 세그먼트 ID 목록입니다 </span>. </p> <p>참고: ID의 분류이므로 여기에 친숙한 이름이 포함되지 않습니다. </p> 
    <!--<p>https://jira.corp.adobe.com/browse/AN-154807</p>--> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Ad Hoc Analysis 국가 보고서 </p> </td> 
   <td colname="col2"> <p>Ad Hoc Analysis의 국가 보고서는 국가/지역으로 이름이 변경되었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Video Analytics </p> </td> 
   <td colname="col2"> <p> <b>Media Collection API </b> </p> <p> VA SDK 제한 사항이나 VA(Video Analytics) SDK 지원 부족으로 인해 비디오 보기를 완벽하게 측정하지 못한 미디어 게시자는 이러한 장치에 Media Collection API를 적용할 수 있습니다. 이를 통해 클라이언트는 VR 헤드셋, 게임 콘솔 등과 같은 디바이스를 비롯하여 사용자가 비디오를 보는 모든 디바이스에 대해 투명도를 유지할 수 있습니다. 미디어 컬렉션 API는 하트비트 VA SDK 컬렉션을 통해 세부적이고 표준화된 지표를 제공합니다. 이러한 측정 지표를 결합하여 전체 고객 여정을 파악할 수 있습니다. </p> 
    <ul id="ul_FD2036F9D160400AAB654CEE30657AAB"> 
     <li id="li_5F4D87F536F6436DAD99F6CDB878BD52">모든 디바이스에서 비디오 측정:게임 콘솔 및 VR 장치를 포함하여 현재 SDK가 지원되지 않는 모든 장치에서 Media Collection API를 적용합니다. </li> 
     <li id="li_2DEE2FE8ED26476CA4C25163D4803345">VA SDK에 대한 RESTful API:Media Collection API는 SDK를 통해 사용할 수 있는 동일한 세부적인 결과와 지표를 얻을 수 있는 효율적이고 효율적인 측정 메커니즘을 제공하기 위해 구축되었습니다. </li> 
     <li id="li_F4D509A6904C484AA1F0BDFAEA678F8A">거시적 고객 측정:이제 Media Collection API를 통해 모든 고객 참여에 대한 전체적인 관점을 비디오로 제공하여 전체 고객의 접근성을 보다 정확하게 파악할 수 있습니다. </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">[!UICONTROL Analysis Workspace]에서 계산된 지표 빌더를 열 때 발생한 문제를 해결했습니다. 이로 인해 함수 드롭다운 목록에 옵션이 표시되지 않았습니다. (AN-160698) </li> 
      <li id="li_C24CD6D3CDF748A0B959D44A4DF41C6A">자유 형식 테이블의 검색 함수 문제를 수정했습니다. 그 결과 기본 및 고급 필터 쿼리에 대한 편집 환경이 개선되었습니다. (AN-159843) </li> 
      <li id="li_727C26115CF946CDA62982DBEA4EAC6B">텍스트가 이미 기존 태그와 일치하는 경우 태그가 생성되지 않던 문제를 수정했습니다. (AN-159363) </li> 
      <li id="li_DCFFC6CB25054530B5B8B0418DB5CC36">텍스트 시각화가 기본적으로 페이지 맨 위에 표시되고 원하는 위치에 배치되지 않는 문제를 해결했습니다. (AN-159148) </li> 
      <li id="li_ABD6A21F42664A3EAEE0036388831B8B">자유 형식 테이블의 검색 필드에서 일본어 및 한국어 문자 입력 문제가 발생하던 문제를 수정했습니다. (AN-158778) </li> 
      <li id="li_A4F55515A9CA4845A4662DEA5712EE77">관리자가 아닌 사용자가 프로젝트 수정 날짜를 선호하거나 태그를 적용하거나 승인된 프로젝트를 변경할 때 발생하는 문제를 수정했습니다. (AN-157398) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_6B5F531B822D4392AD7760752C29B371">세그먼트 빌더에서 시퀀스 전 전용 및 시퀀스 이후에만 옵션에 대한 레이블이 전환되어 이제 복원되던 문제를 수정했습니다. (AN-160747) </li> 
      <li id="li_ED686B21894E4309841C7E322BB35843">관리자가 아닌 사용자가 일부 보고서 세트 도구에 액세스할 수 있었던 문제를 수정했습니다. (AN-159451) </li> 
      ...
      <li id="li_7AF0C1DF79844130B488EDAF27A35B91">회사 설정에서 암호 만료 기능 문제를 수정했습니다. (AN-154927) </li> 
      <li id="li_07E8FF50269B4B7B82EBE67BBF0335A3">자산을 전송하려는 사용자가 경고 소유자로 나열되는 경우 자산 전송 기능이 작동하지 않는 문제를 해결했습니다. (AN-160747) </li> 
      <li id="li_E2A3A073962847FE98D3866E97B6EF04">Experience Cloud을 통해 Analytics에 로그인할 때 발생하는 문제를 해결했습니다.여러 로그인 회사가 사용자 이름과 연결되어 있을 때 잘못된 로그인 회사를 선택한 경우가 있습니다. (AN-160880) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe에서 다음 업그레이드 및 수정 사항이 포함된 DIL 버전 7.0을 릴리스했습니다. </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      ...
      <li id="li_53DBDB6DAB354DF1AD8545A9F14D36F5">DIL 실행 익스텐션에 대한 UX 검토 구현 (CORE-8143) </li> 
     </ul> </p> <p>최신 버전은 Adobe 컨설턴트나 고객 관리팀에게 문의하거나, DTM(<a href="https://marketing.adobe.com/resources/help/ko_KR/dtm/c_overview.html" format="https" scope="external">Digital Tag Management</a>) 또는 <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/t_quick-start.html" format="https" scope="external">Adobe Launch</a>에서 받으십시오 . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>GDPR 준비 </p> </td> 
   <td colname="col2"> <p>As we approach the May 25th, 2018 date at which the European General Data Protection Regulation (GDPR) comes into law, we have prepared documentation to assist you in managing consumer data in  <span class="wintitle"> Audience Manager </span> to meet GDPR obligations. 다음 문서를 참조하십시오. </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> Audience Manager의 GDPR </a> </p> </li> 
...
* 고객이 API 호출을 통해 모든 트레이트 목록을 가져올 수 없었던 버그가 수정되었습니다. (AAM-36824)
* 고객이 세그먼트를 다시 편집할 경우 괄호를 [포함하는 표현식이 괄호를 삭제했던 세그먼트 빌더](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_builder.html) 코드 보기의 버그를 수정했습니다. (AAM-36393)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>향상된 최신 스마트 태그 릴리스는 다음과 같은 주요 개선 사항을 제공합니다. </p> <p> 
     <ul id="ul_1F32257EF31548F986B7D547056BDB3C"> 
      <li id="li_4EDD96DF180B436CB817B8E1B150F1DF">알고리즘 최적화를 통해 모델 정확도를 더욱 향상시키고 값을 다시 호출할 수 있습니다. </li> 
      <li id="li_86039BFA4E2E4B16A24F44A2FF710431"> 테넌트 수준의 모든 태그에 대한 모델 교육 재설정 지원 </li> 
      <li id="li_7363B9318FB1492A9F067B7F534C5355">충돌을 방지하기 위해 고급 스마트 태그 네임스페이스에 대한 지원 </li> 
      <li id="li_9A675C8D29B549ADAE15BBC1B81311A7">재교육으로 인한 성능 저하를 방지하기 위한 새로운 모델 교체 정책 </li> 
      <li id="li_956259E154DC43DDAFE59836511AF87E">테넌트 당 서비스 사용에 대한 모니터링. </li> 
      <li id="li_352CE4CD51AC4F798B11F6C2C0E9090C">서비스 안정성을 개선하기 위해 클러스터링, 연결 관련 문제가 해결되었습니다. </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>유럽연합(EU)의 개인 정보 보호 규정(General Data Protection Regulation)에 대한 GDPR은 2018년 5월부터 시행됩니다. AEM 및 <a href="https://helpx.adobe.com/experience-manager/6-4/managing/using/gdpr-compliance.html" format="https" scope="external">GDPR 준수</a>에 대해 자세히 알아보십시오 . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>연간 가상 글로벌 컨퍼런스는 모든 경험 수준에서 기업 개발자, 설계자 및 데이터 과학자를 위한 심층 세션을 제공합니다. 라이브 세션은 인도 표준, 영국 하계 및 태평양 시간대 지역에서 개최됩니다. 티켓 소지자는 1년 동안 모든 레코딩에 대한 무제한 액세스 권한을 가집니다. </p> <p>Adobe IMMERSE는 Adobe Experience Manager에서 솔루션을 구축하고 있는 모든 개발자를 위한 연간 가상 글로벌 컨퍼런스입니다. 또한 올해 Adobe Cloud Platform, Adobe I/O, Adobe Sensei, ColdFusion 및 FrameMaker에 대한 추가 세션을 진행합니다. </p> <p>Adobe과 광범위한 개발자 커뮤니티의 전문가로부터 자세한 제품 소개, "방법" 레서피, 모범 사례 및 코드 예제를 확인할 수 있습니다. 라이브 세션은 다음 세 시간대에서 브로드캐스트됩니다. </p> <p> 
     <ul id="ul_BDA2A6B569EF422B9327FBF7474D7D98"> 
      <li id="li_69F4FDE29DE14B1A969F428CB3A1A5A6">미국(태평양 표준시) </li> 
      <li id="li_E3EA932CAA4F4122ACC7982CA1856CD1">유럽(영국 하계 표준시) </li> 
      <li id="li_673F096F6C7541FB8F3FAA21914852F7">APAC(인도 표준시) </li> 
     </ul> </p> <p>의제를 확인한 다음, <b>https://adobe.ly/immerse18</b>에서 미화 25.00달러를 할인받을 수 있는 할인 코드 <a href="https://adobe.ly/immerse18" format="https" scope="external">MR765z</a>를 사용하여 등록하십시오. Adobe에서 호스팅하는 대규모 개발자 컨퍼런스를 놓치지 마십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM 테크놀로지스트 Meetup Group </p> </td> 
   <td colname="col3"> <p>이 가상 그룹은 AEM GEM에 대한 알림인 AEM 커뮤니티 전문가에게 묻기(예정된 대로) 웹 세미나를 제공합니다. 또한 직접 참가 이벤트 및 지역 사용자 그룹 회의에 대한 알림도 받을 수 있습니다. </p> <p> <a href="https://adobe.ly/2sVoSwy" format="https" scope="external">https://adobe.ly/2sVoSwy에서 참여해 보십시오.</a> </p> </td> 
  </tr> 
  <tr> 
...
## [!DNL Advertising Cloud] (이전 Advertising Cloud)
