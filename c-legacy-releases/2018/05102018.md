...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Audience Manager에 <span class="wintitle"> GDPR 요청을 제출하는 방법 </span>및 [! DNL Audience Manager] 는 GDPR 요구 사항을 해결합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 고객이 <span class="wintitle"> Target </span> 방문자 프로필에서 데이터를 삭제할 수 있도록 하는 방법입니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>애드혹 분석 프로젝트 변환기는 단추를 클릭하여 애드혹 프로젝트를 <span class="uicontrol"> 분석 작업 공간으로 </span>변환합니다. </p> <p>복사된 프로젝트는 [!UICONTROL Analysis Workspace]에서 필요에 따라 사용, 수정 및 예약할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>예정 릴리스 발효 2018년 5월 15일</b> </p> <p> <span class="term"> mc_audiences </span>열이 추가되었습니다. <span class="term"> mc_ audiences </span> 는 Adobe <span class="wintitle"> Audience Manager의 대상 분석 세그먼트 ID 목록입니다 </span>. </p> <p>참고: ID의 분류이므로 여기에 친숙한 이름이 포함되지 않습니다. </p> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe는 2018 년 5 월 25 일에 유럽 개인 정보 보호 규정 (GDPR) 이 법률로 시행되는 날짜에 접근할 때 <span class="wintitle"> Adobe Audience Manager </span> 의 소비자 데이터를 관리하는 데 도움이 되는 문서를 작성하여 GDPR 의무를 준수할 수 있도록 지원합니다. 다음 문서를 참조하십시오. </p> <p> 
...
## [!DNL Advertising Cloud] (이전의 Advertising Cloud)
