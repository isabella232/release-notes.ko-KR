...
| 기능 | 설명 |
| -----------| ---------- |  
| [VRS/프로젝트 큐레이션 변경](https://marketing.adobe.com/resources/help/ko-KR/analytics/analysis-workspace/curate-projects-vrs.html) | (2018년 9월 구현) 구성 요소 관리자 및 관리자가 아닌 사용자가 조정된 Workspace 프로젝트 및 조정된 VRS(가상 보고서 세트)에서 볼 수 있게 변경되었습니다. 이전에는 **[!UICONTROL 모든 구성 요소 표시를 클릭하면 누구나 조정되지 않은 구성 요소를 볼 수 있었습니다]**. 업데이트된 조정 환경에서는 표시되는 구성 요소를 보다 세밀하게 제어할 수 있습니다. |
| Adobe [!DNL Analytics] 및 GDPR(General Data Protection Regulation) | [!DNL Analytics]은 기존 [!DNL Analytics] 방문자 ID를 GDPR 요청에 전달하는 새 메서드를 지원합니다([AAID](https://marketing.adobe.com/resources/help/ko_KR/analytics/gdpr/gdpr_namespaces.html) 참조). 또한 [!DNL Analytics]은 삭제 요청의 일부로 [구입 ID 값](https://marketing.adobe.com/resources/help/ko-KR/analytics/gdpr/gdpr_labels.html)을 삭제(익명화)할 수 있습니다. |
| [서버 측 전달에 대한 GDPR/ePrivacy 개선 사항](https://marketing.adobe.com/resources/help/ko_KR/analytics/audiences/ssf-gdpr.html) | [EU 쿠키 준수 규정](http://ec.europa.eu/ipg/basics/legal/cookies/index_en.htm)에서 메시지가 표시되면 데이터 컨트롤러([!DNL Analytics] 고객)에는 사전 동의한 데이터를 Adobe [!DNL Analytics]로 제한하여 서버 측에서 AAM(Adobe Audience Manager)으로 전달되지 않도록 하는 옵션이 제공됩니다. 새 구현 컨텍스트 변수를 사용하여 동의를 받지 못한 히트에 플래그를 지정할 수 있습니다. 변수를 설정하면 동의를 받을 때까지 이러한 히트가 AAM에 전송되지 않습니다. |
...
최신 정보는 [Data Workbench 릴리스 노트](https://marketing.adobe.com/resources/help/ko_KR/insight/whatsnew/)를 참조하십시오.
...
| Dallas FTP 서버 마이그레이션(ftp2.omniture.com)<br/>2018년 10월 19일 | 2018년 10월 23일에 SFTP 프로토콜을 통해 ftp2.omniture.com에 연결하는 경우 SJ1 사이트의 호스트 식별자를 다시 허용해야 할 수 있습니다. 이 문제는 10월 23일에만 적용됩니다.<br/>Adobe FTP 서버 업그레이드[https://marketing.adobe.com/resources/help/ko_KR/whitepapers/ftp/ftp_upgrade.html]()를 참조하십시오. |
...
| 사용자 계정 연결<br/>2017년 10월 26일 | [!DNL Analytics] 사용자는 더 이상 Experience Cloud와 [!DNL Analytics] 간 계정을 수동으로 연결할 필요가 없습니다. 사용자는 Admin Console 관리자에게 문의하여 [!DNL Analytics] 액세스를 요청할 수 있습니다.<br/> 사용자 ID 마이그레이션을 통해 관리자는 사용자 관리에서 Adobe Admin Console로 사용자 계정을 쉽게 마이그레이션할 수 있습니다. [!DNL Analytics][!DNL Analytics] 사용자가 마이그레이션되면 Experience Cloud에서 사용할 수 있는 구입한 솔루션과 핵심 서비스에 액세스할 수 있습니다.<br/>[[!DNL Analytics] 사용자 ID 마이그레이션](https://marketing.adobe.com/resources/help/ko_KR/experience-cloud/admin-console/analytics-migration/)에 대해 자세히 알아보십시오. |
...
| 기능 | 설명 |
| -----------| ---------- |  
| [IRIS Optimizations](https://marketing.adobe.com/resources/help/ko-KR/aam/c_compact.html) | 세그먼트를 대상으로 전송할 때 IRIS가 따르는 규칙 세트에 대한 자세한 내용은 **세그먼트 매핑 규칙**을 참조하십시오. [IRIS &gt; 세그먼트 매핑 규칙](https://marketing.adobe.com/resources/help/ko-KR/aam/c_compact.html)으로 이동합니다. |
| [알고리즘 모델링에서 트레이트 제외](https://marketing.adobe.com/resources/help/ko-KR/aam/trait-exclusion-algo-models.html) | 특성 제외를 사용하면 모델링에서 특성을 제거할 수 있습니다. 이러한 방식으로 사이트 방문자 특성과 같은 일반적인 특성은 모델을 보정하지 않습니다. 이 새로운 기능을 사용하면 타사 데이터 피드에서 특성을 제거할 수도 있습니다. |
| [Audience Lab 고급 기능](https://marketing.adobe.com/resources/help/ko_KR/aam/audience-lab-advanced.html) - **중복 할당 템플릿** 및 **테스트 세그먼트 보류** | Adobe에서는 Audience Lab 사용 시 생산성을 높이기 위해 두 가지 기능을 릴리스했습니다. [Audience Lab 고급 기능](https://marketing.adobe.com/resources/help/ko-KR/aam/audience-lab-advanced.html)에서 시작하는 방법을 살펴보십시오. |
...
* 최신 버전의 Safari에는 ITP(Intelligent Tracking Prevention) 2.0 도구가 포함되어 있습니다. 이 도구는 h_referer 신호를 사용하여 Safari 사용자 및 데이터 수집에 대한 지정 대상 지표에 영향을 줍니다. [대응 가능 대상의 일치율이 낮은 원인](https://marketing.adobe.com/resources/help/ko-KR/aam/addressable-audiences-match-rates.html) 및 [h_ 접두사를 사용한 데이터 컬렉션](https://marketing.adobe.com/resources/help/ko-KR/aam/r_tb_variable_prefixes.html)으로 Safari 트래픽을 참조하십시오.
* [알고리즘 모델링에서 트레이트 제외](https://marketing.adobe.com/resources/help/ko-KR/aam/trait-exclusion-algo-models.html) 릴리스에서 [역할 기반 액세스 컨트롤](https://marketing.adobe.com/resources/help/ko-KR/aam/c_administration.html)을 사용하는 고객에 대한 문제를 소개했습니다. 새 모델을 생성할 때 액세스 권한이 있는 데이터 소스만 선택하면 **제외** 창에서 해당 트레이트를 볼 수 있습니다. 그러나 액세스 권한이 있는 것 외에 다른 데이터 소스를 선택하는 경우, 액세스 권한이 있는 소스 외에도 빈 목록이 표시됩니다. 트레이트를 보려면 액세스 권한이 없는 데이터 소스를 선택 취소하십시오. (AAM-42380)

**설명서 업데이트**

* 일반 보고서에 모든 지표에 대한 정의 및 예제가 추가되었습니다. [일반 보고서 설명서)https://marketing.adobe.com/resources/help/ko-KR/aam/c_general_reports.html](를 참조하십시오.
* 고객 수준과 세그먼트 수준 지표의 차이점을 명확하게 하기 위해 지정 대상 문서를 업데이트했습니다. [대응 가능 대상 설명서](https://marketing.adobe.com/resources/help/ko-KR/aam/addressable-audience-metrics.html)를 참조하십시오.
