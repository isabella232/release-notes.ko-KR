...
| 기능 | 설명 |
|--- |--- |
| [즉각적인 장치 간 억제](https://marketing.adobe.com/resources/help/ko-KR/aam/instant-cross-device-suppression.html) | 즉각적인 장치 간 억제는 이러한 장치에서 특정 환경에서 특정 경험이 발생할 때 연결되어 있는 여러 장치에 있는 사용자를 억제하는 기능입니다. 여러 장치 간에 일관된 경험을 사용자에게 제공하려면 즉각적인 장치 간 억제 기능을 사용하십시오.  이 경험은 [!DNL Audience Manager]의 실시간 세그먼트 해제 기능으로 가능해집니다. |
...
[릴리스 노트](https://helpx.adobe.com/kr/experience-manager/cloud-manager/using/release-notes-2018-50.html)를 참조하십시오.

**코어 구성 요소 릴리스 2.1.0**

이제 [핵심 구성 요소](https://helpx.adobe.com/kr/experience-manager/core-components/user-guide.html)의 릴리스 2.1.0를 사용할 수 있으며, 여기에 [이미지](https://helpx.adobe.com/kr/experience-manager/core-components/using/image.html) 구성 요소 개선 사항과 새 [Teaser](https://helpx.adobe.com/kr/experience-manager/core-components/using/teaser.html) 구성 요소가 도입되고 많은 버그가 수정되었습니다.
...
90개 이상의 세션을 무제한으로 액세스할 수 있는 주문형 티켓을 구매할 수 있습니다. [여기](https://immerse18.adobe-devs.adobeevents.com/register/)에서 할인 코드 He7B52를 사용하십시오.
...
[여기](https://helpx.adobe.com/kr/experience-manager/kt/eseminars/gems/aem-index.html)에서 예정된 세션 또는 이전 세션을 확인하십시오.
...
[여기](https://helpx.adobe.com/kr/experience-manager/kt/eseminars/ask-the-expert/atace-index.html)에서 예정된 세션 또는 이전 세션을 확인하십시오.

여전히 도움이 필요하십니까? AEM 커뮤니티에 가입하여 자기소개를 하고 [여기](https://forums.adobe.com/message/9643186?cid=AEMNewCommInvite13June_MU_1)에 질문을 게시할 수 있습니다.
...
자세한 내용은 [여기](https://evolve.3sharecorp.com/)를 참조하십시오.
...
 [여기](https://www.meetup.com/pro/aem/)에서 로컬 사용자 그룹 만남을 찾으십시오. 로컬 그룹에 속하지 않지만 시작하는 것에 관심이 있다면 [aemusers@adobe.com에 전자 메일을 보내십시오.](mailto:aemusers@adobe.com)
...
* [Experience Cloud 릴리스 노트](https://marketing.adobe.com/resources/help/ko-KR/whatsnew/)
