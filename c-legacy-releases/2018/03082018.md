...
[여기](https://marketing.adobe.com/resources/help/ko-KR/mcloud/solutions-core-services.html)에서 Experience Cloud의 솔루션 및 핵심 서비스에 대한 최신 브랜딩 업데이트에 대해 알아보십시오.
...
* [!DNL  visitor.cookieDomain]에 선행 점이 있을 때 Experience Cloud ID 서비스가 선행 점이 없는 도메인에 대해 AMCV 쿠키를 잘못 설정하던 버그를 수정했습니다. 예를 들어 [!DNL  .sampledomain.com] 외에도 [!DNL  sampledomain.com]에서 [AMCV 쿠키](https://marketing.adobe.com/resources/help/ko_KR/whitepapers/cookies/cookies_mc.html)를 설정합니다. (CORE-10634)
...
<table id="table_6DB2F55C955943EB97DC25C96B6DF526"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 다음을 통해 General Data Privacy Regulation(GDPR)을 지원하는 API로 확장된 [!UICONTROL Mobile] SDK입니다. </p> 
