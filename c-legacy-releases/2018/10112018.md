...
[Adobe FTP 서버 업그레이드](https://marketing.adobe.com/resources/help/ko_KR/whitepapers/ftp/ftp_upgrade.html)를 참조하십시오.
...
중요: [리포트 빌더](https://marketing.adobe.com/resources/help/ko-KR/arb/t_install_arb.html) 설치를 최신 버전으로 업데이트하십시오. 이 업데이트는 2018년 4월부터 시작되는 Admin Console로 Analytics 사용자 ID 이전 실행을 위한 전제 조건입니다.
...
* **Cloud Manager 2018.7.0**
   ...
   이 Cloud Manager 릴리스는 자동 크기 조정, 코드 품질 분석, 환경 및 성능 테스트에 대한 세부 사항 보기에 대한 주요 개선 사항을 제공합니다. [릴리스 노트](https://helpx.adobe.com/kr/experience-manager/cloud-manager/using/release-notes-2018-7-0.html).
...
[기능 동영상](https://helpx.adobe.com/kr/experience-manager/kt/sites/using/spa-editor-framework-feature-video-use.html) 및 [기술 동영상](https://helpx.adobe.com/kr/experience-manager/kt/sites/using/spa-editor-components-technical-video-understand.html)을 참조하십시오.

다음 설명서를 참조하십시오. [https://helpx.adobe.com/kr/experience-manager/6-4/assets/using/aem-assets-adobe-stock.html](https://helpx.adobe.com/kr/experience-manager/6-4/assets/using/aem-assets-adobe-stock.html)
...
* **AEM Screens**
   ...
   [Dynamic Embedded Sequence를 사용하면](https://helpx.adobe.com/kr/experience-manager/6-4/sites/authoring/using/dynamic-embedded-sequences.html)을 사용하면 한 채널에 대해 수행된 변경 사항 및 업데이트가 연관된 다른 채널에 전파되는 계층을 따를 수 있습니다. 상위-하위 계층 구조를 따르며, 이미지 또는 비디오와 같은 자산을 포함합니다.

* **AEM Cloud Manager**

   자동 크기 조정은 프로덕션 환경에서 Dispatcher/Publish 세그먼트의 수평적인 확장을 통해 활성화되어 로드, 볼륨, 액세스 및 기타 정의된 모니터링된 지표의 급격한 증가를 지원합니다. 자세한 내용은 [2018.7.0용 릴리스 노트](https://helpx.adobe.com/kr/experience-manager/cloud-manager/using/release-notes-2018-7-0.html)를 따르십시오.
...
* **Adobe IMMERSE**
   ...
   90개 이상의 세션에 무제한 액세스할 수 있는 On-Demand Pass를 구입할 수 있습니다. [여기](https://immerse18.adobe-devs.adobeevents.com/register/)에서 할인 코드 `He7B52`를 사용하십시오.
