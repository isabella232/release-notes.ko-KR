...
* 대상 라이브러리 인터페이스를 통해 생성된 세그먼트가 데이터를 채우지 않도록 [!DNL Audience Manager] 하는 트레이트 문제를 해결했습니다 [!DNL Audience Manager]. (CORE-9891)
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>[!UICONTROL Mobile] Services에서 [!DNL Target] 워크플로우 제거 </p> </td> 
     <td colname="col2"> <p> 2018년 3월부터 Adobe [!UICONTROL Mobile] Services에서 Adobe [!DNL Target] 워크플로우를 사용하지 않도록 설정하는 과정의 일부로, [!DNL Target]/활동, [!DNL Target]/대상, [!DNL Target]/컨텐츠를 생성하는 기능이 이 릴리스에서 비활성화됩니다. </p> <p> 2018년 3월까지는 기존 활동, 대상 및 컨텐츠를 계속 보고, 수정하고, 삭제할 수 있습니다. </p> <p>자세한 내용은 <a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_mob_remove-target-faqs.html" format="html" scope="external">Mobile Services에서 [!DNL Target] 워크플로우 제거</a>를 참조하십시오 . </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>플레이어 상태 유지 관리와 마감된 상태 식별을 포함한 정확한 측정 보장 지원을 향상시키기 위한 추가 논리입니다. </p> <p>이제 플레이어에는 사용자가 컨텐츠를 완료하지 않고 세션을 닫을 때 세션이 종료되었음이 즉시 표시됩니다. 이 업데이트 전에 먼저 중단된 세션은 하트비트가 수신되지 않은 10분 시간 제한에 의해 판별되었습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
자세한 내용은 제품에서 도움말 아이콘 **[!UICONTROL ?]** &gt; **[!UICONTROL 도움말 내용을]** 참조하십시오.
