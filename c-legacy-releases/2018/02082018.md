...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>모바일 서비스 <span class="wintitle"> 부문의 해체된 타겟 </span><span class="uicontrol"></span> 워크플로우 </p> </td> 
     <td colname="col2"> <p> 2018 년 3 월부터 Adobe Mobile Services에서 Adobe <span class="wintitle"> Target </span> 워크플로우를 <span class="uicontrol"></span> 비활성화하는 일환으로 새로운 [! dnl target]/activities, [! dnl target]/audiences 및 [! DNL Target]/content가 이 릴리스에서 비활성화되었습니다. </p> <p> 2018년 3월까지는 기존 활동, 대상 및 콘텐츠를 계속 보고, 수정하고, 삭제할 수 있습니다. </p> <p>자세한 내용은 <a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_mob_remove-target-faqs.html" format="html" scope="external">Mobile Services에서 [!DNL Target] 워크플로우 제거</a>를 참조하십시오 . </p> </td> 
  </tr> 
 </tbody> 
</table>
