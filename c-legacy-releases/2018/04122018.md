  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_16206029F40F4862A56F55DB93987414"><b>[!UICONTROL Analysis Workspace]</b>: 호환되지 않는 권한으로 모바일 OS 보고서에 액세스할 수 없는 문제가 해결되었습니다. (AN-159152) </li> 
...
* 이 릴리스는 두 개의 새로운 DCS 매개 변수인 ` d_tdpid`와 ` d_tdpid_ic`를 추가합니다. 이를 사용하면 트레이트 평가를 데이터 소스 목록의 트레이트로만 제한할 수 있습니다. 새로운 두 매개 변수는 [DCS 참조 자료](https://marketing.adobe.com/resources/help/ko-KR/aam/dcs-keys.html)에 자세히 설명되어 있습니다.
* 프로필 병합 규칙에서 장치 간 ID 지표를 계산하는 방법을 업데이트했습니다. 이제 이 지표는 장치 간 전략의 일부로서 인증을 활용하는 고객의 CRM ID에 연결된 총 장치 수를 보다 정확하게 보고합니다. ](자세한 내용은 프로필 병합 규칙[https://marketing.adobe.com/resources/help/ko-KR/aam/profile-link-metrics.html) 설명서를 참조하십시오. (AAM-34509)
