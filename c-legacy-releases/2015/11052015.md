...
11월 및 12월에 고객 기반에서 많은 양의 분류 업로드가 발생할 것으로 예측됩니다. 이러한 업로드를 가능한 한 빨리 처리할 예정이지만 처리하는 데 평소보다 오래 걸릴 수 있습니다. 처리 시간 최소화와 관련된 도움말은 [분류 처리 시간](https://helpx.adobe.com/analytics/kb/saint-processing-time.html)을 참조하십시오.
