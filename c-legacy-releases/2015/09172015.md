...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>푸시 메시지를 <span class="wintitle"></span><span class="keyword"> Mobile Services </span> UI에서 Analytics 세그먼트로 보내면 강력한 [! DNL Analytics] 데이터를 참조하십시오. </p> <p>다음을 참조하십시오. </p> 
...
* Adobe Advertising Cloud 데이터 피드 문제를 해결했습니다. (AN-106116)
