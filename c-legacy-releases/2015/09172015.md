...
솔루션 관리자의 경우, 솔루션 그룹을 더 광범위한 Adobe 그룹에 매핑하고 [Enterprise Dashboard](http://adminconsole.adobe.html/#)에서 사용자를 대량으로 추가하는 방법에 대한 중요한 정보는 [사용자 및 그룹](https://marketing.adobe.com/resources/help/ko_KR/mcloud/?f=user_mgmt_admin)을 참조하십시오.
...
<table id="table_812AC7BF7F314540B7DA72D1C97D1918"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이제 Marketing Cloud 솔루션용 Universal Windows Platform(UWP) SDK 4.x를 사용할 수 있습니다. </p> <p>이 새로운 SDK를 이용하면 기본 Windows 10 응용 프로그램을 측정하고, 앱 내의 타깃팅한 콘텐츠를 제공하고, 고객 관리를 통해 대상 데이터를 이용하고 수집할 수 있습니다. </p> <p><a href="https://marketing.adobe.com/resources/help/en_US/mobile/uwp/" format="https" scope="external">Marketing Cloud 솔루션용 Universal Windows Platform SDK 4.x</a>를 참조하십시오 . </p> </td> 
  </tr> 
  <tr> 
...
Analytics 관리자: Marketing Cloud 관리자인 경우 Analytics 그룹을 더 광범위한 Adobe 그룹에 매핑하고 [Enterprise Dashboard](http://adminconsole.adobe.html/#)에서 사용자를 대량으로 추가하는 방법에 대한 최신 정보는 [사용자 및 그룹](https://marketing.adobe.com/resources/help/ko_KR/mcloud/?f=user_mgmt_admin)을 참조하십시오.
...
* 보고 및 분석에서 사용자 그룹을 만들고 기본 사용자 그룹으로 선택한 후 발생하던 문제를 수정했습니다. 기본 그룹을 다시 _None_으로 변경하려는 시도가 실패하고 오류 메시지가 표시되었습니다. (AN-108270)
...
다음 플랫폼에 대한 [!DNL  AppMeasurement] 릴리스 내역은 [AppMeasurement 릴리스 내역](https://marketing.adobe.com/resources/help/ko_KR/sc/appmeasurement/release/index.html)을 참조하십시오.
...
* 새 설명서는 메타데이터 파일을 사용하여 숫자 ID를 [!UICONTROL 광고 분석] 보고서에서 사람이 읽을 수 있는 텍스트로 바꾸는 방법에 대해 설명합니다. [광고 분석 보고서용 데이터 및 메타데이터 파일](https://marketing.adobe.com/resources/help/ko_KR/aam/?f=metadata-files-intro.html)을 참조하십시오.
* [!UICONTROL 광고 분석] 보고서에 필요한 새 키-값을 포함하도록 [픽셀 호출을 통한 캠페인 데이터 노출 데이터 캡처](https://marketing.adobe.com/resources/help/ko_KR/aam/?f=c_capturing_camp_data.html)를 수정했습니다.
* 광고 분석 보고서에 필요한 새 키-값을 포함하도록 [픽셀 호출을 통한 캠페인 클릭 데이터 캡처](https://marketing.adobe.com/resources/help/ko_KR/aam/?f=c_capturing_camp_click_data.html)를 수정했습니다.
