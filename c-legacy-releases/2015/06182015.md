...
* 다음 지침을 다시 구성하고 개선했습니다.
   ...
   * [Adobe Mobile Services 사용 안내서](https://marketing.adobe.com/resources/help/ko_KR/mobile/)
   * [Marketing Cloud 솔루션용 iOS SDK 4.x 관리 안내서](https://marketing.adobe.com/resources/help/ko_KR/mobile/ios/)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> 분석 작업 공간 - 자유 형식 분석 </td> 
...
Analytics Premium은 [Data Workbench 6.4 릴리스](https://marketing.adobe.com/resources/help/ko_KR/insight/whatsnew/)에서 다음과 같은 새로운 기능을 제공합니다.
...
* Swagger 관련 API 설명서를 개선하고 있습니다. 새로운 방법 및 수정된 방법은 [Audience Manager API Docs](https://bank.demdex.com/portal/swagger/index.html) 섹션을 참조하십시오.
* [Marketing Cloud 방문자 ID](https://marketing.adobe.com/resources/help/ko_KR/aam/?f=c_visitor_id_versions.html)에 새 설명서를 추가했습니다. 데이터 소스를 생성하거나 편집할 때 경우에 따라 방문자 ID가 필요합니다.
...
자세한 내용은 [Adobe Social 릴리스 노트](https://marketing.adobe.com/resources/help/ko_KR/social/c_rel_notes.html)를 참조하십시오.
