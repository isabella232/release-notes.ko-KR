...
* [!DNL  Marketing Cloud] 와 [!DNL  Media Optimizer] (와) 간의 Single Sign-On 이 되지 않았던 문제를 수정했습니다.

**알려진 문제**

* 알려진 문제로 인해 연결된 [!DNL Analytics] 계정이 소유하지 않은 보고서 세트에서 대상 공유가 되지 않습니다. 해결하기 위한 노력이 진행 중입니다.
...
* 이제 [!DNL  Adobe Target][!DNL  Mobile] 세션을 기간 동안 IMS 조직에 연결할 수 있습니다.
...
* 데이터 웨어하우스에 세그멘테이션 지표로 지원을 추가하여 보고서와 [!DNL Analytics] 데이터 *` campaign instances`* 웨어하우스 데이터 간 불일치를 수정했습니다.
...
<table id="table_E8F149CB37804A42878657728501997B"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p><span class="wintitle">소셜</span> 태그를 집중 위치로 사용하여 <span class="keyword">Social</span>에서 사용하는 태그를 관리해 보십시오 . </p> <p>소셜 태그는 <span class="keyword">Social</span> 내 컨텐츠를 분류하는 데 도움이 됩니다. 예를 들어 소셜 연락처 프로필, 중재 피드의 인바운드 컨텐츠 및 <span class="wintitle">컨텐츠 달력</span>이나 <span class="wintitle">게시자</span>에서 생성된 아웃바운드 게시물에 태그를 지정할 수 있습니다 . </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p>어디서나 게시 기능 </p> </td> 
   <td colname="col2"> <p>게시는 <span class="keyword">Adobe Social</span> 내에서 가장 많이 사용되는 기능입니다. <span class="wintitle"> 어디서나 게시 기능</span>을 사용하면 소셜 네트워크에 컨텐츠를 게시하는 기능을 <span class="keyword">Social</span> 내 어디에서나 사용할 수 있습니다 . </p> <p> <p>참고: <span class="wintitle">어디서나 게시 기능</span> 기능은 현재 베타에 있습니다. </p> </p> </td> 
  </tr> 
 </tbody> 
</table>
