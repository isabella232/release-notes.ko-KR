...
* Data Source API 메서드가 Swagger로 마이그레이션되었습니다. 메서드, 구문 및 코드 샘플은 [Audience Manager API Docs](https://bank.demdex.com/portal/swagger/index.html) 섹션을 참조하십시오.
