...
* <span class="term">대상 라이브러리</span> 및 <span class="term">고객 특성</span> 메뉴 모음이 이제 <span class="term">대상자</span> 아래에 있습니다.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Reports &amp; Analytics에서는 SiteCatalyst 15의 도입 이후 "트래픽 데이터 소스" 유형의 데이터 소스를 지원하지 않았습니다. 데이터 소스 사용자 인터페이스를 사용하면 여전히 트래픽 데이터 소스를 만들 수 있지만, 이러한 데이터 소스는 회사가 SiteCatalyst 14에서 SiteCatalyst 15로 마이그레이션한 날짜 이전의 날짜 범위에만 적용할 수 있습니다. 다음 달(2015년 6월), Adobe는 트래픽 데이터 소스를 옵션으로 제거할 계획입니다. 6월에는 Reports &amp; Analytics에 트래픽 데이터 소스 없이도 간단한 트래픽 지표를 만들 수 있도록 해주는 새로운 기능들을 도입하게 됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Data warehouse은 Analytics 보고 API 1.4를 지원합니다. </p> <p>개발자 연결 웹 사이트에서 데이터 웨어하우스 API 설명서의 <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a>를 참조하십시오. </p> </td> 
  </tr> 
 </tbody> 
</table>
