...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> 2015년 6월에 제공될 데이터 소스 수정 </td> 
   <td colname="col2"> <p>Reports &amp; Analytics에서는 SiteCatalyst 15의 도입 이후 "트래픽 데이터 소스" 유형의 데이터 소스를 지원하지 않았습니다. 데이터 소스 사용자 인터페이스는 여전히 트래픽 데이터 소스를 만들 수 있지만, 이 유형의 데이터 소스는 회사가 SiteCatalyst 14에서 SiteCatalyst 15으로 마이그레이션한 날짜 이전의 날짜 범위에만 적용할 수 있습니다. 다음 달(2015년 6월), Adobe은 트래픽 데이터 소스를 옵션으로 제거할 계획입니다. 6월에는 Reports &amp; Analytics에 트래픽 데이터 소스 없이도 간단한 트래픽 지표를 만들 수 있도록 해주는 새로운 기능들을 도입하게 됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
다음 플랫폼에 대한 [ 릴리스 내역은 ](https://docs.adobe.com/content/help/en/analytics/implementation/appmeasurement-release-notes/c-release-notes-mjs.html)AppMeasurement 릴리스 내역[!DNL  AppMeasurement]을 참조하십시오.
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>타임라인에 표시되지 않지만 직접 링크를 통해 액세스할 수 있는 게시물을 Facebook에 만듭니다. 이 옵션을 사용하면 콘텐츠 작성자가 스폰서가 있는(유료) 광고로 승격할 게시물을 만들 수 있습니다. </p> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>현재 <span class="keyword">Adobe Analytics</span>에서 보고할 수 없는, 소셜 네트워크에서 받는 지표가 있습니다. New reserved events let you create custom reports in  <span class="wintitle"> Analytics </span> to view social data alongside web data. </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>비디오의 아무 곳에서나 정지 프레임을 선택하여 업로드하고 게시물에서 해당 비디오의 축소판 이미지로 사용합니다. 이전에는 <span class="keyword">Social</span>에서 썸네일 이미지로 사용할 시작 프레임을 선택했습니다. 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>2015년 3월 1일에 Adobe Social은 트윗의 지역 타깃팅에 대한 지원을 중단했습니다. Twitter를 사용한 후 지역 타깃팅을 다시 사용할 수 있습니다. </p> 
...
* 게시물이 때로 시간 초과 오류가 발생하여 실패했던 문제를 수정했습니다.
* 웹 사이트 내의 페이지에 대한 링크가 회사 홈페이지로 리디렉션되는 단축 링크 문제를 수정했습니다.
...
In the VisitorAPI / AppMeasurement Audience Manager Module integrations, there will be two destination publishing iFrame requests made in IE6-9: `//fast.<subdomain>.demdex.net/dest5.html` and `//fast.<subdomain>.demdex.net/dest4.html`. 다른 브라우저에 표시될 때 올바른 동작은 `//fast.<subdomain>.demdex.net/dest5.html`.
