...
>[!NOTE]
>
>[Adobe Priority Product Update](https://www.adobe.com/kr/subscription/priority-product-update.html)에 가입하면 릴리스 노트를 월별 제품 업데이트 1주일 전에 받아 볼 수 있습니다. Priority Product Update의 릴리스 정보는 릴리스 날짜 1주일 전에 제공되며 변경될 수 있습니다. 업데이트를 위해 릴리스 시간을 다시 확인하십시오.
...
왼쪽 탐색 메뉴가 모든 핵심 서비스 및 솔루션에 액세스할 수 있도록 업데이트 및 구성되었습니다. 주목할 만한 변경 사항은 다음과 같습니다.
* <span class="term">대상 라이브러리</span> 및 <span class="term">고객 속성</span> 메뉴 모음이 이제 <span class="term">대상자</span> 아래에 있습니다.
...
* 일부 고객의 경우 고객 특성이 동기화되지 않던 문제를 수정했습니다.
...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 획득 링크에 대한 데스크톱 브라우저 지역 재정의를 추가했습니다. 이 설정을 사용하면 사용자가 데스크톱 브라우저에서 링크를 클릭할 때 획득 링크가 가리킬 지역별 앱스토어를 선택할 수 있습니다. </p> <p> 이 기능은 획득 링크를 만들 수 있는 관리 권한이 있는 사용자(모바일 앱 관리자)만 설정할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_1A8173DB38E8426D96BB7C57BF8FD2D5"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> iOS SDK 버전 4.5부터 새로운  iOS 확장을 사용하면 Apple Watch 앱, 오늘 위젯, 사진 편집 위젯 및 기타 모든  iOS 확장 앱의 사용 데이터를 수집할 수 있습니다. </p> <p><a href="https://docs.adobe.com/content/help/ko-KR/mobile-services/ios/overview.html" format="https" scope="external">Marketing Cloud 솔루션용 iOS SDK 4.x</a> 안내서의 <a href="https://docs.adobe.com/content/help/ko-KR/mobile-services/ios/ios-ext/ios-ext.html" format="https" scope="external">iOS 확장 구현</a>을 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Android SDK 버전 4.5 </p> </td> 
   <td colname="col2"> <p> Android SDK 버전 4.5부터 새로운  Android 확장을 사용하여  Android Wearable 앱에서 데이터를 수집할 수 있습니다. </p> <p><a href="https://docs.adobe.com/content/help/ko-KR/mobile-services/android/overview.html" format="https" scope="external">Marketing 솔루션용 Android SDK 4.x</a> 안내서의 <a href="https://docs.adobe.com/content/help/ko-KR/mobile-services/android/wearables-android/android-wearable.html" format="https" scope="external">Android Wearable 구현</a>을 참조하십시오. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Data Warehouse 보고를 위해 "마케팅 채널 마지막 터치 인스턴스" 지표를 추가했습니다. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 2015년 6월에 제공될 Data Sources 수정 </td> 
   <td colname="col2"> <p>Reports &amp; Analytics에서는 SiteCatalyst 15의 도입 이후 "트래픽 데이터 소스" 유형의 데이터 소스를 지원하지 않았습니다. 데이터 소스 사용자 인터페이스를 사용하면 여전히 트래픽 데이터 소스를 만들 수 있지만 이 유형의 데이터 소스는 회사가 SiteCatalyst 14에서 SiteCatalyst 15으로 마이그레이션한 날짜 이전의 날짜 범위에만 적용할 수 있습니다. 다음 달(2015년 6월), Adobe은 옵션으로 트래픽 데이터 소스를 제거할 계획입니다. 6월에는 Reports &amp; Analytics에 트래픽 데이터 소스 없이도 간단한 트래픽 지표를 만들 수 있도록 해주는 새로운 기능들을 도입하게 됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>데이터 웨어하우스는 Analytics 보고 API 1.4를 지원합니다. </p> <p>개발자 연결 웹 사이트에서 데이터 웨어하우스 API 설명서의 <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a>를 참조하십시오. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
다음 플랫폼에 대한 [ 릴리스 내역은 ](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html)AppMeasurement 릴리스 내역[!DNL  AppMeasurement]을 참조하십시오.
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>타임라인에 표시되지 않지만 직접 링크를 통해 액세스할 수 있는 Facebook 게시물을 만듭니다. 이 옵션을 사용하면 콘텐츠 작성자가 스폰서가 있는(유료) 광고로 승격할 게시물을 만들 수 있습니다. </p> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>현재 <span class="keyword">Adobe Analytics</span>에서 보고할 수 없는, 소셜 네트워크에서 받는 지표가 있습니다. 새로운 예약 이벤트를 사용하면 <span class="wintitle"> 분석 </span>에서 사용자 지정 보고서를 만들어 웹 데이터와 함께 소셜 데이터를 볼 수 있습니다. </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>비디오의 아무 곳에서나 스틸 프레임을 선택하여 게시물에서 비디오의 축소판 이미지로 업로드하고 사용합니다. 이전에는 <span class="keyword">Social</span>에서 썸네일 이미지로 사용할 시작 프레임을 선택했습니다. 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>2015년 3월 1일에 Adobe Social은 트윗의 지역 타깃팅에 대한 지원을 중단했습니다. twitter을 사용한 후 지역 타깃팅을 다시 사용할 수 있습니다. </p> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>이제 이전에 삭제한 태그 그룹 또는 태그와 동일한 이름으로 태그 그룹 또는 태그를 만들 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 게시물이 때로 시간 초과 오류가 발생하여 실패하던 문제를 수정했습니다.
* 웹 사이트 내의 페이지에 대한 링크가 회사의 홈 페이지로 리디렉션되는 단축 링크 문제를 수정했습니다.
...
VisitorAPI/AppMeasurement Audience Manager 모듈 통합에는 IE6-9에서 수행된 2개의 대상 게시 iFrame 요청이 있습니다.`//fast.<subdomain>.demdex.net/dest5.html` 및 `//fast.<subdomain>.demdex.net/dest4.html`. 다른 브라우저에 표시될 때 올바른 동작은 `//fast.<subdomain>.demdex.net/dest5.html`.
...
<table id="table_3C13024F4D754E2C98D7B8434A3497EF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.adobe.com/content/help/ko/core-services/interface/ec-cookies/cookies-first-party.html" format="https" scope="external"> Adobe 관리 인증서 프로그램 </a> </p> </td> 
