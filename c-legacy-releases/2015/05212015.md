...
*  <span class="term">대상 라이브러리 </span>및 <span class="term">사용자 특성 </span>메뉴 선택이 이제 <span class="term">대상자</span> 아래에 있습니다.
...
이 변경에 대한 자세한 내용은 [방문자 ID 서비스 구현)https://marketing.adobe.com/resources/help/ko-KR/mcvid/?f=mcvid_implement](을 참조하십시오.
...
이러한 새로운 기능에 대한 교육 동영상은 [2015년 5월 새로운 기능](https://bit.ly/1JSO2k5)을 참조하십시오.
...
| 기능 | 설명 |
|---|---|
| [Audience Marketplace](https://marketing.adobe.com/resources/help/ko-KR/aam/c_audience_marketplace.html) | [!DNL  Audience Marketplace]에서는 데이터 구매자와 데이터 제공자가 최소의 노력으로 셀프 서비스 방식으로 데이터 거래를 수행할 수 있도록 해주는 전문 기능을 제공합니다. 시작하려면 [!DNL  Audience Manager] 컨설턴트에게 문의하십시오. [!DNL  Audience Marketplace]를 활성화해줄 수 있습니다. |

**수정 사항, 개선 사항 및 중단 사항**

* [그룹 만들기](https://marketing.adobe.com/resources/help/ko-KR/aam/t_create_groups.html): 그룹을 만들고 권한을 지정하는 간단한 단계 및 지침입니다.
* [와일드카드 권한 이해](https://marketing.adobe.com/resources/help/ko_KR/aam/c_wildcard_permissions.html): [!DNL  Wild Card Permissions]을 사용하여 그룹 구성원에게 자동으로 새로운 데이터 소스에 대한 액세스 권한을 부여할 수 있습니다. 표준 권한을 사용할 경우에는 수동으로 새 데이터 소스를 그룹에 지정해야 합니다.
