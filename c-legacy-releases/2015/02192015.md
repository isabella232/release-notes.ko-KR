...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Marketing Cloud에서 솔루션 계정을 연결할 때, 여러 솔루션 및 조직이 있는 경우 이제 여러 제품 및 서비스를 하나의 조직에 매핑할 수 있습니다. </p> <p><a href="https://marketing.adobe.com/resources/help/ko_KR/mcloud/organizations.html" format="https" scope="external">계정 및 조직</a>을 참조하십시오 . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9F4F40B4329443AC88F07B74660407C3"> 
     ...
     <li id="li_8EEB2C69113C43349F2B5E3AD9352B7B">지표 세트를 기본값으로 저장하지 않고 실행하는 기능이 추가되었습니다. 이제 표준 보고서 및 Analytics 보고서와 더 일관되게 표시됩니다. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="wintitle"> Analytics </span> 분류 규칙 - 기존 값을 덮어씁니다. </p> </td> 
...
* 순차적 세그먼트에 대한 업데이트 간 차원. 컨테이너 간 일치를 식별하는 사이 인스턴스 논리와 마찬가지로, 이제 사이 차원은 차원 값을 기반으로 논리를 제공하는 차원 제한 기능을 포함하고, 특정 값(테이블 행)을 기준으로 일치를 확인하여 선택한 차원이 설정되어 있는지 여부를 추적한 다음 이러한 차원 값을 기반으로 세그먼트 논리를 제공할 수 있습니다.
