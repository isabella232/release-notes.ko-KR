...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.adobe.com/docs/en/aem/6-1/author/personalization/ct-touch.html" format="https" scope="external"> 타깃팅된 컨텐츠 작성 </a> </p> </td> 
   <td colname="col2"> <p> AEM 터치에 적합한 UI의 타깃팅 모드를 사용하여 타깃팅된 컨텐츠를 작성합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> MSM(Multi Site Manager)을 사용하여 여러 위치의 동일한 사이트 컨텐츠를 사용합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe는 AMP(가속 모바일 페이지) 프로젝트에 참여하고 있습니다. AMP는 빠르게 렌더링되는 정적 컨텐츠의 웹 페이지를 작성할 수 있는 개방형 소스 프로젝트입니다. 이 기능은 모바일에 최적화된 컨텐츠를 한 번 만든 후 모든 위치에서 즉시 로드하려는 게시자에게 이상적입니다. </p> </td> 
