...
수정된 [!DNL  Analytics] 고객용 ID 서비스 구현 절차. [Marketing Cloud ID Service 및 Analytics 설정하기](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-analytics.html)를 참조하십시오.
