...
| 기능 | 설명 |
|--- |--- |
| 앱 충돌 추적 |  iOS SDK 버전 4.8.6에는 잘못된 충돌이 보고되지 않는 중요한 변경 사항이 포함되어 있습니다. 버전 4.8.6으로 업데이트할 것을 강력히 권장합니다. |
...
버전 1.5.4에는 다음 변경 사항이 포함되어 있습니다.
...
수정된 [!DNL  Analytics] 고객용 ID 서비스 구현 절차. Analytics [를 사용하여 Marketing Cloud ID 서비스 설정을 참조하십시오](https://docs.adobe.com/content/help/ko-KR/id-service/using/home.html).
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 <thead> 
  <tr> 
   ...
   <th colname="col02" class="entry"> 추가된 날짜 </th> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">처리 규칙을 만들거나 편집할 수 없는 문제를 수정했습니다. (AN-118939) </li> 
      <li id="li_81ED9C850197465BB2E8ACE1AC9C59E6">20자를 초과하는 사용자 이름에 대해 암호를 재설정할 수 없는 문제가 해결되었습니다. (AN-115603) </li> 
      <li id="li_A477D5A9DEAE4B4092990612AB2A0A59">드릴다운 패널 레이블이 중복되는 기여도 분석 문제를 해결했습니다. (AN-118627) </li> 
      <li id="li_11840BC1D1A74248A1AD9E9B509BA5BD">일별 세부기간을 선택할 때 데이터가 표시되지 않던 대시보드 reportlet 문제를 수정했습니다. (AN-117755) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_018BD45725944884BBF0B4C61116F5EF"> 
      <li id="li_12A2EED797D440649E4C4CC89434CC84">구성 요소를 서로 너무 빠르게 드래그하여 놓을 때 발생하는 문제를 수정했습니다. 이 문제로 인해 다른 요청이 여전히 처리 중인 동안 구성 요소를 드래그한 경우 테이블에 검은색 드롭 표시기가 지속되었습니다. (AN-118836) </li> 
      <li id="li_80727A266F0C4D3EBC486D5357F2943D"><span class="wintitle">프로젝트 정보</span> 창 이름의 현지화가 수정되었습니다. (AN-118612) </li> 
      <li id="li_9AFA60D53A8F42FD8392E3C4E2D25F29">드물게 프로젝트를 새로 고칠 때 시각화가 위치를 재설정하는 문제를 해결했습니다. (AN-115865) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">Adobe Marketing Cloud에서 Adobe ID을 사용하여 Ad Hoc Analysis을 실행할 때를 열 수 없는 문제가 해결되었습니다. (AN-102875) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
* 트렌드 보고서에 현재 날짜로부터 하루 떨어진 결과가 표시되는 버그가 수정되었습니다. 동유럽 표준 시간대에만 영향을 줍니다. (AAM-22321)
* 데이터 공급자가 브랜드 없는 비공개 데이터 피드를 활성화하지 못하게 하는 Audience Marketplace 버그를 수정했습니다. (AAM-23377)
* 데이터 소스 만들기 워크플로우의 ID 유형 옵션을 &quot;모바일&quot;에서 &quot;장치 광고 ID&quot;로 변경했습니다. (AAM-22947)
...
* 긴 링크가 있는 중재 피드의 게시물에 가로 스크롤 막대가 포함되도록 UI 문제를 수정했습니다.
* 문제 제기 중재 피드에 일부 게시물이 표시되지 않던 문제를 수정했습니다.
...
안정성, 보안 및 성능 향상을 위해 최신 권장 패치를 배포하려면 온-프레미스 배포를 사용하는 것이 좋습니다.

| AEM 자산 포럼 | 설명 |
|--- |--- |
| AEM 자산 포럼 | 우리의 새로운 AEM Assets 하위 포럼이 이제 생방송으로 연결되었습니다. 이 포럼에서는 다음을 다룹니다.자산(온-프레미스), Assets on Demand, 브랜드 포털, 다이내믹 미디어 및 Scene7. 누구나 로그인하여 게시할 수 있습니다. Adobe ID에 로그인하기만 하면 됩니다. |


| 컨퍼런스 | 설명 |
|--- |--- |
| Adobe Immerse | Immerse는 4월 25~29일에 열리는 가상 Adobe Experience Manager 개발자 컨퍼런스입니다. 이 이벤트는 Adobe Experience Manager 구현의 디자인, 개발, 배포 또는 유지 관리를 담당하는 누구나 &quot;참석해야 하는&quot; 좋은 기회입니다.  티켓 및 자세한 내용은 Adobe Immerse 웹 사이트를 참조하십시오. |
