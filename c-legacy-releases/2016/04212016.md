...
>[!IMPORTANT]
>
>[!DNL  Recommendations Classic] 사용자 [!DNL  Search&Promote] 로그인 알림. 업데이트된 Marketing Cloud 인터페이스에서는 **[!UICONTROL Analytics]** &gt; **[!UICONTROL 도구]** 메뉴에서 해당 링크에 액세스할 수 있습니다.
...
설명서에는 [!DNL  Target]에 대한 새로운 절차 컨텐츠가 포함되어 있습니다. Marketing Cloud ID Service [구현을 참조하십시오 ](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-setup-target.html).
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이번 릴리스에서 이러한 기능의 이름이 바뀌었거나 삭제되었거나, 설치 파일이나 폴더가 재구성되었습니다. </p> <p> 
    ...
    <ul id="ul_7B6DDED9E1FE47328FDB5422A547AE52"> 
     <li id="li_69D665FD85364FBB899BBB0A3EBA0967"> <p> 클립보드에서 작업 공간으로 컨텐츠를 붙여넣기 위한 Ctrl+V가 추가되었습니다. </p> </li> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     ...
     </ul> </p> <p>릴리스 정보를 더 보려면 <a href="https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/?f=c_release_notes_insight_62" format="http" scope="external">데이터 워크벤치 6.2 업데이트</a>를 참조하십시오. </p> <p> <b>알려진 문제</b> </p> <p> 
