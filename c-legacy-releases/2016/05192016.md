...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Enterprise Dashboard에서 사전 구성된 제품 구성 </p> </td> 
   <td colname="col2"> <p>Marketing Cloud 고객 관리자는 미리 만들어져 Analytics 및 다이내믹 태그 관리에 대한 기본 권한 그룹에 매핑된 제품 구성을 활용할 수 있습니다. </p> <p>이 최적화는 새롭게 제공된 조직에 대해 사용할 수 있으며 조직에서 Enterprise Dashboard에서 사용자를 관리하는 데 필요한 시간을 줄입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>피드 개선 사항 </p> </td> 
   <td colname="col2"> <p> 이제 Marketing Cloud 피드에서 새 게시물을 만들 때 받는 사람 라인은 기본적으로 조직을 사용하는 대신 현재 활성화된 주제를 사용합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Assets on Demand에서 Marketing Cloud 피드로 공유된 에셋에 대해 축소판이 표시되지 않던 문제를 수정했습니다. (MAC-29955)
...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>고객 확보 추적 개선 사항 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>인앱 및 푸시 메시지 대상</b> </p> <p>마케터는 작성의 편의를 높이기 위해 "대상" URL을 선택하여 링크 관리자에 저장된 링크에서 저장된 웹 또는 앱 딥 링크를 호출하거나 링크를 인라인 제공할 수 있습니다. </p> 
    <ul id="ul_379FB0A30634422AAFD3B708D562E6D7"> 
     <li id="li_62C4475E78E84657A2AA193C7CA34856"> <p>사용자 지정 웹 링크 또는 딥 링크를 수동으로 입력합니다. </p> </li> 
...
이 릴리스에는 다음 변경 사항, 개선 사항 및 수정 사항이 포함되어 있습니다.
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_0A126115FB8E4C8B81D0FDBBB63C9F85"> 
     <li id="li_FD2534C49B244AAE9729E99C6FED9E03">1.5.5(베타):일부 특정 고객을 위한 테스트 버전입니다. 이 버전은 사용하지 마십시오. </li> 
     <li id="li_D8226C3FEAF7458BB806EA75370223C9">1.5.6:코드를 업데이트해야 하는 경우 이 버전을 사용하십시오. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>버그 수정</b> </p> </td> 
   <td colname="col2"> <p>조직 ID가 여러 개인 경우 잘못된 회사 이름을 반환하는 버그를 수정했습니다. (AAM-23861) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>설명서</b> </p> </td> 
   <td colname="col2"> <p>Marketing Cloud ID를 Data Workbench에 통합하는 방법을 설명하는 새 설명서를 추가했습니다. <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-dwb.html.html" format="https" scope="external">Data Workbench 및 Marketing Cloud ID 서비스</a>를 참조하십시오 . (AAM-23727) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Analysis Workspace:추가된 필터 유형 </td> 
   <td colname="col2"> <p><span class="wintitle">예약된 프로젝트 관리자</span> 내에 필터 유형 "실패함"을 추가했습니다 . 이 기능은 반복되는 실패로 인해 더 이상 실행되지 않는 예약된 모든 프로젝트를 보여줍니다. 기본적으로 선택되어 있지 않습니다. 실패한 각 인스턴스에는 마우스를 위로 가져가면 실패 이유를 나타내는 경고 아이콘이 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 관리 도구:비디오 및 비디오 광고 메타데이터 </td> 
   <td colname="col2"> <p><span class="uicontrol">관리 도구</span> &gt; <span class="uicontrol">보고서 세트</span> &gt; <span class="uicontrol">설정 편집</span> &gt; <span class="uicontrol">비디오 관리</span>에서 보고서 세트의 비디오 설정을 편집할 경우 [비디오 및 비디오 광고 메타데이터] 확인란을 통해 추가 비디오 보고 기능을 사용하도록 설정할 수 있습니다. 비디오 및/또는 광고에 메타데이터를 첨부할 수 있으므로 해당 비디오나 광고를 추가적으로 설명하고 분류할 수 있습니다. 표준화된 비디오 및 광고 메타데이터는 솔루션 변수 및 분류를 통해 수집됩니다. </p> <p>값은 다음과 같습니다.표시, 시즌, 에피소드, 자산 ID, 장르, 첫 번째 방송 날짜, 첫 번째 디지털 날짜, 컨텐츠 등급, 작성자, 네트워크, 표시 유형, 광고 로드, MVPD, 인증, 당일 파트, 비디오 세션 ID, 광고주, 캠페인 ID 및 크리에이티브 ID. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Activity Map </td> 
   <td colname="col2"> 
    <ul id="ul_B6AD0D7125EB43A990C9B3D87F9C8A1D"> 
     <li id="li_1AD24DDE8C4149DCAB3BAB6E19D5313D">이제 Activity Map Internet Explorer 확장 버전을 다운로드하여 설치할 수 있습니다. </li> 
     <li id="li_7EB1AEF08CB34E10BBBE2E58C1890AC2">선택한 세그먼트를 보기 위해 모든 세그먼트를 스크롤할 필요가 없도록 세그먼트 드롭다운 패널 하단에 선택한 세그먼트 목록을 추가했습니다. (AN-122464) </li> 
  ...
  <tr> 
   <td colname="col1"> 모바일 메시징 보고 </td> 
   <td colname="col2"> <p>모바일 메시징 로컬 알림 보고에 대한 지원이 추가되었습니다. </p> <p>새로운 이벤트 보고서는 <span class="ignoretag"><span class="uicontrol">모바일 앱</span> &gt; <span class="uicontrol">메시지 보고서</span> &gt; <span class="uicontrol">In-App 메시지 노출</span></span>에 있습니다  
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">여러 보고서 세트에 대한 eVar를 동시에 편집하려고 할 때 발생하는 문제를 수정했습니다. 메뉴가 38을 지나 로드되지 않습니다. (AN-120804) </li> 
      ...
      <li id="li_FA4F75C0A239423B94394E94345D84C3">처리 규칙이 복사되지 않는 문제를 해결했습니다. (AN-122109) </li> 
      <li id="li_81F059A6216A4026B336FFBDF3AA0670">Analytics와 Target 간에 대상 공유가 되지 않던 문제를 수정했습니다. (AN-120472) </li> 
      <li id="li_74AF4B656E94428F803C8116EFDF33D2">많은 수의 필터가 적용된 보고서가 다운로드되지 않는 문제를 해결했습니다. (AN-122771) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      ...
      <li id="li_1F32EAB8E7814E02955C0FD545970838">집단 및 자유 형식 분석 간의 "고유 방문자 수" 데이터 불일치 문제를 해결했습니다. (AN-122449) </li> 
      <li id="li_F26FFE0694804EC3B9FEAC54586DAC93">사용자 지정 폭 및 높이로 자유 형식 패널을 최소화할 때 발생하는 표시 문제를 해결했습니다. (AN-122651) </li> 
      <li id="li_0066E2796ABA45278BA0D5984DC209B4"><span class="wintitle">요약 번호 시각화</span>가 표 합계를 표시하지 않는 문제를 해결했습니다. (AN-122728) </li> 
      <li id="li_BC5743B301F24B138CF2CB412C0E31A0">목록이 화면 크기의 감소에 따라 조정되지 않는 표시 문제를 해결했습니다. (AN-122815) </li> 
      <li id="li_74155E28492C4772A09D66AF12EC278B">"텍스트" 시각화 유형을 자유 형식 패널로 드래그할 때 텍스트 상자의 오류를 해결했습니다. (AN-122801) </li> 
      <li id="li_BB724E9101A8490496A28EA04D7B3D7A">로컬라이즈된 환경에서 예약된 프로젝트를 PDF로 받을 때 이메일 본문에 대한 표시 문제를 해결했습니다. (AN-121967) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3043079A3AAA425683D252708FDD7D19"> 
      <li id="li_1C899F516436470E91C427C3E7CE35DA">"도시" 보고서가 모든 Analytics 도구에 알 수 없는 값을 표시하는 문제를 해결했습니다. (AN-121533) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Activity Map </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">취소된 일부 Data Warehouse 요청이 잘못된 상태를 표시하는 문제를 해결했습니다. (AN-122436) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="codeph"> full_response </span> 
     <!--AN-122485--> </p> <p> 새로운 선택적 매개 변수 <span class="codeph">full_response</span>를 <span class="codeph">ReportSuite.Create</span>에 추가했습니다 . 이 매개 변수가 포함되어 있고 "true"로 설정되면 응답은 부울이 아닌 개체가 됩니다. </p> <p><a href="https://marketing.adobe.com/developer/documentation/analytics-administration-1-4/r-create-1" format="https" scope="external">ReportSuite.Create</a>를 참조하십시오 . </p> <p> <b>사용 중지 알림</b> </p> <p> 웹 서비스 API의 버전 1.2는 2014년 2월 20일에 공식적으로 사용 중지되었습니다. 2016년 9월 15일에 수명이 종료됩니다. 이때 Adobe은 버전 1.2 API 요청에 응답하는 API 서버의 기능을 제거합니다. <span class="filepath">https://api.omniture.com/admin/1.2</span> 종단점에 대한 모든 API 요청은 404를 반환합니다. 
    </p> </td> 
  </tr> 
  <tr> 
...
* 보류 중인 상태인 사용자 계정을 비활성화하지 못하게 하는 관리자 UI의 버그를 수정했습니다. (AAM-16087)
* 일시 중지된 세그먼트를 다시 활성화할 수 없는 버그를 수정했습니다. (AAM-23938)
* 선택한 [프로필 병합 규칙] 확인란을 선택 취소하지 못했던 버그가 수정되었습니다. (AAM-23359)
* 개인 데이터 피드를 활성화하지 못하게 하는 버그를 수정했습니다. (AAM-23395 및 관련, AAM-23377)
* Audience Marketplace에서 데모 데이터를 표시하는 버그를 수정했습니다. (AAM-23837)
* 페이지에서 나갔다가 나중에 반환할 때 검색 결과를 유지하는 대상 검색 도구의 버그를 수정했습니다. (AAM-23860)
* 다른 화면으로 이동할 때 탐색 표시 탐색 기능이 업데이트되지 않던 버그를 수정했습니다. (AAM-24120)
* 트레이트 화면 및 그래프가 제대로 표시되지 않던 버그를 수정했습니다. (AAM-24141)
* 사용자 및 그룹 섹션이 제대로 표시되지 않던 버그를 수정했습니다. 관리 액세스 권한이 있는 사용자만 영향을 받습니다. (AAM-24144)

**설명서 업데이트**

## [!DNL Social]

[대상](https://marketing.adobe.com/resources/help/en_US/aam/c_destinations.html) 섹션을 수정했습니다. 변경 사항에는 간소화된 절차 문서 및 재구성된 콘텐츠가 포함됩니다.
...
* 승인 워크플로우 중에 중복된 이메일 메시지가 전송되던 문제를 수정했습니다.
* 실패한 캠페인 추적을 나타내는 이메일 메시지를 수신하게 하는 문제를 해결했습니다.
...
안정성, 보안 및 성능 향상을 위해 권장 패치를 배포하려면 온-프레미스 배포를 사용하는 것이 좋습니다.
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Experience Manager 6.2는 Adobe Experience Manager 6.1의 코드 베이스에 대한 업그레이드 릴리스입니다. 이 버전은 새롭고 향상된 기능, 주요 고객 수정 사항, 높은 우선 순위의 고객 개선 사항 및 제품 안정화를 위한 일반적인 버그 수정을 제공합니다. 또한 Adobe Experience Manager 6.1 기능 팩, 핫픽스 및 서비스 팩 릴리스가 포함되어 있습니다. </p> <p> <a href="https://www.adobe.com/marketing-cloud/enterprise-content-management/new-capabilities.html" format="http" scope="external"> 새로운 기능</a> </p> <p> <a href="https://docs.adobe.com/docs/kr/aem/6-2/release-notes.html" format="https" scope="external"> 릴리스 노트 </a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>핫픽스 팩은 2016년 6월에 출시될 예정입니다. 핫픽스 팩은 <a href="https://docs.adobe.com/docs/en/aem/6-2/release-notes/known-issues.html" format="https" scope="external">AEM 6.2의 일부 알려진 문제</a>를 해결합니다 . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D0FFD1AD5C0D4BAA81BAEC60E8B2290F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Experience Manager의 Gems는 Adobe 전문가가 전달하는 일련의 기술 심층 잠수입니다. 이 시리즈는 제품 설명서 및 기술 채널을 보완하며 개발자는 특정 주제를 접하고 살펴볼 수 있습니다. </p> <p>다음 세션은 2016년 6월 1일 수요일입니다. AEM 웹 성능입니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>2016년 5월 24일에 열리는 이 심층 세션을 통해 Experience Manager에서 커뮤니티 기능이 작동하는 방식을 살펴볼 수 있습니다. 프레젠테이션 및 라이브 데모 외에도 주제 전문가가 AEM Communities과 관련된 질문에 답변합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Experience Manager에는 클래식 및 터치에 적합한 UI가 포함되어 있습니다. 이와 같이 "고객을 위한 사용자 인터페이스 Recommendations" 항목에서는 프로젝트 구현 중에 어떤 UI를 가장 잘 사용할 것인지 또는 이전 릴리스에서 업데이트할 것인지 결정하는 데 도움이 될 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
