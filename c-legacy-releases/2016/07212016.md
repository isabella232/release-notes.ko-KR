...
* 새로운 설명서: [Analytics 및 Audience Manager용 Marketing Cloud ID 서비스 구현](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-aam-analytics.html)
* 수정된 설명서: [Marketing Cloud ID 서비스 테스트 및 확인](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-test-analytics.html)
