...
* ID 서비스 iFrame에 제목 속성이 추가되었습니다. iFrame 제목 도움말 스크린 리더는 온라인 컨텐츠와 상호 작용할 때 지원이 필요한 사용자에게 페이지 정보를 제공합니다. iFrame 제목 속성이 ` Adobe ID Syncing iFrame`으로 설정되어 있습니다. (MCID-81)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="uicontrol">프로젝트</span> &amp;gt; <span class="uicontrol">프로젝트 정보</span>에서 정보 모델을 추가했습니다 . 이 패널에는 다음과 같은 프로젝트 정보가 표시됩니다. <!--(https://jira.corp.adobe.com/browse/AN-125284)-->
 </p> <p> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Developer Connection 컨텐츠 업데이트</b> (2016년 7월 25일 업데이트) </p> <p><a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external"> Classifications.CreateExport </a> 업데이트: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_505A2F423250452CBBD071B094A9ADC0"><span class="wintitle">레이아웃</span> 모드에 있는 동안 [컨텐츠 추가]를 클릭했을 때 Reportlet이 추가되지 않는 문제를 해결했습니다. (AN-97419) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
