...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>앱 설정 관리를 위한 새로운 권한 요구 사항 </p> </td> 
...
제품 설명서의 [Adobe Mobile](https://marketing.adobe.com/resources/help/ko_KR/mobile/) Services를 참조하십시오. 이전 릴리스의 릴리스 노트를 보려면 왼쪽 창에서 *이전 릴리스 노트*&#x200B;를 확장하십시오.

### 다이내믹 태그 관리 {#dtm}

| 기능 | 설명 |
|---|---|
| Marketing Cloud ID 서비스 도구 | 이제 페이지 맨 위에 DTM이 로드되어 있는 Marketing Cloud ID 서비스 도구를 사용하는 옵션이 기본적으로 활성화됩니다. |
...
[Marketing Cloud ID 서비스](https://docs.adobe.com/content/help/ko-KR/id-service/using/home.html) 제품 설명서를 참조하십시오.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>2016년 10월에 Analytics 관리자는 <span class="wintitle">Enterprise Dashboard</span>에서 사용자 및 제품 구성(그룹)을 관리할 수 있습니다 . Enterprise Dashboard는 Adobe의 마케팅, 크리에이티브 및 Document Cloud을 위한 관리 인터페이스입니다. </p> <p>다음을 수행할 수 있습니다. </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">제품, 도구, 제품, 보고서 세트 등의 제품 구성을 만듭니다. </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">사용자를 만들어 제품 구성에 할당합니다. </li> 
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">특정 제품 구성에 대한 사용자에게 관리 역할을 위임합니다. </li> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Developer Connection 콘텐츠 업데이트</b> (2016년 7월 25일 업데이트) </p> <p><a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external"> Classifications.CreateExport </a> 업데이트: </p> 
    ...
    </ul> <p> <b>사용 중지 알림</b> </p> <p> 웹 서비스 API의 버전 1.2는 2014년 2월 20일에 공식적으로 사용 중지되었습니다. 2016년 9월 15일에 수명이 종료됩니다. 이때 Adobe은 버전 1.2 API 요청에 응답하는 API 서버의 기능을 제거합니다. <span class="filepath">https://api.omniture.com/admin/1.2</span> 종단점에 대한 모든 API 요청은 404를 반환합니다. 
     </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">관리:Adobe ID을 사용하여 Marketing Cloud을 통해 로그인하는 사용자에 대해 활동 추적이 되지 않던 문제를 수정했습니다. 이 수정 사항은 회사 이름, 사용자 이름 및 암호를 통해 기존의 로그인 사용자에 대한 활동 추적을 복제합니다. (AN-124792) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      <li id="li_602B55D4F7DF4D0C8B240C0B43679808"> 이제 예약된 프로젝트는 브라우저의 시간대가 아닌 보고서 세트 시간대를 사용합니다. (AN-126233) </li> 
      ...
      <li id="li_413B05B2DE7B4910B80A334A4AD8D26A"> PDF 프로젝트를 크롬 브라우저에서 미리 볼 때 다운로드할 때 발생하는 오류가 수정되었습니다. (AN-123674) </li> 
      <li id="li_4584537608434E7CBCBCC18EA8F01B59">구성 요소를 배치하고 크기를 조절할 수 없는 문제를 해결했습니다(드문 경우). (AN-126175) </li> 
      <li id="li_976D720D2919457A91C2F4CC5DCBB54F">브라우저 세그먼트를 추가한 다음 테이블에서 브라우저 유형을 변경할 때 발생하는 세그먼트 정의 문제를 해결했습니다. (AN-126086) </li> 
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">주간 프로젝트 예약에서 요일이 인터페이스에 제대로 표시되지 않던 문제를 수정했습니다. (AN-125760) </li> 
      ...
      <li id="li_7B10BCEA62D1427BB5A7574A88B756FD">여러 지표와 세그먼트를 사용하는 프로젝트의 표 정렬 문제를 수정했습니다. (AN-126162) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Office 365를 통해 Excel 웹 인터페이스에서 처음 연 통합 문서 예약에 대한 지원이 개선되었습니다. (AN-118240 </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
     ...
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">JavaScript 오류를 발생시키는 문제를 수정했습니다."속성은 v:image에만 유효합니다." (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle">샘플 오류 보고서</span>는 인바운드 데이터 소스 파일의 레코드 처리에 대한 성공 및 실패율을 확인합니다. 오류 보고는 대화형 막대 차트에 데이터를 표시하고 요약 지표를 표 형식으로 제공합니다. 또한 고정 시간 간격에 대해 파일을 샘플링하고 각 오류 유형에 대해 가장 일반적인 오류를 표시하는 옵션이 포함되어 있습니다. </p> <p>7월 말에 기능이 릴리스되면 설명서를 사용할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
* Google 입찰 관리자를 v201601에서 v201603으로 업그레이드했습니다. (AAM-24618)
* 프로필 병합 규칙 보고에서 0이 표시되던 버그를 수정했습니다. (AAM-24685)
* 감사 테이블의 고유 키 오류로 인해 고객이 사용자 그룹을 편집하거나 삭제할 수 없었던 버그가 수정되었습니다. (AAM-24864)
* S2S 및 벌크 S2S 대상에 제한이 적용되지 않는 버그를 수정했습니다. (AAM-24905)
* 기존 로그인과 Marketing Cloud을 나누는 선의 스타일을 변경했습니다. (AAM-24378)
...
* 특정 링크 단축기를 활성화하는 전환 단추가 작동하지 않는 문제가 해결되었습니다.
* 중재자 응답이 중재에 표시되지 않던 문제를 수정했습니다.
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM에는 클래식 및 터치에 적합한 UI가 포함되어 있습니다. 이와 같이 "고객을 위한 사용자 인터페이스 Recommendations" 항목을 사용하면 가장 적합한 UI를 결정할 수 있습니다. 이 정보는 프로젝트 구현 중에 또는 이전 릴리스에서 업데이트할 때 유용합니다. </p> </td> 
  </tr> 
  <tr> 
