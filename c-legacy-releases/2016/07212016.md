---
description: 릴리스 노트 2016년 7월
keywords: 릴리스 노트
seo-description: 릴리스 노트 2016년 7월
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>앱 설정 관리에 대한 새로운 권한 요구 사항 </p> </td> 
...
| 기능 | 설명 |
|---|---|
| Marketing Cloud ID 서비스 도구 | 이제 페이지 상단에서 DTM 로드에서 Marketing Cloud ID 서비스 도구를 사용하는 옵션이 기본적으로 활성화됩니다. |
...
이 릴리스에서는 버전이 1.6.0으로 증가하며 다음 기능, 버그 수정 및 기타 변경 사항이 포함됩니다.
...
<table id="table_BEDD720754F84255A64598018911E336"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>CORS를 사용하면 브라우저가 현재 도메인이 아닌 도메인에서 리소스를 요청할 수 있습니다. <span class="keyword">Marketing Cloud</span> ID 서비스는 클라이언트 측의 교차 도메인 리소스 요청이 가능하도록 CORS 표준을 지원합니다. ID 서비스는 CORS를 지원하지 않는 브라우저에서는 JSONP 요청으로 되돌립니다. (AAM-23988) </p> <p>다음을 참조하십시오. </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-cors.html.html" format="https" scope="external"> Marketing Cloud ID 서비스의 CORS 지원 </a> </li> 
...
* 기본 ` loadTimeout` 값이 500밀리초에서 30,000밀리초(30초)로 변경됨 [ID 서비스 getInstance 함수에서 사용되는 변수](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_getinstance.html)를 참조하십시오. (MCID-96)
* ID 동기화 호출에 대한 ` d_fieldgroup` 매개 변수를 ` dpm.demdex.net`에 추가했습니다. 이 새 매개 변수는 내부 문제 해결 및 디버깅에 사용됩니다. (MCID-94)
* ID 서비스 iFrame에 제목 속성을 추가했습니다. iFrame 제목 도움말 스크린 리더는 온라인 콘텐츠와 상호 작용할 때 지원이 필요한 사용자에게 페이지 정보를 제공합니다. iFrame 제목 속성이 ` Adobe ID Syncing iFrame`으로 설정되어 있습니다. (MCID-81)
* ` idSyncAttachIframeASAP: true`가 ` Visitor.getInstance` 함수에서 설정할 수 있는 선택적 플래그로 추가됨. ` true`일 경우, ID 서비스는 최대한 빠르게 ID 동기화 iFrame을 로드합니다. ID 동기화 일치 비율을 개선하는 데 도움이 됩니다. 기본적으로 ID 서비스는 창을 로드할 때 iFrame을 로드합니다. (MCID-86)

**새로운 설명서 및 수정된 설명서**

* 새로운 설명서: [Analytics 및 Audience Manager용 Marketing Cloud ID 서비스 구현](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-setup-aam-analytics.html)
* 수정된 설명서: [Marketing Cloud ID 서비스 테스트 및 확인](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-test-analytics.html)

[Marketing Cloud ID 서비스](https://docs.adobe.com/content/help/en/id-service/using/home.html) 제품 설명서를 참조하십시오.
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>2016년 10월에 Analytics 관리자는 <span class="wintitle">Enterprise Dashboard</span>에서 사용자 및 제품 구성(그룹)을 관리할 수 있습니다 . Enterprise Dashboard는 Adobe의 마케팅, 크리에이티브 및 Document Cloud을 위한 관리 인터페이스입니다. </p> <p>다음을 수행할 수 있습니다. </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">제품, 도구, 제품, 보고서 세트 등에 대한 제품 구성을 만듭니다. </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">사용자를 만들어 제품 구성에 할당합니다. </li> 
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">특정 제품 구성에 대한 사용자에게 관리 역할을 위임할 수 있습니다. </li> 
     <li id="li_E8FD5A1C454F4AE4BE00B3CD9EB7BE4F">특정 차원 및 지표에 권한을 적용합니다. </li> 
    </ul> <p>또한 현재 관리 도구 사용자 관리 기능에는 중요한 개선 사항이 적용됩니다. </p> <p> <p class="important">중요: 자세한 내용은 <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external">2016년 가을 관리 제품 변경사항</a>을 참조하십시오. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> Flash용 AppMeasurement - 보안 업데이트 </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="uicontrol">프로젝트</span> &amp;gt; <span class="uicontrol">프로젝트 정보</span>에서 정보 모델을 추가했습니다 . 이 패널에는 다음 프로젝트 정보가 표시됩니다 
     ...
     <ul id="ul_AC21E32F5F6E4B2480455AE681F56BAB"> 
      ...
      <li id="li_E7E6A02B373A487699BE1CEA4E938F3F">마지막으로 수정한 날짜 </li> 
      <li id="li_212CE5A04D84449281CD8D78CD49F981">태그 </li> 
      <li id="li_40EECF14652A4787ABFD2E456BEB54AF">설명 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>(2016년 6월 추가) 신규 고객을 위한 간단한 구현 </p> </td> 
   <td colname="col2"> <p><span class="keyword">Marketing Cloud</span>를 통해 <span class="keyword">Analytics</span>에 로그인한 새로운 고객은 Analytics를 빠르게 구현한 다음(<span class="term">Adobe Analytics 시작하기</span> 양식 사용) 다이내믹 태그 관리를 사용하여 <span class="keyword">Analytics</span>를 배포할 수 있습니다. </p> <p>이 간단한 구현은 다이내믹 태그 관리에 의해 호스팅되며 다음을 수행할 수 있습니다. </p> 
...
수정 사항 및 개선 사항이 다음 제품 및 서비스에 적용되었습니다.
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Developer Connection 콘텐츠 업데이트</b> (2016년 7월 25일 업데이트) </p> <p><a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external"> Classifications.CreateExport </a> 업데이트: </p> 
    ...
    </ul> <p> <b>사용 중지 알림</b> </p> <p> 웹 서비스 API의 버전 1.2는 공식적으로 2014년 2월 20일에 사용 중지되었습니다. 이 버전은 2016년 9월 15일에 사용이 종료됩니다. 이때 Adobe은 버전 1.2 API 요청에 응답하는 API 서버의 기능을 제거합니다. <span class="filepath">https://api.omniture.com/admin/1.2</span> 종단점에 대한 모든 API 요청은 404를 반환합니다. 
     </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">관리자:Adobe ID을 사용하여 Marketing Cloud을 통해 로그인하는 사용자에 대해 활동 추적이 되지 않던 문제를 수정했습니다. 이 수정 사항은 기존의 회사 이름, 사용자 이름 및 암호를 통해 로그인한 사용자를 위해 활동 추적을 복제합니다. (AN-124792) </li> 
      <li id="li_0BDA039583054473BC3190E0AF57D03D">공유 계산된 지표가 관리자가 아닌 사용자에게 적용되지 않는 문제를 해결했습니다. (AN-125412) </li> 
      <li id="li_A5B1C8700C56426AACECBFF448DB06B3">보고서가 배포되도록 예약되지 않았더라도 보고서를 보내는 드문 문제를 수정했습니다. (AN-126552) </li> 
      <li id="li_D1237FEB03554D7793CCF09148F32530">기본 제품 로그인이 SearchCenter인 사용자에 대해 발생하는 로그인 문제를 해결했습니다(AN-126281). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      ...
      <li id="li_413B05B2DE7B4910B80A334A4AD8D26A"> 크롬 브라우저에서 PDF 프로젝트를 미리 볼 때 PDF 프로젝트를 다운로드할 때 발생하는 오류가 수정되었습니다. (AN-123674) </li> 
      <li id="li_4584537608434E7CBCBCC18EA8F01B59">구성 요소를 배치하고 크기를 조정할 수 없는 문제를 해결했습니다(드문 경우). (AN-126175) </li> 
      <li id="li_976D720D2919457A91C2F4CC5DCBB54F">브라우저 세그먼트를 추가한 다음 테이블에서 브라우저 유형을 변경할 때 발생하는 세그먼트 정의 문제를 해결했습니다. (AN-126086) </li> 
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">주간 프로젝트 예약에서 요일이 인터페이스에 제대로 표시되지 않는 문제를 해결했습니다. (AN-125760) </li> 
      ...
      <li id="li_D8E69F309E144BCB999B19B59AE502A4">로그인 후 프로젝트 대시보드가 표시되지 않던 문제를 수정했습니다. (AN-124635) </li> 
      <li id="li_7B10BCEA62D1427BB5A7574A88B756FD">여러 지표 및 세그먼트를 사용하는 프로젝트에 대한 표의 정렬 문제를 수정했습니다. (AN-126162) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">지원되지 않는 오버레이 지표(새 방문자 및 새 고객)가 Activity Map에서 제거되었습니다. (AN-124056) </li> 
      <li id="li_44571DB551274B25A37C13F0D0A8505A"> 이제 Activity Map 라이브 모드는 웹 페이지에 있는 모든 링크에 대해 보고합니다. (AN-116094) </li> 
      <li id="li_7044F2E995024A48873E6209146C1678">페이지를 다시 로드한 후 계산된 지표가 표시되지 않는 문제를 해결했습니다. (AN-125900) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Report Builder </td> 
   <td colname="col2"> <p> Office 365를 통해 Excel 웹 인터페이스에서 처음 연 통합 문서를 예약하는 기능이 개선되었습니다. (AN-118240 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse </td> 
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      <li id="li_77E57F08C316489D959009967CB160C9"> Data Warehouse의 페이지 보기에 대한 세그먼트 지원을 추가합니다(AN-125067). </li> 
      <li id="li_59787469534B455686696BA9E095D388"> 분류 조회 테이블에 "0" 해시 값이 있는 규칙의 세그먼트 논리 문제를 수정했습니다(AN-125340). </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">"데이터 없음"으로 응답하지 않고 빈 보고서를 전송하는 기능을 추가했습니다. (AN-126210) </li> 
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">인터페이스의 가상 보고서 세트 변경 후에 만들어진 새 이메일 배포 목록이 이제 Data Warehouse에서 작동합니다. (AN-123842) </li> 
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">이제 분류는 생성되는 이메일에 적절한 MIME 형식을 제공합니다(AN-124243). </li> 
      <li id="li_93364B7D632E49C5AE6C222BCBE5EC1F">기여도 지표 이름이 표시되지 않던 문제를 수정했습니다. (AN-117260) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b><span class="keyword"></span>  JavaScript용 AppMeasurement</b> </p> <p> <b>2016년 8월 4일:</b> 버전 <b>1.6.3</b></p> <p> AppMeasurement가 요청 연결을 너무 일찍 종료하던 문제를 수정했습니다. (AN-126448) </p> <p> <p class="important">중요: <span class="keyword">Marketing Cloud</span> ID 서비스의 버전 1.6.0을 사용하려면 AppMeasurement for JavaScript 버전 1.6.3 이상이 <i>필요합니다</i>. Marketing Cloud ID 서비스 버전 1.6.0으로 업그레이드하려면 AppMeasurement 코드 버전 1.6.3 이상을 사용하는지 확인하십시오. </p> </p> <p> <b><span class="keyword"></span>  JavaScript용 AppMeasurement</b> </p> <p>버전 <b>1.6.2</b></p> <p> 
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_C64B1DCB5679439A8FD77CF03A4D5F3B">AppMeasurement가 방문자 API에서 잘못된 난독화된 메서드를 호출하게 하는 문제를 수정했습니다. (AN-126006) </li> 
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">JavaScript 오류가 발생하는 문제를 수정했습니다."속성은 v:image에만 유효합니다." (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="wintitle">샘플 오류 보고서</span>는 인바운드 데이터 소스 파일의 레코드 처리에 대한 성공 및 실패율을 확인합니다. 오류 보고는 대화형 막대 차트에 데이터를 표시하고 요약 지표를 테이블 형식으로 제공합니다. 또한 고정 시간 간격에 대해 파일을 샘플링하고 각 오류 유형에 대해 가장 일반적인 오류를 표시하는 옵션이 포함되어 있습니다. </p> <p>7월 말에 이 기능이 릴리스되면 설명서를 사용할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
* v201601에서 Google 입찰 관리자를 v201603으로 업그레이드했습니다. (AAM-24618)
* 프로필 병합 규칙 보고에서 0이 표시되던 버그를 수정했습니다. (AAM-24685)
* 감사 테이블에서 고유한 키 오류로 인해 고객이 사용자 그룹을 편집하거나 삭제할 수 없는 버그를 수정했습니다. (AAM-24864)
* S2S 및 벌크 S2S 대상에 제한이 적용되지 않는 버그를 수정했습니다. (AAM-24905)
* 기존 로그인과 Marketing Cloud을 구분하는 선의 스타일을 변경했습니다. (AAM-24378)
* 사용자, 그룹 또는 데이터 소스를 삭제한 후 잘못된 오류 메시지가 표시되는 버그를 수정했습니다. (AAM-24638)
...
* [일괄 관리 시작하기](https://marketing.adobe.com/resources/help/en_US/aam/c_bulk_start.html) 새로운 일괄 관리 스프레드시트가 포함됩니다.
...
* 트윗에 답글을 달면 트윗이 140자를 초과했다는 오류가 발생하는 문제를 수정했습니다.
* 특정 링크 단축기를 활성화하는 전환 단추가 작동하지 않는 문제를 해결했습니다.
* 중재자 답글이 중재에 표시되지 않던 문제를 수정했습니다.
...
최신 Primetime 도움말에 대해서는 [Primetime 도움말 홈](https://help.adobe.com/ko_KR/primetime/)을 참조하십시오.
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM의 Gems는 Adobe 전문가가 전달하는 일련의 기술 심층 정보입니다. 이 시리즈는 제품 설명서 및 기술 채널을 보완합니다. 또한 개발자는 특정 주제에 대해 자세히 알고 탐색할 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>새로운 기능은 다음과 같습니다. 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      <li id="li_128ED169444F4F11B221CBB19AD0B918"><p>필터 및 캐시 규칙에 대한 정규 표현식(regex)을 지원합니다. </p></li> 
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">모든 플랫폼에서 HTTP 영구 연결(HTTP 유지 가능)을 지원합니다. </li> 
...
다음 표에는 제안되는 주제에 대한 링크 선택 옵션이 포함되어 있습니다. 이러한 항목은 AEM 구현 및 사용을 최대한 활용하는 데 도움이 될 수 있습니다.
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM에는 클래식 및 터치에 적합한 UI가 포함되어 있습니다. 이와 같이 "고객을 위한 사용자 인터페이스 Recommendations" 주제에서는 어떤 UI를 가장 효과적으로 사용할 수 있는지 결정하는 데 도움이 될 수 있습니다. 이 정보는 프로젝트를 구현하는 동안 또는 이전 릴리스에서 업데이트할 때 유용합니다. </p> </td> 
  </tr> 
  <tr> 
...
Advertising Cloud 도움말은 **[!UICONTROL 의 제품에서 사용할 수 있습니까?  > 도움말 목차]**&#x200B;에서 확인할 수 있습니다. 
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 <thead> 
  <tr> 
   ...
   <th colname="col2" class="entry"> 설명 </th> 
   <th colname="col3" class="entry"> 게시 날짜 </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 2016년 가을에 있을 허가 변경에 관한 중요 공지. </p> </td> 
   <td colname="col3"> <p>2016년 7월 21일 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/docs/en/aem/6-2.html" format="https" scope="external"> Adobe Experience Manager 6.2 </a> </td> 
   <td colname="col2"> <p>Adobe Experience Manager 6.2는 Adobe Experience Manager 6.1의 코드 베이스에 대한 업그레이드 릴리스입니다. 이 버전은 새롭고 향상된 기능, 주요 고객 수정 사항, 높은 우선 순위의 고객 개선 사항 및 제품 안정화를 위한 일반적인 버그 수정을 제공합니다. 또한 Adobe Experience Manager 6.1 기능 팩, 핫픽스 및 서비스 팩 릴리스도 포함되어 있습니다. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Analytics용 Marketing Cloud 대상을 적절히 통합하면 인구 통계적 정보(예: 성별 또는 수입 수준), 심리통계적 정보(예: 관심사 및 취미), CRM 데이터 및 광고 노출 데이터 등의 Marketing Cloud 대상 데이터를 Analytics 워크플로우에 통합할 수 있습니다. </p> </td> 
   <td colname="col3"> <p>2016년 4월 14일 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>기능 설명, 프로젝트 만들기 작업, 비디오 및 사용 사례와 함께 Analysis Workspace 제품 설명서를 업데이트했습니다. </p> </td> 
   <td colname="col3"> <p>2015년 9월 17일 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>타임스탬프 옵션에 대한 제품 설명서 및 우수 사례를 추가했습니다. 이 기능을 사용하면 보고서 세트에서 타임스탬프가 지정된 데이터와 지정되지 않은 데이터를 모두 통합할 수 있습니다. 모든 새 보고서 세트는 기본적으로 타임스탬프 선택 사항이 됩니다. </p> </td> 
   <td colname="col3"> <p>2015년 9월 17일 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>새로운 연결 표 및 코드표, 시각화, 사용자 인터페이스, 알고리즘 및 내보내기 기능에 대한 업데이트 등 새로운 기능과 버그 수정 사항 목록과 업그레이드 지침이 필요하면 Data Workbench 6.5 릴리스 노트를 참조하십시오. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>규칙 세트를 만든 후 기존 규칙 세트를 편집할 때 보고서 세트와 변수를 규칙 세트에 추가할 수 있도록 분류 규칙 빌더를 업데이트했습니다. 이전에는 규칙 세트를 만들 때 변수 및 보고서 세트를 지정했습니다. 이 변경 사항은 분류 변수와 관련하여 보고된 문제가 발생하지 않도록 합니다. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>프로필 링크는 인증된 사이트 방문자에 대한 트레이트를 식별 및 수집하기 위해 장치 간 데이터 소스와 작동합니다. 여기에는 여러 장치에서 사용자를 세그먼트화하고 정확하게 타깃팅할 수 있는 프로필 병합 규칙 기능이 포함되어 있습니다. </p> </td> 
   <td colname="col3"> <p>2015년 8월 20일 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>이제 계산된 지표를 사용하여 세그먼트화된 지표, 더 진보된 수학 및 지표를 구성 및 공유할 수 있습니다. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-first-party.html" format="https" scope="external">Adobe 관리 인증서 프로그램</a>을 개조된 <span class="term"> 퍼스트 파티 쿠키 </span> 제품 설명서에 추가했습니다. </p> <p>관리 인증서 프로그램을 사용하면 추가 비용 없이 자사 쿠키에 대한 새로운 퍼스트 파티 SSL 인증서를 구현할 수 있습니다. </p> </td> 
