...
` disableThirdPartyCalls`가 ` Visitor.getInstance` 함수에서 설정할 수 있는 선택적 부울 플래그로 추가되었습니다. ` disableThirdPartyCalls= true`이면 ID 서비스는 다른 도메인을 호출하지 않습니다. 기본적으로 ` disableThirdPartyCalls= false`입니다. [disableThirdPartyCalls](https://marketing.adobe.com/resources/help/ko_KR/mcvid/?f=mcvid-disablethirdpartycalls.html)를 참조하십시오. (MCID-51)
...
* [!DNL  Adobe Social] 내에서 리트윗된 게시물이 이제 Twitter에서 기본적으로 리트윗될 때와 동일하게 표시됩니다. 자세한 내용은 [개별 트윗 조정](https://marketing.adobe.com/resources/help/ko_KR/social/t_mod_individual_tweet.html) 및 [인용된 트윗 게시](https://marketing.adobe.com/resources/help/ko_KR/social/t_post-quoted-retweet.html)를 참조하십시오.
* 소셜 태그는 10월 1일 이후 Adobe Analytics에서 사용할 수 있습니다(정확한 날짜 TBD).
   * 10월 1일 이후 [!DNL  Adobe Social]사용자는 [소셜 태그](https://marketing.adobe.com/resources/help/ko_KR/social/c_settings_tag_manr.html)를 사용하여 아웃바운드 콘텐츠를 분류하고 [!DNL  Adobe Analytics] 내에서 이 콘텐츠에 대해 보고할 수 있습니다. 이러한 새 기능에 액세스하기 위해 이 목록을 보려면 [!DNL  Adobe Social] 계정 관리자 또는 Social 지원 팀에 문의하십시오. 액세스 권한 및 지원 받기에 대한 다음 단계에서 업데이트를 받습니다.
