...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe는 <a href="https://marketing.adobe.com/resources/help/en_US/implementation/?f=accelerated-mobile-pages" format="https" scope="external">AMP(가속 모바일 페이지)</a> 프로젝트에 참여하고 있습니다. AMP는 빠르게 렌더링되는 정적 컨텐츠의 웹 페이지를 작성할 수 있는 개방형 소스 프로젝트입니다. 이 기능은 모바일에 최적화된 컨텐츠를 한 번 만든 후 모든 위치에서 즉시 로드하려는 게시자에게 이상적입니다. </p> <p>참고: 이 프로젝트는 보고 결과에 영향을 주지 않습니다. </p> </td> 
  </tr> 
  <tr> 
...
* [!DNL  Social] 중재 규칙이 Facebook 페이지에서 [!UICONTROL  비속어] 목록의 단어가 포함된 게시물을 제거하지 못하는 문제를 해결했습니다. (AS-35461)
