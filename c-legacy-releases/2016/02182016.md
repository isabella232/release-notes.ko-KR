...
Marketing Cloud:새로운 기능에는 Marketing Cloud 에셋 기능이 향상되었으며, 솔루션 계정을 Adobe ID에 연결하는 워크플로우가 향상되었습니다. Adobe 모바일:Apteligent 및 appFigures 통합 업데이트. 분석:관리 도구의 새 실시간 보고서 권한 구성. Audience Manager:Audience Marketplace에서 데이터 피드 비활성화를 참조하십시오. Experience Manager:서비스 팩 및 핫픽스. 일반 수정 사항 및 개선 사항에 대한 2월 유지 관리 릴리스.
...
<table id="table_C9B288CF42034F329C3C72D95D22E515"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>향상된 Marketing Cloud 에셋 </p> </td> 
   <td colname="col2"> <p>Marketing Cloud Assets에서는 중앙의 한 위치에서 디지털 자산을 저장, 공유 및 동기화할 수 있습니다. Marketing Cloud Assets는 AEM(<span class="keyword">Adobe Experience Manager</span>)에서 사용할 수 있는 기능 중 일부를 활용합니다. </p> <p><a href="https://marketing.adobe.com/resources/help/en_US/mcloud/marketing-cloud-assets.html" format="https" scope="external">Marketing Cloud Assets</a>를 참조하십시오 . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>계정 연결 개선 사항 </p> </td> 
   <td colname="col2"> <p>솔루션 계정을 Marketing Cloud(Adobe ID)과 연결하는 인터페이스 워크플로를 개선했습니다. 이 새 워크플로우는 조직과 연관된 사용자 계정을 모두 찾아서 연결할 계정을 선택할 수 있도록 해줍니다. 계정 연결 환경을 간소화했으므로 계정을 수동으로 연결하기 위해 조직 관리 페이지에 더 이상 액세스하지 않아도 됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 2016년 2월 초, Adobe Analytics은 더 이상 SSLv3을 지원하지 않습니다. 이 변경 사항은 Report Builder, 데이터 수집 요청 및 Analytics 웹 서비스 API에 대한 요청에 영향을 줍니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe는 <a href="https://marketing.adobe.com/resources/help/en_US/implementation/accelerated-mobile-pages.html" format="https" scope="external">AMP(가속 모바일 페이지)</a> 프로젝트에 참여하고 있습니다. AMP는 빠르게 렌더링되는 정적 콘텐츠의 웹 페이지를 작성할 수 있는 개방형 소스 프로젝트입니다. 이 기능은 모바일에 최적화된 콘텐츠를 한 번 만든 후 모든 위치에서 즉시 로드하려는 게시자에게 이상적입니다. </p> <p>참고: 이 프로젝트는 보고 결과에 영향을 주지 않습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 실시간 보고서 구성 권한 </td> 
   <td colname="col2"> <p>새 Admin Console 권한이 추가되었습니다.실시간 보고서 구성을 참조하십시오. </p> <p>실시간 보고서를 구성하려면 a) 관리자이거나, b) 관리 도구에 대한 모든 액세스 권한이 있는 그룹에 속해 있거나, c) 새로운 실시간 보고서 구성 권한이 있어야 합니다. </p> <p>모든 보고서 액세스 권한이 있는 사용자를 포함한 다른 사용자는 실시간 보고서를 구성할 수 없습니다. 이러한 사용자의 경우 실시간 보고 인터페이스에서 구성 단추를 사용할 수 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 경고:2월과 3월 MR 간의 데이터 처리 변경 </td> 
   <td colname="col2"> <p>2월과 3월 유지 관리 릴리스 사이에 다음 Analytics 데이터 처리 변경 사항이 구현됩니다. </p> <p>이전에는 이벤트 세트를 사용하지 않고 제품 변수를 사용하는 경우 이벤트는 기본적으로 처리 초반에(처리 규칙 적용 전) 설정된 "ProdView"로 설정됩니다. 이제 이 이벤트는 처리 규칙 후에 설정되므로 모바일 데이터 처리 작동 방식과 상충되지 않습니다. 이 변경 내용에는 다음과 같은 다운스트림 효과가 있습니다. </p> 
    <ul id="ul_F9DA8F25F016488B9E9F97FC7DF67D6F"> 
     <li id="li_214969F8FBEF4202B759FDBCB64B6751"> 컨텍스트 데이터가 이벤트를 생성하는 히트(특히 모바일에서)로 인해 ProdViews가 더 이상 부풀려지지 않습니다. 앞으로 이벤트는 ProdView가 설정된 데이터 처리 시(설정된 이벤트 없이) 설정됩니다. </li> 
     <li id="li_D0A2C9FC425E4EFE914B028D9D3A06F6"> 히트에 설정된 ProdView 이벤트에 따라 논리를 갖는 모든 VISTA 규칙을 검토하여 VISTA 규칙의 변경 사항이 필요한지 확인해야 할 수 있습니다. 이는 ProdView가 처리 파이프라인 초반에 설정되기 때문에 ProdView 이벤트가 이전에 비해 적은 히트에 대해 설정될 수 있기 때문입니다. 이 변경 사항은 VISTA 규칙에서 원하는 것에 영향을 미치거나 주지 않을 수 있습니다. </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> 보고서 및 분석 수정 사항 </td> 
   <td colname="col2"> 
    <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
     <li id="li_294227DF6E1346F18F5FA38805A5C2C3"> 실시간 보고서의 문제를 수정했습니다.시간대 문제로 인해, 오늘 그래프는 인스턴스 수가 많음에도 불구하고 0을 표시했습니다. (AN-114982) </li> 
     <li id="li_741A006D5EEE4612AD7BF748BB6742A4">관리자가 Marketing Cloud 자격 증명으로 로그인하면 오류가 발생하는 사용자 관리/암호 재설정 문제를 수정했습니다. (AN-108518) </li> 
     ...
     <li id="li_E319AB4C89C5432592B12CAF81CB35AF">예약된 대시보드가 정크 메일 폴더로 배달되는 문제를 해결했습니다. (AN-117157) </li> 
     <li id="li_437D157D6BDB4444B9D59B909168DAF9">처리 규칙이 저장되지 않는 문제를 해결했습니다. (AN-115916) </li> 
     <li id="li_E71AE65E326A442D99B0CA3C24B37220">고객에게 책갈피 업그레이드를 요청하는 오류 메시지를 표시하는 사용자 지정 트래픽(prop) 보고서 문제를 해결했습니다. (AN-104560) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_99A0056C827D4F5FA35FE87B3DB5A75C"> 
      <li id="li_7F75C3AA17AA4F719E3641D5A418AD2F">실행 취소 기능을 셀 선택에 사용할 수 있도록 개선했습니다.</li> 
      <li id="li_AF1C69FFD6354ACC9DEB1382DBFD2597">프로젝트를 열 수 없는 문제를 수정했습니다. 이 문제는 데이터 테이블에 열이 10개가 넘는 프로젝트에서 발생했을 수 있습니다. (AN-118259) </li> 
      <li id="li_6A400CA46F954F4ABB5E92FFECCECB2C">세그먼트 만들기 권한이 없는 사용자가 복사를 사용하여 만든 세그먼트를 편집할 수 있도록 허용하는 문제를 <span class="term"> 수정했습니다 </span>. (AN-117762) </li> 
      <li id="li_3CFE801DC1E545CF97B0894D6A7236C6">실행 취소를 사용하여 삭제된 패널을 복원할 때 발생하는 패널 크기 문제를 <span class="term"> 수정했습니다 </span>. (AN-117743) </li> 
      <li id="li_8B9D2FC9FC5A4BA6800CD6CF00936FFF">공유 날짜 범위를 다른 사용자가 사용할 수 없는 문제를 해결했습니다. (AN-117637) </li> 
      <li id="li_60637BC4F07043E99577C801119EBF43">보고서 날짜를 수동으로 입력할 수 없는 Firefox에서 발생하는 문제를 수정했습니다. (AN-117595) </li> 
      <li id="li_B1DC872D986347BAADA4F59ACFC6114A">세그먼트에서 분류를 삭제하면 세그먼트가 삭제되던 문제를 수정했습니다. (AN-115941) </li> 
      <li id="li_3207A74F73704AEC98B07B1F6B1DA85A">구성 요소를 사용할 수 없거나 수정할 수 없는 문제를 수정했습니다. 이 문제는 구성 요소를 조정한 후 다시 인증한 후에만 발생했습니다. (AN-118499) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
     <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">로케일이 영어(국제)로 설정된 경우 지표, 차원 및 세그먼트가 로드되지 않는 문제를 해결했습니다. ( AN-118055) </li> 
     <li id="li_4748F7C2ECCC44F5885B4FAC2FFB1C60">보고서를 예약할 수 없는 문제가 해결되었습니다. (AN-116527) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Data Warehouse 예약된 보고서가 배달되지 않는 문제가 해결되었습니다. (AN-118182) </li> 
      <li id="li_142ACEB3BA1D40F4A6DACBD970860278">Data Warehouse 보고가 eVar 76+를 올바로 분류하지 않았던 문제를 수정했습니다. (AN-118867) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p class="important">참고: 웹 서비스 API의 버전 1.2는 공식적으로 2014년 2월 20일에 사용 중지되었습니다. 2016년 9월 15일에 수명이 종료됩니다. 이때 Adobe은 버전 1.2 API 요청에 응답하는 API 서버의 기능을 제거합니다. <span class="filepath">https://api.omniture.com/admin/1.2</span> 종단점에 대한 모든 API 요청은 404를 반환합니다. 고객은 API 애플리케이션에서 중단이 발생하지 않도록 하려면 사용 종료 날짜까지 버전 1.2 API에서 버전 1.4 API로 업그레이드해야 합니다. 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Audience Marketplace에서 데이터 피드 비활성화 </p> </td> 
   <td colname="col2"> <p>Audience Marketplace 데이터 제공업체는 가입된 피드에 대한 구매자 액세스를 취소할 수 있습니다. 판매자가 피드를 취소하는 방법 및 구매자에게 발생하는 사항에 대한 자세한 내용은 다음을 참조하십시오. </p> 
    <ul id="ul_28EE8AE9CAB1456185D19C2FC83B26FD"> 
     <li id="li_B5F2A49D9C55434FB55E78ED00C096DA"> <a href="https://marketing.adobe.com/resources/help/en_US/aam/marketplace-deactivate-subscribers.html" format="https" scope="external"> 가입자의 데이터 피드 비활성화 </a> </li> 
     <li id="li_D1295E39404649F6ACA797ACF1F69941"> <a href="https://marketing.adobe.com/resources/help/en_US/aam/marketplace-subscriber-deactivated.html" format="https" scope="external">공급자가 내 데이터 피드를 비활성화하면 어떻게 됩니까?</a> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
* 브랜드 없는 데이터 피드에 공급자 ID가 노출되는 API를 수정했습니다. 소스 및 특성 API가 영향을 받았습니다. (AAM-22430)
* 사용자 계정을 제거할 때 타블로 보고서 계정이 삭제되지 않는 버그가 수정되었습니다. (AAM-16048)
* [!UICONTROL 대상]([!UICONTROL 세그먼트 매핑] 섹션)에서 세그먼트 우선순위를 변경하지 못했던 버그를 수정했습니다. (AAM-22942)
* 관리자 권한이 없는 사용자가 프로필 병합 규칙을 만들 수 있었던 버그를 수정했습니다. (AAM-22433)개선 사항:
...
* [DCS 오류 코드, 메시지 및 예제](https://marketing.adobe.com/resources/help/en_US/aam/dcs_error_codes.html)
* [ID 동기화 파일 이름 및 컨텐츠 요구 사항](https://marketing.adobe.com/resources/help/en_US/aam/c_file_based_id_sync.html)
* [인바운드 데이터 파일에 대한 Amazon S3 이름 요구 사항](https://marketing.adobe.com/resources/help/en_US/aam/inbound-s3-filenames.html)
* [인바운드 데이터 파일에 대한 FTP 이름 요구 사항](https://marketing.adobe.com/resources/help/en_US/aam/inbound-ftp-filenames.html)
...
* 오류 메시지가 실패한 게시물의 이유를 제대로 설명하지 못하는 문제를 해결했습니다. 경우에 따라 &quot;#&quot;이(가) 오류 메시지의 유일한 텍스트였습니다. (AS-35576)
...
* 피드 규칙에 정의된 대로 중재 피드가 모든 관련 게시물을 지연하거나 가져오지 않는 문제를 해결했습니다. (AS-35451)
* 잘못된 센티멘트 점수가 중재 피드에 표시되는 문제를 해결했습니다. (AS-35149)
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> 자가 도움말 업데이트 </th> 
   <th colname="col2" class="entry"> 설명 </th> 
  </tr> 
 </thead>
 <tbody> 
...
지난 릴리스에서 주목할 만한 설명서 추가 사항 및 업데이트.
