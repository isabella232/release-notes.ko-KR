...
Marketing Cloud: 새로운 기능에는 Marketing Cloud Assets에 대한 개선 사항 및 솔루션 계정을 Adobe ID에 연결하는 향상된 워크플로우가 포함됩니다. Adobe Mobile: Apteligent 및 appFigures 통합 업데이트. Analytics: 관리 도구의 새 실시간 보고서 권한 구성. Audience Manager: Audience Marketplace에서 데이터 피드 비활성화를 참조하십시오. Experience Manager: 서비스 팩 및 핫픽스. 일반 수정 사항 및 개선 사항에 대한 2월 유지 관리 릴리스.
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>웹 서비스 API의 버전 1.2는 2014년 2월 20일에 공식적으로 사용 중지되었습니다. 2016년 9월 15일에 수명이 종료됩니다. 이때 Adobe는 버전 1.2 API 요청에 응답하는 API 서버의 기능을 제거할 것입니다. <span class="filepath">https://api.omniture.com/admin/1.2</span> 종단점에 대한 모든 API 요청은 404 오류를 반환합니다. 고객은 API 애플리케이션에서 중단이 발생하지 않도록 하려면 사용 종료 날짜까지 버전 1.2 API에서 버전 1.4 API로 업그레이드해야 합니다. 
     <!--https://jira.corp.adobe.com/browse/AN-118670--></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>SSL v3 </p> </td> 
   <td colname="col2"> <p> 2016년 2월 초부터 Adobe Analytics은 더 이상 SSLv3을 지원하지 않습니다. 이 변경 사항은 리포트 빌더, 데이터 수집 요청 및 Analytics 웹 서비스 API에 대한 요청에 영향을 줍니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>영국 우편 번호 </p> </td> 
   <td colname="col2"> <p>Adobe의 지역 서비스 제공업체는 영국 우편 번호를 수신하는 방식을 변경하고 있습니다. 3월 18일경 잘린 영국 우편 번호를 제공하던 방식에서 전체 우편 번호로 전환할 예정입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
     ...
     <li id="li_E71AE65E326A442D99B0CA3C24B37220">고객에게 책갈피 업그레이드를 요청하는 오류 메시지가 표시되는 사용자 지정 트래픽(prop) 보고서 문제를 해결했습니다. (AN-104560) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p class="important">참고: 웹 서비스 API의 버전 1.2는 공식적으로 2014년 2월 20일에 사용 중지되었습니다. 2016년 9월 15일에 수명이 종료됩니다. 이때 Adobe는 버전 1.2 API 요청에 응답하는 API 서버의 기능을 제거할 것입니다. <span class="filepath">https://api.omniture.com/admin/1.2</span> 종단점에 대한 모든 API 요청은 404를 반환합니다. 고객은 API 애플리케이션에서 중단이 발생하지 않도록 하려면 사용 종료 날짜까지 버전 1.2 API에서 버전 1.4 API로 업그레이드해야 합니다. 
...
<table id="table_45E49397B42D4B7198FC947C6C79483D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> AEM 6.1 서비스 팩 1은 2015년 5월 AEM 6.1의 공식 출시 이후 릴리스된 성능, 안정성, 보안 및 주요 고객 수정 사항과 개선 사항을 포함하는 중요한 업데이트입니다. SP1은 AEM 6.1 GA에 설치할 수 있습니다. </p> <p> 이 페이지의 개요에는 SP1에 추가된 변경 사항이 나와 있습니다. 서비스 팩의 주요 특징 중 몇 가지는 다음과 같습니다. </p> 
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>기능 설명, 프로젝트 제작 작업, 비디오 및 사용 사례와 함께 업데이트된 Analysis Workspace 제품 설명서입니다. </p> </td> 
   <td colname="col3"> <p>2015년 9월 17일 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Mobile 제품 설명서를 개조했습니다. </p> </td> 
   <td colname="col3"> <p>2015년 5월 22일 </p> </td> 
  </tr> 
  <tr> 
