...
>[!IMPORTANT]
>
>이제 내에서 [!DNL  Target][!DNL  Mobile Services] 기능에 액세스하려면 사용자가 [!DNL  Target] 회사에 제공된 Adobe ID로 로그인해야 합니다. [!DNL  Target] 사용자 이름 및 암호로 로그인하는 작업이 제거되었습니다.
...
<table id="table_D919A080718349AA83775BEB256B7C4A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID 서비스는 서버에서 반환된 MID 값 또는 <span class="codeph">visitor.setMarketingCloudVisitorID()</span> 함수에 설정된 경우 MID 값을 인코딩합니다. MID에 대한 자세한 내용은 <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid_cookies.html" format="https" scope="external">쿠키 및 Marketing Cloud ID</a>를 참조하십시오 . (AAM-23336) </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12"><span class="wintitle">이동통신사</span> 보고서에서 "없음"에 대한 정의를 변경했습니다. 이제 “없음”에 모바일 장치 외에도 비모바일 장치가 포함됩니다. 이 경우 Reports &amp; Analytics와 비슷하게 보고서를 가져옵니다. (AN-122678) </li> 
...
* [픽셀 호출을 통해 캠페인 노출 횟수 데이터 캡처](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_doc_updates.html)
* [베타 환경](https://marketing.adobe.com/resources/help/en_US/aam/?f=beta_environment.html)
