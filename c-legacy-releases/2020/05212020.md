...
>[!NOTE]
>
>[[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html)에 가입하여 예정된 릴리스에 대한 이메일을 통해 알림을 수신합니다.
...
도움이 필요하십니까? Adobe에서 선별된 교육 과정, 기술 문서, 빠른 답변, 커뮤니티 통찰력 및 강사 중심의 트레이닝을 찾으려면 [[!DNL Adobe Experience League]](https://experienceleague.adobe.com/#home)을 방문하십시오.
...
| -----------| --------- | ---------- |
| [!UICONTROL 작업 공간]의 [!UICONTROL Quick Insights] 패널 | 2020년 6월 25일 | [!UICONTROL Quick Insights]는 [!UICONTROL Analysis Workspace]의 비분석가 및 새 사용자에게 비즈니스 관련 질문에 빠르고 쉽게 답변할 수 있는 방법을 배울 수 있도록 지침을 제공합니다. [추가 정보](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/panels/quickinsight.html) |
...
| 공지 | 추가 또는 업데이트 날짜 | 설명 |
| -----------| ---------- | ---------- |
| 통합 제품 도메인으로 마이그레이션 | 시행일: 2020년 5월 28일 | 2020년 1월에 시작된 Adobe Analytics용 통합 제품 도메인으로의 마이그레이션은 2020년 5월 28일에 완료되었습니다. Adobe Analytics은 아키텍처에서 모든 `omniture.com` 도메인 참조를 제거하려고 하지만 `omniture.com`을(를) 타사 쿠키로 허용하는 것이 중요합니다. 전체 아키텍처 마이그레이션이 (곧) 완료되면 릴리스 정보를 통해 알려 드릴 예정이며 이 허용리스트 단계는 더 이상 필요하지 않습니다. [권장 IP 주소 및 도메인](https://helpx.adobe.com/kr/analytics/kb/adobe-ip-addresses.html) 의 전체 목록은 여기에 있습니다.<br>조직에서 타사 쿠키를 차단하는 경우 고객 지원 센터에 문의하여 Adobe Analytics에 다시 액세스하십시오. |
...
| 제3자 기술 허용 목록에 추가 | (시행일: 2020년 3월 12일 | Adobe Analytics는 기능 롤아웃 관리 및 제품 내 지원을 위한 타사 기술을 활용하기 시작했습니다. 전체 기능 액세스를 보장하려면 필요한 네트워크 방화벽에 다음 URL을 허용 목록에 추가하다 추가해야 합니다.<ul><li>Gainsight: https://esp.aptrinsic.com</li><li>LaunchDarkly: https://app.launchdarkly.com</li></ul> |
...
* [AEM as a Cloud Service 릴리스 노트](https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
* [AEM as a Cloud Service 설명서](https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/landing/home.html)
...
* [Adobe Campaign Standard 20.3 릴리스](https://docs.adobe.com/content/help/en/campaign-standard/using/release-notes/release-notes.html)
