...
* [[!DNL Analytics]](#analytics) (**2020년 6월 4일 업데이트**)
* [Audience Manager](#aam)
* [Experience Manager](#aem)
* [[!DNL Campaign]](#ac)
* [Advertising Cloud](#adcloud)
* [[!DNL Target]](https://docs.adobe.com/content/help/ko-KR/target/using/release-notes/target-release-notes.html) (Target 도움말 페이지로 링크)
* [[!DNL Magento]](#magento)
...
| 타사 기술 허용 목록에 추가 | (시행일: 2020년 3월 12일 | Adobe Analytics는 기능 롤아웃 관리 및 제품 내 지원을 위한 타사 기술을 활용하기 시작했습니다. 다음 URL을 필요한 네트워크 방화벽허용 목록에 추가하다에 추가하여 모든 기능을 이용할 수 있습니다.<ul><li>Gainsight: https://esp.aptrinsic.com</li><li>LaunchDarkly: https://app.launchdarkly.com</li></ul> |
