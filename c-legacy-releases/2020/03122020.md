...
1분기 릴리스가 게시되었습니다. [자세히 보기](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en)
...
| **[!UICONTROL 대시보드 아카이브]**&#x200B;의 EOL | 2020년 3월 27일 | 다음 **[!UICONTROL 아카이브 보기]** 설정 **[!UICONTROL 대시보드 관리]** in [!UICONTROL Reports &amp; Analytics] 2020년 10월부터 더 이상 제공되지 않습니다. |
...
자세한 내용은 [JavaScript 릴리스 노트의 AppMeasurement](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ko-KR). 버전 2.20.0은 2020년 2월 5일에 릴리스되었습니다.
