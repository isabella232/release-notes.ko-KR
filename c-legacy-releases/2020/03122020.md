...
| [!DNL Adobe Campaign] | 자습서 - [Android에서 푸시 알림™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=ko) | iOS 및 Android™ 모바일 장치로 맞춤형 및 세그먼트화된 푸시 알림을 보냅니다. 이 튜토리얼에서는 Adobe Campaign에서 푸시 알림을 보내어 Android™ 앱에서 해당 알림을 받는 단계를 안내합니다. |
