...
[AppMeasurement for JavaScript 릴리스 노트](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ko-KR)를 참조하십시오. 버전 2.20.0은 2020년 2월 5일에 릴리스되었습니다.
...
* Adobe Campaign Classic:[Documentation](https://experienceleague.adobe.com/docs/campaign-classic.html) - [방법 비디오](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=ko-KR)
...
| [!DNL Adobe Campaign] | 자습서 - [Android에서 푸시 알림™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=en) | iOS 및 Android™ 모바일 장치로 맞춤형 및 세그먼트화된 푸시 알림을 보냅니다. 이 튜토리얼에서는 Adobe Campaign에서 푸시 알림을 전송하고 Android™ 앱에서 해당 알림을 받는 것과 관련된 단계를 안내합니다. |
