...
| 기능 | 설명 |
| -----------| ---------- |
| GDPR 투명성 및 동의 프레임워크 | Advertising Cloud은 IAB의 투명도 및 동의 프레임워크에 대한 지원을 2020년 8월 15일까지 버전 2.0으로 업그레이드하고 있습니다. 이때, 고객측에서 변경할 필요가 없습니다.  Adobe의 각 고객을 위한 데이터 프로세서로서 Adobe 제품 및 서비스 사용에 적용되는 GDPR에 따른 고객의 의무를 이행할 수 있는 기능을 제공합니다. |
| Audience Manager 통합 | (Adobe Experience Platform 전용 Adobe Audience Manager 고객을 위한 베타) DSP은 광고주의 광고 참여 데이터가 포함된 실행 가능한 로그 파일을 Adobe Experience Platform을 통해 Audience Manager으로 보낼 수 있습니다. Audience Manager에서 광고주는 고급 세분화 및 Audience Optimization 보고서와 같은 인사이트 도구의 사용을 위해 데이터를 사용할 수 있습니다. |
| 사용자 기반 상호 장치 그래프 타깃팅 | 셀프 서비스 DSP 고객은 새로운 캠페인에 걸쳐 사용자 기반의 타깃팅 및 빈도 관리를 위해 디바이스 그래프(Adobe Device Co-op 또는 LiveRamp)를 사용할 수 있습니다. 따라서 광고업체는 자사 디바이스를 통해 고객에게 도달하고 노출 횟수를 제한할 수 있습니다. 또한 배치 간 크로스 디바이스 타깃팅 설정의 일괄 편집이 베타 버전으로 제공됩니다. 계정에 대한 베타 버전을 활성화하려면 Adobe 계정 관리자에게 문의하십시오. |
| 사이트 타깃팅 | &quot;blacklists&quot; 및 &quot;화이트리스트&quot;의 이름이 보다 공정한 용어 &quot;차단된(사이트)&quot; 및 &quot;타깃팅된(사이트)&quot;으로 변경되었습니다. |
| Flashtalking 광고 | 이제 DSP에서는 단일 광고 생성 및 대량 타사 광고 제작 워크플로우를 통해 모든 Flashtalking 광고 태그에 대한 클릭 매크로를 자동으로 삽입합니다. |
| 보고서 | (Adobe Experience Platform 고객만을 위한 베타) Advertising Cloud Search의 새로운 크로스채널 보고서는 DSP 배치 및 검색 캠페인에 대한 일일 주요 지표와 함께 DSP 및 검색 전반에 걸쳐 미디어 지출을 종합적으로 파악할 수 있도록 해줍니다. |
