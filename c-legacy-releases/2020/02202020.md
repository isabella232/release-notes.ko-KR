...
* **Experience Manager as a Cloud Service Tutorials**
   ...
   Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en)에 대한 [자습서를 빠르게 시작하십시오.
...
* **Microsoft®  _Dynamics 변경 소유자_ 흐름 작업:**  리드를 변경하거나 Marketo Engage에서 직접 담당자에게 문의하십시오.
* **API 호출에 대한 개선 사항:**
   * 사용자 관리 API
   * 사용자 지정 개체 스키마 API
   * 랜딩 페이지 리디렉션 규칙 API
