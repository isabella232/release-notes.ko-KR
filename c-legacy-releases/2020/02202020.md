...
* **장치 상호 Analytics를 사용하는 조직에 대한 새로운 Workspace 템플릿:** 이 템플릿에서는 CDA가 방문 횟수를 합치는 데 얼마나 효과적인지를 보여주며 CDA 전용 차원 및 지표에 대해 교육합니다. CDA를 사용하는 보고서 세트가 필요합니다. 자세한 내용은 [상호 장치 Analytics 설정](https://experienceleague.adobe.com/docs/analytics/components/cda/cda-setup.html?lang=en)을 참조하십시오.
...
| **[!UICONTROL 아카이브 보기]** 옵션 EOL | 2019년 10월 30일 | 대시보드 관리자(**[!UICONTROL 구성 요소 > 대시보드]**)에 있는 **[!UICONTROL 아카이브 보기]** 옵션에 대한 종료 날짜를 2020년 1월로 발표합니다. |
...
[AppMeasurement for JavaScript 릴리스 노트](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=en)를 참조하십시오. 버전 2.19.0은 2020년 2월 21일에 릴리스되었습니다.
...
* **Cloud Service으로 Experience Manager Tutorials**

   Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en)로서 Experience Manager에 대한 [자습서를 빠르게 시작하십시오.
