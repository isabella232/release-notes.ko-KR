...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * [페이지 및 하위 페이지(페이지 트리)를 이전 버전으로 복원](https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions)하는[!UICONTROL  AEM as a Cloud Service]의 기능입니다.
...
[컨텐츠 감사 테스트](https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html)를 참조하십시오.
   ...
   * [AEM as a Cloud Service 릴리스 정보](https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)을 참조하십시오.
...
* **[!UICONTROL Dynamic Media]**&#x200B;의 CDN 무효화
   ...
   [[!UICONTROL Dynamic Media]를 통해 CDN 캐시 무효화하기](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)를 참조하십시오.
...
| 2020년 8월 12일 | [AEM as a Cloud Service SDK를 사용한 로컬 개발](https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/commerce/develop.html) | 비디오 | [!UICONTROL AEM Commerce] 및 [!UICONTROL AEM as a Cloud Service] SDK의 로컬 개발 환경을 설정하는 방법을 알아봅니다. |
...
| 2020년 8월 17일 | [Adobe IMS 사용자](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/accessing/adobe-ims-users.html) | 비디오 | Adobe IMS 사용자의 유형, Admin Console에서 액세스 및 관리되는 방법, AEM as a Cloud Service로 로그인하는 데 사용할 수 있는 방법에 대해 알아보십시오. |
...
* [AEM 6.4 누적 수정 팩 릴리스 정보](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html)
...
* [AEM Brand Portal 릴리스 정보](https://docs.adobe.com/content/help/en/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
* [AEM 데스크탑 앱 릴리스 정보](https://docs.adobe.com/content/help/en/experience-manager-desktop-app/using/release-notes.html)
...
* [AEM as a Cloud Service 사용 안내서](https://docs.adobe.com/content/help/ko-KR/experience-manager-cloud-service/landing/home.html)
