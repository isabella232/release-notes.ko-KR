...
>[!IMPORTANT]
>
>ID 서비스 코드 v2.0은 기본적으로 ID를 [!DNL  Adobe Advertising Cloud]와 자동으로 동기화합니다. [ID 동기화 및 일치율 이해](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html)를 참조하십시오.
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>검색 &gt; 제품에서 BMC(Bing Merchant Center) 계정에 대한 데이터를 다운로드하고 표시할 수 있습니다. 또한 인벤토리 피드 템플릿을 BMC 계정과 연결하여 캠페인 구조 및 광고 문구에 쇼핑 캠페인에 대한 필드 열을 포함할 수 있습니다. </p> <p>Advertising Cloud에서 제품 데이터로 직접 작업하려면 계정 액세스 자격 증명과 액세스 권한이 활성화된 계정 레코드를 Advertising Cloud에서 만들어야 합니다. </p> <p>현재 다음과 같은 경우 BMC 피드를 사용할 수 있습니다. </p> <p> 
