...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Bing 광고 계정) 기존의 Bing DSA(동적 검색 광고) 및 DSA 대상은 이제 광고 및 자동 대상 보기에 나열됩니다. DSA 및 Target에 대한 비용 및 클릭 데이터의 정확성과 매출 기여도 분석은 여전히 테스트되고 있으며, Adobe Advertising Cloud는 최적화된 포트폴리오에서 DSA 타겟에 대한 입찰을 모델링하고 최적화하지 않습니다. 이제 기존 Bing DSA(동적 검색 광고) 및 DSA 대상을 다운로드하고, 일괄 시트를 사용하여 DSA 및 DSA 대상을 편집(작성하지 않음)할 수 있습니다. 일괄 시트 다운로드 대화 상자에서 "자동 대상" 섹션을 선택하면 동적 검색 대상에 대한 데이터가 추가됩니다. </p> </td> 
  </tr> 
  <tr> 
