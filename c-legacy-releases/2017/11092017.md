...
>[!IMPORTANT]
>
>Launch는 Adobe Experience Cloud 고객에게 점진적으로 출시되고 있습니다. 사전 체험판을 사용해 보려면, [Launch 릴리스 양식](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?WVFJ3K)에 필요한 정보를 입력하여 알려 주십시오.
...
<table id="table_579DC25A4F3A49A78290837578B12D96"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Launch 컨테이너 태그는 Adobe Tag Manager보다 60% 가벼우며 Google Tag Manager보다 40% 가볍습니다. 사용자 지정 코드를 포함하여 컨테이너의 콘텐츠가 축소됩니다. 모두 모듈식입니다. 항목이 필요하지 않으면 라이브러리에 포함되지 않습니다. 따라서 빠르고 컴팩트하게 구현됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 사소한 버그가 수정되었습니다.
* 2018년 3월부터는 Adobe Analytics 로그인 프로세스가 더 이상 지원되지 않으므로 Adobe ID가 있어야 합니다. [자세히...](https://marketing.adobe.com/resources/help/ko_KR/mobile/gs_signin.html)
