...
* GET 또는 POST 메서드를 사용하여 DCS API에서 작업할 수 있습니다. [DCS API 메서드](https://marketing.adobe.com/resources/help/ko_KR/aam/dcs-api-methods.html)는 각 사례에 사용해야 하는 구문에 대해 설명합니다.
...
제품 설명서는 [Adobe Campaign Standard 설명서](https://docs.adobe.com/docs/kr/campaign/ACS.html)에서 확인할 수 있습니다.

* [Adobe Campaign Standard 릴리스 노트](https://docs.campaign.adobe.com/doc/standard/kr/RN.html)
* [Adobe Campaign Standard 설명서](https://docs.adobe.com/docs/kr/campaign/ACS.html)
* [Adobe Campaign v7 릴리스 노트](https://docs.campaign.adobe.com/doc/AC/kr/RN.html)
* [Adobe Campaign v7 설명서](https://docs.adobe.com/docs/kr/campaign/AC.html)
* [Adobe Campaign v6 설명서](https://docs.adobe.com/docs/kr/campaign/AC6.html)
