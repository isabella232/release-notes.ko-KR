...
[다른 Marketing Cloud 솔루션 및 서비스와 함께 DNS Prefetch 사용](https://marketing.adobe.com/resources/help/ko_KR/mcloud/dns-prefetch.html)
...
* Addressable Audience 용어를 설명하기 위해 벤 다이어그램을 업데이트했습니다. [Addressable Audience 설명서](https://marketing.adobe.com/resources/help/ko_KR/aam/addressable-audiences.html)를 참조하십시오. (AAM-27559)
* 아웃바운드 데이터 파일에서 새로운 &lt;DPUUIDS&gt; 콘텐츠 매크로를 추가했습니다. [아웃바운드 템플릿 매크로](https://marketing.adobe.com/resources/help/ko_KR/aam/outbound-template-macros.html) 및 [아웃바운드 매크로 예시](https://marketing.adobe.com/resources/help/ko_KR/aam/outbound-macro-examples.html)를 참조하십시오. (AAM-28000)
...
최신 릴리스 정보는 [Primetime 릴리스 노트](https://help.adobe.com/ko_KR/primetime/release_notes/index.html)를 참조하십시오.
