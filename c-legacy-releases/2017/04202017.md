...
* 프로필 링크 기능을 개선했습니다. 이제 이 기능은 [Audience Manager UUID](https://marketing.adobe.com/resources/help/ko_KR/aam/ids-in-aam.html)를 다른 3개의 Audience Manager UUID에 연결하여 클러스터에 총 4개의 Audience Manager UUID가 됩니다. (AAM-28808)
* 이제 다음 API에서 테스트 세그먼트 ID([SID 및 csegID](https://marketing.adobe.com/resources/help/ko_KR/aam/ids-in-aam.html))를 쿼리 매개 변수 testSegments=true와 함께 노출합니다(AAM-27591).
   * ` .../v1/segments`
   * ` .../v1/destinations/<destinationId>/mappings`

* 세그먼트 API 메서드를 Swagger로 병합했습니다. [Audience Manager API 코드 마이그레이션Migration](https://marketing.adobe.com/resources/help/ko_KR/aam/c_api_swagger.html)을 참조하십시오. (AAM-28601)
...
Adobe는 Windows 및 Linux용 [Adobe Campaign 보안 게시판](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) v 6.11을 릴리스했습니다.
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이제 Creative SDK에서 제공하는 완벽한 기능 세트에 액세스하여 이메일 또는 방문 페이지를 편집할 때 콘텐츠 편집기에서 직접 이미지를 개선할 수 있습니다. </p> <p> 이 기능은 추가 Creative Cloud 솔루션을 구입할 필요가 없습니다. </p> </td> 
  </tr> 
  <tr> 
