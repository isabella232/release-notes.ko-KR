...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Analysis Workspace에서 사람 지표를 적용하여 장치 간 방문자를 식별할 수 있습니다. </p> <p><a href="https://marketing.adobe.com/resources/help/ko_KR/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud 장치 조합</a> 설명서에서 사람 지표에 대한 액세스 권한을 받는 방법을 알아봅니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      ...
      <li id="li_0DB03B90D5B840EAA7BD390A228BC3A5">Report Builder 요청을 예약할 때 공백에 공백이 포함된 이메일 주소 문제를 수정했습니다. ( AN-138584) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">예를 들어 선택한 날짜 범위에서 링크 클릭이 수집되지 않는 경우 발생하는 문제를 해결했습니다. 이로 인해 Activity Map 도구 모음이 매달려 있는 상태로 고정되었습니다. (AN-140163, AN-140119, AN-136186) </li> 
...
* 세그먼트 API 메서드를 Swagger로 병합했습니다. See [Audience Manager API Code Migration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
...
* 암호 재설정 모달, Audience Marketplace 및 사용자 인터페이스 전체의 목록 페이지의 정렬 열에 잘못된 아이콘이 표시되었던 시각적 버그를 수정했습니다. (AAM-28953)
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이제 Creative SDK에서 제공하는 완벽한 기능 세트에 액세스하여 이메일 또는 방문 페이지를 편집할 때 콘텐츠 편집기에서 직접 이미지를 개선할 수 있습니다. </p> <p> 이 기능은 추가 Creative Cloud 솔루션을 획득할 필요가 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 트랜잭션 푸시 알림 </p> </td> 
   <td colname="col2"> <p> 모바일 응용 프로그램 채널이 Adobe Campaign의 트랜잭션 메시징 기능에 추가되었습니다. 이제 트랜잭션 메시지에 대해 세 개의 채널이 지원됩니다.이메일, SMS 및 푸시 알림 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>최신 권장 AEM Oak 누적 수정 팩은 다음 위치에서 사용할 수 있습니다. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 2017년 4월 25일 오전 09:00-10:00 MST에서 AEM Community Super User Lokesh BS에 참여하십시오. 2015 - 2016년 커뮤니티 회원은 'Experience Manager에서 Bootstrap 및 Angular JS를 사용하여 반응형 레이아웃 작성'에 대해 토론합니다'. </p> <p>AEM 프로젝트에 적용할 수 있는 AEM 개발 기술을 학습합니다. 로케쉬는 데모를 제공하고 질문에 답변합니다. AEM 개발자의 경우 이 세션은 놓칠 수 없는 세션입니다. <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_7.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">여기서 RSVP</a>할 수 있습니다 . </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Cloud에서 Analytics로 리버스 데이터 피드의 새로운 버전이 데이터 정확도를 크게 향상시킵니다. Analytics와 통합된 모든 광고주가 다음 주 내에 새 리버스 피드로 업그레이드됩니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>이제 기존 Adobe Experience Cloud 대상의 이메일 목록 또는 세그먼트를 사용하여 Google 대상자(검색 광고에 대한 리마케팅 목록)를 만들 수 있습니다. </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager 세그먼트:(허용 목록에추가된광고주용 베타 전용) 캠페인 베타&amp;gt;대상&amp;gt;대상, 대상으로 Advertising Cloud을 포함하는 Audience Manager 세그먼트에서 Google 웹 사이트 태그 기반 대상을 만들 수 있습니다. 여기에는 Adobe Experience Cloud에 게시된 Adobe Analytics 세그먼트와 사람 핵심 서비스를 사용하여 Adobe Experience Cloud에서 만들어진 세그먼트가 포함될 수 있습니다. Advertising Cloud은 Google 추적 URL을 Audience Manager 세그먼트로 자동 푸시하여 Google에서 대상을 추적할 수 있습니다. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(베타 허용 목록에추가된 광고주만 해당) 새 검색 베타 사용자 인터페이스는 릴리스 후 다음 주에 사용할 수 있습니다. </p> <p> 
