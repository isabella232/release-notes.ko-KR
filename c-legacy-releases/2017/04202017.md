...
Learn more about the [Adobe Experience Cloud](https://www.adobe.com/kr/experience-cloud.html) announcement at the 2017 Adobe Summit.
...
사용 사례 레시피는 솔루션 간 워크플로우 및 통합을 구현하고 배포하는 방법을 보여줍니다. 사용 방법 비디오와 자조 방법을 소개하는 이 유용한 자료가 곧 제공될 예정입니다.
...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 분석 작업 공간에서 사람 지표를 적용하여 장치에서 방문자를 식별할 수 있습니다. </p> <p><a href="https://marketing.adobe.com/resources/help/ko_KR/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud 장치 조합</a> 설명서에서 사람 지표에 대한 액세스 권한을 받는 방법을 알아봅니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>사람 템플릿 </p> </td> 
   <td colname="col2"> <p>참고: 사람 템플릿과 관련 사람 지표는 <a href="https://marketing.adobe.com/resources/help/ko_KR/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud 장치 조합</a>의 일부로서만 사용할 수 있습니다. </p> <p>템플릿은 고유 방문자 수 지표의 중복 제거 버전인 사람 지표를 기반으로 합니다. 사람 지표는 여러 장치를 사용하는 소비자가 브랜드와 상호 작용하는 빈도를 측정합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
...
Adobe Analytics 인터페이스 도구 및 구성 요소(분석 작업 공간, 보고 및 분석, 리포트 빌더 등)에 적용된 수정 사항 및 경미한 업데이트.
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8A8B70BF95EE4E9D895043277974ED74"> 
     ...
     <li id="li_56DAE7B163764192B2731FA1D45D499D">이메일 또는 전화 알림을 트리거하지 않는 지능형 경고 문제를 수정했습니다. (AN-135483) </li> 
     ...
     <li id="li_BBB9F3D8177A4FB1B0E66FA053E02F79">세그먼트를 만들 때 일본어 전용 오류가 발생하는 문제를 해결했습니다. (AN-139916) </li> 
     <li id="li_9424DBAF511C4273AC52EF4016697E3C">시간대가 최신 상태가 아니어서 경고가 잘못 트리거되는 문제를 수정했습니다. (AN-134390) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
     ...
     <li id="li_3067A6CC3B6544DDA2D0307E68EFC501">차원별로 % 지표를 분류할 때 발생하는 문제를 수정했습니다. 연결된 차원에 대한 지표는 백분율 대신 소수가 되었습니다. (AN-141122) </li> 
     ...
     <li id="li_65CC26F8EA214077B10BE18906958E02">분류 셀에 연결할 때 라인 그래프가 다시 로드되고 읽을 수 없는 정보가 표시되는 문제를 해결했습니다. (AN-140057) </li> 
     ...
     <li id="li_DCE679F7FEDA437DBA0EB4C553BDE61D">선택 사항을 트렌딩한 후 <span class="uicontrol">데이터 소스 표시</span>에서 자동으로 생성된 숨겨진 테이블을 변경했을 때 발생하는 문제를 해결했습니다 . 해당 테이블에 대한 변경 내용이 저장되지 않았습니다. (AN-139341, AN-136031) </li> 
     ...
     <li id="li_F7D90FC5E62F4FCBB3FAFFC23637B3EA">.pdf 또는 .csv 보고서가 이메일을 통해 공유되지 않는 문제를 해결했습니다. (AN-125437) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_22A36506B82A4404B03B00F8D9D7CE92">기존 보고서 세트에서 설정을 복제하여 새 보고서 세트를 생성하려는 문제를 해결했습니다. (AN-137797) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      ...
      <li id="li_121EE083916B4908A37CF6F47B0AFB7B">현지화된 일본어 버전의 Report Builder에서 영어 메뉴 이름 문제를 해결했습니다. (AN-138828, AN-137183) </li> 
      <li id="li_0DB03B90D5B840EAA7BD390A228BC3A5">리포트 빌더 요청을 예약할 때 공백이 포함된 이메일 주소 문제를 수정했습니다. ( AN-138584) </li> 
      <li id="li_215E6C18553B4A889E50AB2B1A42CB13">고객이 Marketing Cloud 로그인을 통해 리포트 빌더에 로그인하지 못했던 문제를 수정했습니다. (AN-138557) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">예를 들어 선택한 날짜 범위에서 링크 클릭이 수집되지 않는 경우 발생하는 문제를 해결했습니다. 이로 인해 Activity Map 도구 모음이 정지되는 상태로 고정되었습니다. (AN-140163, AN-140119, AN-136186) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50E675542D94AB3B1206ECAC3C39BC8"> 
      <li id="li_A5C2F2B605694CE6B31BF547D7E15462"> 해결된 세그먼트 문제: 
      ...
      <li id="li_94115FD800EF4DF891D0AF616CE8AD83">중첩 방문/방문자 세그먼트 필터링(AN-116275)의 버그가 수정되었습니다. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b><span class="keyword"></span>  JavaScript용 AppMeasurement</b> </p> <p>버전 2.1.0 </p> 
    <ul id="ul_80BCF27E492246AD883ABD5B417004E1"> 
     ...
     <li id="li_CB1E4CAC306B473FBFC2E50B440568B1"> 방문자 API 2.1.0을 다시 포함합니다. (AN-140873) </li> 
...
* 일부 고객의 경우 트레이트 목록 페이지에 데이터 소스에 대한 끊어진 링크가 포함되는 문제가 해결되었습니다. (AAM-29174)
* 프로필 링크 기능이 개선되었습니다. The feature now links an [Audience Manager UUID](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) to another three Audience Manager UUIDs, for a total of 4 Audience Manager UUIDs in a cluster. (AAM-28808)
...
* 세그먼트 API 메서드를 Swagger로 병합했습니다. Audience [Manager API 코드 마이그레이션을 참조하십시오](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
* DAID 대상에 대해 Addressable Audience에서 몇 가지 작은 시각적 버그를 제거했습니다. (AAM-28679)
* 고객이 이미 사용 중인 사용자 이름으로 회사에 대한 새 사용자를 만들고자 할 때 오류 메시지가 표시되지 않는 사용자 관리 페이지의 문제를 해결했습니다. (AAM-28945)
* 암호 재설정 모달, Audience Marketplace 및 사용자 인터페이스 간 목록 페이지의 열 정렬에 잘못된 아이콘이 표시되었던 시각적 버그를 수정했습니다. (AAM-28953)
* Audience Marketplace 최종 사용자 ID를 회사에 추가할 수 없는 Audience Manager 관리 인터페이스의 문제를 수정했습니다. (AAM-28953)

## [!DNL Social]

**수정 사항**

* 게시 워크플로우: 승인 작업 과정을 거치지 않은 사용자가 여전히 승인 알림을 받는 문제를 수정했습니다. 워크플로우의 승인자인 사용자만 게시물을 승인할 메시지를 수신하게 됩니다.
* 어디서나 게시: 사진 또는 비디오 업로드가 특정 플랫폼의 API 크기 제한을 초과할 때 사용자에게 경고가 표시되지 않던 문제를 수정했습니다.
* 어디서나 게시: Facebook에서 타깃팅된 사진 앨범 게시물이 사진 없이 게시되던 문제가 수정되었습니다.
...
* Facebook 속성 세부 사항: Facebook 속성에 대한 지리적 위치별 팬 데이터 획득 문제를 해결했습니다.
* 중재: 사용자가 속성 또는 작성자에 대해 여러 줄의 주석을 작성할 수 없던 문제를 수정했습니다.
* 중재: 작성자 세부 사항 페이지에 해당 작성자와의 상호 작용의 전체 내역이 표시되지 않는 문제가 해결되었습니다.
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Creative SDK를 사용한 향상된 이미지 에디션 기능 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 모바일 응용 프로그램 채널이 Adobe Campaign의 트랜잭션 메시지 기능에 추가되었습니다. 이제 트랜잭션 메시지에 대해 세 개의 채널이 지원됩니다. 이메일, SMS 및 푸시 알림 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 반복 푸시 알림 </p> </td> 
   <td colname="col2"> <p> 이제 워크플로우에서 반복되는 푸시 알림을 사용할 수 있습니다. 반복적인 알림을 사용하면 동일한 대상 또는 특정 빈도(일별, 월별 등)로 동적 대상자에게 동일한 모바일 앱 푸시 알림 전달을 여러 번 보낼 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 2017년 4월 25일 오전 09:00-10:00 MST에서 AEM Community Super User Lokesh BS에 참여하십시오. 2015 - 2016년 커뮤니티 회원은 'Experience Manager에서 Bootstrap 및 Angular JS를 사용하여 반응형 레이아웃 작성'에 대해 토론합니다'. </p> <p>AEM 프로젝트에 적용할 수 있는 AEM 개발 기술에 대해 학습합니다. 로케쉬는 데모를 제공하고 질문에 답변합니다. AEM 개발자로서 이 세션은 놓치고 싶지 않은 세션입니다. <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_7.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">여기서 RSVP</a>할 수 있습니다 . </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Advertising Cloud에서 Analytics로 리버스 데이터 피드의 새로운 버전을 사용하면 데이터 정확도가 크게 향상됩니다. Analytics와 통합된 모든 광고주가 다음 주 내에 새 리버스 피드로 업그레이드됩니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>이제 기존 Adobe Experience Cloud 대상의 이메일 목록 또는 세그먼트를 사용하여 Google 대상자(검색 광고에 대한 리마케팅 목록)를 만들 수 있습니다. </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager 세그먼트: (나열된 광고주만 사용할 수 있는 베타) 캠페인 베타 &amp;gt; 대상&amp;gt; 대상: Advertising Cloud를 대상으로 하는 Audience Manager 세그먼트 중 하나에서 Google 웹 사이트 태그 기반 대상을 만들 수 있습니다. 여기에는 Adobe Experience Cloud에 게시된 Adobe Analytics 세그먼트와 사람 핵심 서비스를 사용하여 Adobe Experience Cloud에서 만들어진 세그먼트가 포함될 수 있습니다. Adobe Advertising Cloud는 Google 추적 URL을 다시 Audience Manager 세그먼트에 푸시하므로 Google이 고객을 추적할 수 있습니다. </li> 
     </ul> </p> <p>Adobe Advertising Cloud는 Google 대상을 만들거나 편집하는 데 사용되는 이메일 목록 또는 Audience Manager 세그먼트의 고객 데이터를 저장하지 않습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Campaigns Beta 검색 </p> </td> 
   <td colname="col2"> <p>(베타 허용 목록에 있는 광고주만 해당) 새 검색 베타 사용자 인터페이스는 릴리스 후 다음 주에 사용할 수 있습니다. </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      <li id="li_226EDEA6C6404A3B886E7C1E0F25EA77">새로운 격자, 왼쪽 레일, 필터, 툴바 및 벌크 작업을 수행할 수 있습니다. </li> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">라이브러리, 타겟 및 제외가 있는 대상 메뉴 라이브러리에는 모든 Google 대상(리마케팅 목록)이 나열되며 Adobe Audience Manager의 세그먼트를 사용하여 Google 대상을 만들 수 있습니다. Google 캠페인의 모든 대상을 광고 그룹 수준 타겟 및 캠페인 및 광고 그룹 수준 제외로 사용할 수 있습니다. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
