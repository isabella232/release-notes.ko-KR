...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이제 기존 Adobe Experience Cloud 대상의 이메일 목록 또는 세그먼트를 사용하여 Google 대상자(검색 광고에 대한 리마케팅 목록)를 만들 수 있습니다. </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager 세그먼트: (허용된 광고주만 베타) 캠페인 베타&amp;gt; 대상&amp;gt; 대상: Advertising Cloud를 대상으로 하는 Audience Manager 세그먼트 중 하나에서 Google 웹 사이트 태그 기반 대상을 만들 수 있습니다. 여기에는 Adobe Experience Cloud에 게시된 Adobe Analytics 세그먼트와 사람 핵심 서비스를 사용하여 Adobe Experience Cloud에서 만들어진 세그먼트가 포함될 수 있습니다. Adobe Advertising Cloud는 Google 추적 URL을 다시 Audience Manager 세그먼트에 푸시하므로 Google이 고객을 추적할 수 있습니다. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(허용되는 광고주만 베타) 새 검색 베타 사용자 인터페이스는 릴리스 후 다음 주에 사용할 수 있습니다. </p> <p> 
