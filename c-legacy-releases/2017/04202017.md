...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Cloud에서 Analytics로 리버스 데이터 피드의 새로운 버전이 데이터 정확도를 크게 향상시켰습니다. Analytics 통합을 사용하는 모든 광고주는 앞으로 몇 주 내에 새로운 역방향 피드로 업그레이드될 것입니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>기존 Adobe Experience Cloud 잠재 고객의 이메일 목록 또는 세그먼트를 사용하여 Google 잠재 고객(검색 광고용 리마케팅 목록)을 만들 수 있습니다. </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager 세그먼트:(화이트리스트 광고주용 베타) 캠페인 베타 &amp;gt;대상 &amp;gt;대상을 위해 Advertising Cloud가 있는 Audience Manager 세그먼트에서 Google 웹 사이트 태그 기반 대상을 만들 수 있습니다. 여기에는 Adobe Experience Cloud에 게시된 Adobe Analytics 세그먼트와 사용자 핵심 서비스를 사용하여 Adobe Experience Cloud에서 생성된 세그먼트가 포함될 수 있습니다. Adobe Advertising Cloud는 Google 추적 URL을 Audience Manager 세그먼트에 자동으로 다시 푸시하므로 Google에서 대상을 추적할 수 있습니다. </li> 
     </ul> </p> <p>Advertising Cloud는 Google 대상을 만들거나 편집하는 데 사용되는 이메일 목록 또는 Audience Manager 세그먼트의 고객 데이터를 저장하지 않습니다. </p> </td> 
  </tr> 
  <tr> 
