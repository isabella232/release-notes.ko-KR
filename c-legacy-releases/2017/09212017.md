...
[Marketing Cloud ID Services](https://marketing.adobe.com/resources/help/ko_KR/mcvid/) 제품 설명서를 참조하십시오.
...
Analytics 고객은 분류, Data Sources, 처리 규칙 및 데이터 웨어하우스 내보내기 등 표준 Analytics 기능과 API를 사용하여 ExactTarget에 대한 사용자 지정 통합을 구현할 수 있습니다. Adobe 컨설팅 팀과의 계약은 필요에 따라 고려될 수 있습니다.
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>관리 콘솔로의 사용자 ID 마이그레이션 </p> </td> 
   <td colname="col02"> <p>2017년 9월 21일 </p> </td> 
   <td colname="col2"> <p>Analytics 사용자 ID 마이그레이션을 통해 관리자는 Analytics 사용자 관리에서 Adobe Admin Console로 사용자 계정을 쉽게 마이그레이션할 수 있습니다. 사용자가 마이그레이션되면 Experience Cloud에서 사용할 수 있는 솔루션 및 핵심 서비스에 액세스할 수 있습니다. 마이그레이션은 이번 달 말부터 단계별로 고객에게 배포되고 있습니다. </p> <p> <a href="https://marketing.adobe.com/resources/help/ko_KR/experience-cloud/admin-console/analytics-migration/" format="https" scope="external"> Analytics 사용자 ID 마이그레이션에 대해 자세히 알아보기 </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>2017년 9월 21일 </p> </td> 
   <td colname="col2"> <p>2018년 5월 현재 애드혹 분석은 Java 8 이상만 지원합니다. 2018년 5월 유지 관리 릴리스 이후 Java 7에서 애드혹 분석을 실행하도록 선택하면 Adobe는 더 이상 애드혹 분석 구현을 지원하지 않습니다. </p> <p>Adobe의 .jar 파일은 1.7.0_76 이하의 Java 버전에서 지원되지 않는 보안 256비트 암호화로 서명됩니다. 이 256비트 인증서를 통해 강화된 보안 기능을 제공할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>타임스탬프를 기반으로 한 차원이 분석 작업 공간에 즉시 추가되었습니다. 차원은 다음과 같습니다. </p> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> Adobe Analytics Cloud는 이제 Amazon Alexa, Google Assistant, Microsoft Cortana 및 Apple Siri와 같은 음성 지원 지능형 어시스의 성능을 추적할 수 있습니다. </p> <p><a href="https://marketing.adobe.com/resources/help/en_US/reference/voice-analytics-faq.html" format="html" scope="external">FAQ</a>를 참조하십시오 . </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> "java_enabled"를 사용하는 세그먼트가 데이터 웨어하우스 작업에 대해 제대로 처리되지 않는 문제를 해결했습니다. (AN-147372) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>실행 가능한 로그 파일 </p> </td> 
...
* 업데이트된 Audience Manager 세그먼트 이름이 Google DFP 대상으로 전송되지 않던 문제를 수정했습니다. (AAM-31677)
...
* 이제 이벤트 호출 응답의 영역 ID가 변경되면 DIL이 ID 동기화를 다시 실행합니다. (CORE-4304)
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 이 대량 가입 개선 사항을 통해 이제 워크플로우의 가입 서비스 활동을 통해 Adobe Campaign Standard 데이터베이스에 구독 정보(출처 및 날짜)를 직접 저장할 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 이제 Adobe Campaign Standard에서 Adobe Campaign v7으로 행동 데이터를 다시 보낼 수 있으므로 마케터와 데이터 분석가가 마케팅 캠페인에 대한 360° 보기를 구축할 수 있습니다. ACS 행동 데이터를 통합하는 고급 고객 및 세그먼트 만들기; 마케팅 활동의 ROI를 보다 효과적으로 측정할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> SAP HANA 커넥터 </p> </td> 
   <td colname="col2"> <p>통합 데이터 액세스 커넥터를 사용하면 Adobe ‪ Campaign의 모든 외부 데이터‪을 실시간으로 활용하여 SAP HANA를 지원할 수 있습니다. 페더레이티드 ‪ 데이터 액세스‪을 사용하면 여러 개의 서로 다른‪ 외부 데이터베이스를 Adobe Campaign과 연결할 수 있습니다. 데이터 세트를 가져오거나 Adobe Campaign 플랫폼‪에 저장하지 않고 모든 소스에서 실시간으로 데이터를 쿼리할 수 있습니다‪. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> HiveSQL을 통한 Hadoop 커넥터 </p> </td> 
   <td colname="col2"> <p>대용량 데이터 세트를 처리하는 데 있어서 Hadoop은 관계형 데이터베이스 관리 시스템보다 장점이 있으며, 비정형 데이터가 계속 증가함에 따라 모든 규모의 비즈니스에 대한 가치는 계속 증가합니다. Adobe Campaign은 HiveSQL을 통해 Hadoop 커넥터를 통해 고객이 Adobe Campaign UI에서 바로 스키마에 액세스하여 고급, 고도로 세그먼트화된 고객을 빠르고 유연하며 확장 가능한 방식으로 만들 수 있는 Hadoop의 강력한 기능을 활용할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>AEM 6.3 다이내믹 미디어 기능 팩(NPR-14410 및 NPR-18912) </p> </td> 
   <td colname="col3"> <p>이 릴리스는 다이내믹 미디어 고객을 위한 새로운 자동화 및 전달 기능을 제공하며 기존 Dynamic Media Classic(S7)-AEM 고객이 Dynamic Media로 전환하도록 타깃팅된 첫 번째 릴리스입니다. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>적응형 양식 구성 서비스를 사용하면 역할이나 기능을 기반으로 규칙 편집기 액세스를 사용자로 제한할 수 있습니다. </p> <p><a href="https://helpx.adobe.com/aem-forms/6-3/rule-editor-access-user-groups.html" format="https" scope="external">사용자 그룹을 선택하려면 규칙 편집기 액세스 권한 부여</a>를 참조하십시오 . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM Forms에서는 Dynamics 365를 양식과 빠르게 통합하는 데 사용할 수 있는 구성 패키지를 제공합니다. 이 패키지에는 미리 구성된 Dynamics 365 개체 및 서비스가 포함된 클라우드 서비스 구성 및 양식 데이터 모델이 포함됩니다. </p> <p><a href="https://helpx.adobe.com/aem-forms/6-3/ms-dynamics-odata-configuration.html" format="https" scope="external">Microsoft Dynamics 365 OData 구성</a>을 참조하십시오 . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>양식 JEE 설치 및 업그레이드 </p> </td> 
   <td colname="col3"> <p>AEM 6.3 Forms JEE에 대한 몇 가지 문제와 새로 고친 설치 및 업그레이드 설명서를 수정했습니다. </p> <p>왼쪽 패널의 <b>항목</b>에 있는 <a href="https://helpx.adobe.com/aem-forms/6-3/user-guide.html" format="https" scope="external">JEE의 AEM Forms 설치 또는 업그레이드</a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM Sites 6.3 개발 시작 - WKND 자습서 </p> </td> 
   <td colname="col3"> <p>새 개발자 6.3 시작하기 자습서는 다음 최신 AEM 기술을 기반으로 제공됩니다. </p> <p> 
  ...
  <tr> 
   <td colname="col2"> <p> 클라이언트측 라이브러리를 사용한 AEM Screens 6.3 설명서 </p> </td> 
   <td colname="col3"> <p>새 AEM Screens 6.3 설명서를 사용할 수 있습니다. 또는 사용자가 5분 내에 디지털 서명 경험을 만들 수 있는 빠른 시작을 사용할 수 있습니다. 다음 리소스를 참조하십시오. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>웹 페이지의 구성 요소가 렌더링되면 HTML 요소를 생성하여 렌더링된 구성 요소를 자체 내에 래핑할 수 있습니다. 개발자의 경우 AEM은 포함된 구성 요소를 래핑하는 데코레이션 태그를 제어하기 위한 명확하고 간단한 로직을 제공합니다. </p> <p><a href="https://docs.adobe.com/docs/en/aem/6-3/develop/components/decoration-tag.html" format="https" scope="external">장식 태그</a>를 참조하십시오 . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_39E9A53B4A1A465589547638A29CB34C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> (리마케팅 타겟이 있는 Bing 광고 캠페인) Advertising Cloud는 다음을 지원합니다. </p> 
    <ul id="ul_A77BB0543BF54FD4B514AB25C84EA33D"> 
     <li id="li_D73008892A584B8AB0E333F3556D70EF"> 기존 Bing 광고 대상 및 재마케팅 목록 타겟/제외는 캠페인의 대상 타겟 보기 및 캠페인 베타의 대상 보기에 표시됩니다. </li> 
     <li id="li_46876A78AEB5431B83696668A2E604F0"> Bulksheet에서는 이제 광고 그룹 수준 대상(제외 제외) 만들기 및 편집을 지원합니다. 일괄 시트 다운로드 대화 상자에서 "RLSA 대상" 섹션을 선택하면 다음과 같은 열을 포함하여 RLSA 대상에 대한 데이터가 추가됩니다. "캠페인 이름," "광고 그룹 이름", "입찰 조정"(선택 사항), "대상" 및 "RLSA 대상 상태" 각 RLSA 대상에 대해 "RLSA 타겟 ID" 열이 자동으로 추가됩니다. </li> 
    </ul> <p> <b>참고:</b> </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이제 AdWords 대상 보고서에서 Advertising Cloud에서 추적한 거래 속성에 대한 열을 포함할 수 있습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads는 9월 25일부터 Advertising Cloud 관리 계정을 새로운 사이트 링크 모델(공유 사이트 링크)로 마이그레이션합니다. 이 과정은 4일이 걸릴 것으로 예상된다. 9월 22일부터 계정 마이그레이션이 완료되는 시점까지 사이트 링크는 Advertising Cloud에서 액세스할 수 없으며 삭제된 것으로 잘못 표시됩니다. 마이그레이션이 완료되기 전에 사이트 링크를 변경해야 하는 경우 Bing 광고 편집기에서 직접 작업하십시오. 마이그레이션이 완료된 후 변경 사항이 새 모델로 마이그레이션되고 Advertising Cloud에 의해 동기화됩니다. 공유 사이트 링크를 지원하는 기능은 10월 릴리스에서 사용할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Campaigns Beta 검색 </p> </td> 
   <td colname="col2"> <p>이제 모든 사용자에게 검색 광고 &gt; 캠페인 &gt; 캠페인 베타에 새로운 검색 베타 사용자 인터페이스가 제공됩니다. </p> <p>새로운 기능은 다음과 같습니다. </p> <p> 
     <ul id="ul_F43F02DBCF9A4248AC7A7258FB13ECC7"> 
      ...
      <li id="li_3E3A37A41C7B40BEA9A0747A42174C08">이제 캠페인에서 라이브 &gt; 잠재 고객 &gt; 타겟 보기에서 잠재 고객(리 마케팅 목록)을 타깃팅할 수 있습니다. 이전에는 광고 그룹 수준에서만 대상을 타깃팅할 수 있었습니다. 편집 모드 또는 대상 보기의 "입찰 조정" 열에서 각 대상 대상에 대한 입찰 조정을 설정할 수 있습니다. 자동 입찰 조정을 아직 사용할 수 없습니다. 참고: 일괄 시트 지원은 다음 릴리스에서 사용할 수 있습니다. </li> 
