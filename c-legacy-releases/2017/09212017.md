...
* ID 서비스에서 사용하는 Adobe 도메인에 호출을 허용하는 방법에 대해 설명하는 새 설명서, [콘텐츠 보안 정책 및 Marketing Cloud ID 서비스](https://marketing.adobe.com/resources/help/ko_KR/mcvid/?f=mcvid-csp.html)가 추가되었습니다.
...
* [Audience Lab](https://marketing.adobe.com/resources/help/ko_KR/aam/?f=audience-lab.html)이 적절한 방식으로 로드되지 않는 버그를 수정했습니다. (AAM-32249)
