...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>" 입찰 조정 자동 최적화 "옵션을 사용하면 포트폴리오가 최적화된 경우 포트폴리오의 광고 그룹에 대한 입찰 조정 설정을 자동으로 변경하여 성과를 최적화할 수 있습니다. Google, Bing 및 Yahoo! Google 및 Bing의 태블릿과 컴퓨터 타겟, Google RLSA 타겟 및 Google 위치 타겟에 대한 입찰 조정을 최적화할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(최종 URL이 포함된 Bing Merchant Center 계정) "템플릿 추적" 필드는 Bing 쇼핑 템플릿과 일괄 시트의 제품 그룹에서 사용할 수 있습니다. </p> <p>Advertising Cloud 전환 추적을 위해 계정, 캠페인 또는 광고 그룹 수준에서 추적 템플릿이 있는 경우 값을 입력하지 않아도 됩니다. </p> </td> 
  </tr> 
  <tr> 
