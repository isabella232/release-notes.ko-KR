...
* 트레이트 및 폴더 API 메서드를 Swagger로 마이그레이션했습니다. [Audience Manager API 코드 마이그레이션Migration](https://marketing.adobe.com/resources/help/ko_KR/aam/c_api_swagger.html)을 참조하십시오. (AAM-28221 및 AAM-27133)
...
이 릴리스는 ` GA.submitUniversalAnalytics`가 데이터를 데이터 수집 서버로 보내지 못하게 하는 버그를 수정합니다. [GA.submitUniversalAnalytics](https://marketing.adobe.com/resources/help/ko_KR/aam/dil-google-universal-analytics.html)를 참조하십시오. (MCID-354)

**새로운 설명서 및 수정된 설명서**

**신규**

[다른 Marketing Cloud 솔루션과 함께 DNS Prefetch 사용](https://marketing.adobe.com/resources/help/ko_KR/mcloud/dns-prefetch.html)은 페이지 로드 시간을 줄이기 위해 DNS Prefetch를 사용하는 방법에 대해 설명합니다.

**수정된 설명서**

* [DCS 오류 코드, 메시지 및 예시](https://marketing.adobe.com/resources/help/ko_KR/aam/dcs_error_codes.html)에 통합 경고가 포함됩니다.
* [아웃바운드 데이터 파일 이름)https://marketing.adobe.com/resources/help/ko_KR/aam/c_name_reqs_outbound.html](에 선택적 매개 변수` PID-ALIAS`가 포함됩니다.
* [세그먼트 요약 보기](https://marketing.adobe.com/resources/help/ko_KR/aam/c_segment_summary.html)에 보고서 전환 확인 간격이 포함됩니다.
* [DIL 생성](https://marketing.adobe.com/resources/help/ko_KR/aam/r_dil_create.html)에 ` containerNSID` 속성에 대한 새 정보가 포함됩니다.
* [Addressable Audience 지표](https://marketing.adobe.com/resources/help/ko_KR/aam/addressable-audience-metrics.html)에는 수정된 정의 및 콘텐츠 조직이 포함되어 있습니다.
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>“입찰 조정 자동 최적화” 옵션을 사용하면 포트폴리오가 최적화된 경우 Media Optimizer가 포트폴리오에서 광고 그룹에 대한 입찰 조정 설정을 자동으로 변경하여 성능을 최적화할 수 있습니다. Media Optimizer는 Google, Bing 및 Yahoo! Japan의 모바일 장치 타겟, Google 및 Bing의 태블릿과 컴퓨터 타겟, Google RLSA 타겟 및 Google 위치 타겟에 대한 입찰 조정을 최적화할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(최종 URL이 포함된 Bing Merchant Center 계정) "템플릿 추적" 필드는 Bing 쇼핑 템플릿과 일괄 시트의 제품 그룹에서 사용할 수 있습니다. </p> <p>계정, 캠페인 또는 광고 그룹 수준에 추적 템플릿이 있는 경우에는 Media Optimizer 전환 추적을 위해 값을 입력하지 않아도 됩니다. </p> </td> 
  </tr> 
  <tr> 
