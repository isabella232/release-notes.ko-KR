...
* Analytics이 허용하는 내용과 일치하도록 컨텍스트 데이터 키에 대한 유효성 검사가 추가되었습니다. (MOB-7365)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI는 데이터를 분석하고 인사이트를 공유할 수 있는 비즈니스 분석 대시보드 패키지입니다. Power BI와 Adobe Analytics 통합에는 Microsoft Power BI 내에서 Report Builder Analytics 데이터를 시각화하는 기능이 포함되어 있습니다. </p> <p>Power BI를 사용하면 Adobe Analytics을 추가 데이터 소스(예: POS, CRM)와 통합하여 고유한 고객 인사이트, 연관성 및 기회를 발견하고 조직 전체에서 손쉽게 공유할 수 있습니다. Report Builder의 보고서 생성 기능과 Power BI의 기능을 결합하면 조직 내 모든 사람이 정보에 보다 웹에 액세스할 수 있습니다. </p> <p>Adobe Report Builder와의 통합을 통해 다음을 수행할 수 있습니다. </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     <li id="li_CD2EE3675FD045A2B1A2BD960C0F7F2A">Target 활동에 대해 잘못된 데이터를 보고 및 Ad hoc analysis에 보고하는 문제를 수정했습니다. (AN-141435) </li> 
     ...
     <li id="li_74750379709445DC97F22CC212C80E21">보고서 세트에 대해 Ad hoc analysis이 활성화되거나 비활성화되지 않던 Admin Console 문제를 수정했습니다. (AN-142529) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> 지표 가시성이 구성되었지만 지표 극성은 구성되지 않았을 때 발생하는 문제를 수정했습니다. Analysis Workspace의 결과 요약 변경 색상 표시 기능은 예상대로 표시되지 않았습니다(음수일 때는 빨간색, 양수가 되면 녹색). (AN-143496, AN-143413) </li> 
