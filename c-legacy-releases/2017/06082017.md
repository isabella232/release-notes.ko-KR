...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이러한 구성은 함께 사용됩니다. iFrame 및 상위 페이지에 구현된 ID 서비스 코드의 여러 인스턴스가 서로 통신할 수 있도록 해줍니다. 상위 페이지/도메인을 제어할 수 있거나 제어할 수 없고 제어하는 도메인의 iFrame에서 ID 서비스 코드가 로드되는 개의 특정 사용 사례와 관련된 문제를 해결하는 데 도움이 되도록 설계되었습니다. VisitorAPI.js 코드 버전 2.2 이상에서 사용할 수 있습니다. allowParentDomain <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?=mcvid-whitelistdomain.html" format="https" scope="external">및 allowIframeDomain을 참조하십시오 </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
