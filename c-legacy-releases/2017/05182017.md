...
[ID 동기화 및 매치율의 이해](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html)에 ID 서비스에서 ` cm.eversttech.net`에 제공하는 [!DNL  Adobe Media Optimizer] 호출에 대한 새로운 정보가 포함됩니다.
