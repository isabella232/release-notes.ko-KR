...
<table id="table_2D2E3E490C7347399F25F056AC601E39">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>ID 서비스에서 Adobe Marketing Cloud Device Co-op로 데이터를 전송하거나 전송하지 않는지 여부를 결정하는 부울 구성(선택 사항)입니다. <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-coopsafe.html" format="https" scope="external">isCoopSafe</a>를 참조하십시오 . </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 사소한 버그 및 성능 개선 사항은 [Adobe Mobile Services](https://marketing.adobe.com/resources/help/ko_KR/mobile/)를 참조하십시오. 이전 릴리스의 릴리스 노트를 보려면 왼쪽 창에서 *이전 릴리스 노트*를 확장하십시오.
...
8월 22일부터 Adobe Analytics는 모든 고객에 대해 [지역 세분화](https://marketing.adobe.com/resources/help/ko_KR/reference/reports_geosegmentation.html) 보고서를 활성화합니다. 이는 Admin Console에서 지역 세분화 설정이 곧 제거될 것을 예상함에 따라 적용되는 변경 사항입니다.
...
* [조직 ID](https://marketing.adobe.com/resources/help/ko_KR/aam/ids-in-aam.html)와 연결된 사용자는 이제 사용자 이름 및 암호 대신 Adobe ID로 Audience Manager UI에 로그인할 수 있습니다. (AAM-28161)
...
[DIL](https://marketing.adobe.com/resources/help/ko_KR/aam/dil-overview.html)은 Audience Manager에 대한 API 데이터 수집 코드입니다. 8월 릴리스는 DIL을 버전 6.11로 증가시킵니다.

* 새로운 구성 ` isCoopSafe`를 추가했습니다. 이는 DIL이 [!DNL  Adobe Marketing Cloud Device Co-op]로 데이터를 전송하는지 여부를 결정하는 부울 구성(선택 사항)입니다. [isCoopSafe](https://marketing.adobe.com/resources/help/ko_KR/aam/?f=dil-coopsafe.html)를 참조하십시오. (CORE-4334)

**중요한 설명서 업데이트**

Adobe의 DCS(Data Collection Server) API 작업 방법에 대한 설명서를 다시 작성했습니다. [DCS 서버 API 메서드 및 코드](https://marketing.adobe.com/resources/help/ko_KR/aam/dcs-intro.html)로 시작하고 DCS API를 사용하여 복잡한 작업을 수행할 수 있습니다.
...
* [의견 수렴 규칙](https://marketing.adobe.com/resources/help/ko_KR/social/c_settings_rules.html): 규칙은 6개월 후 자동으로 비활성화됩니다. 만료된 규칙은 [!UICONTROL 규칙 빌더]의 [!UICONTROL 비활성] 탭에서 찾을 수 있으며 개별적으로 또는 대량으로 6개월 동안 갱신할 수 있습니다.
...
업데이트 날짜: 2017년 8월 23일(2017년 8월 19일 릴리스용)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Media Optimizer는 이제 Yahoo에서 개발한 Yahoo Gemini 공유 사이트 링크를 동기화하고 사이트 링크 클릭 수로 관련 광고 및 키워드에 대한 수익을 산정합니다. </p> <p>일괄 시트에서 공유 사이트 링크를 편집할 수도 있습니다. "설명" 매개 변수는 아직 지원되지 않지만, Media Optimizer에서 기존 값을 변경하지는 않습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(직접 액세스 클라이언트 관리자 및 관리자에게만 보내기) Media Optimizer를 사용하면 Audience Manager 세그먼트의 메타 데이터, 계층 데이터 및 고유 대상 데이터를 [검색 광고] &gt; [캠페인 베타] &gt; [대상 보기]로 가져올 수 있습니다. 광고주를 설정하려면 [검색 광고] &gt; [관리] &gt; [Audience Manager 설정]에서 Adobe Audience Manager에 대한 광고주의 파트너 ID를 입력합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
