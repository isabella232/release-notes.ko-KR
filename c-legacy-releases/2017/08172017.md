...
8월 22일부터 Adobe Analytics는 데이터 수집 중 받은 모든 히트에서 geo_zip을 결정하기 시작합니다. 이 업데이트는 특히 모바일 장치의 데이터 정확도를 높입니다. 이전에는 방문당 geo_zip이 한 번 설정되었습니다. 이제, geo_zip은 방문자의 방문 중에 올바르게 변경될 수 있습니다. geo_zip 입력란은 보고에는 사용되지 않지만 데이터 피드에는 나타납니다.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이제 데이터 워크벤치 워크스테이션은 사용자 이름과 암호를 통한 사용자 인증을 지원합니다. 관리자는 이 새로운 방법을 사용하여 자신의 사용자 계정을 만들고 관리할 수 있으므로 고객 지원 센터에 문의할 필요가 없습니다. </p> <p>자세한 내용은 <a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_self-provisioning-users.html">사용자의 자체 프로비저닝</a>을 참조하십시오 . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_E89112FD11B2443D98923C8708888194"> 
      ...
      <li id="li_F9201D1E035E49F39C9BA8CED8213723">테이블을 분류 매개 변수로 분류할 때 발생하는 문제를 수정했습니다. eVar와 prop의 이름이 같으므로 분류가 어느 항목에 속하는지 판단하기가 어려웠습니다. 이를 완화하기 위해 컨텍스트 메뉴에 괄호 안의 루트 차원에 대한 정보를 추가했습니다. (AN-146730) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C4E913B41B1E46E7821A312C42FFDADB"> 
      <li id="li_F194FD3B25ED458D81351CAE2F978C87">고객이 사용자가 실행할 수 있는 할당된 예약된 리포트 빌더 보고서의 수를 조정할 수 없는 권한 문제를 수정했습니다. (AN-138801) </li> 
      ...
      <li id="li_6CFDD8DDB0F345A498786663BDC24A40">대상 세그먼트가 Analytics에서 Marketing Cloud로 게시되지 않던 문제를 수정했습니다. (AN-146486) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_41A7B52EFE5A4A2CBBEDC38389E17E13"> 
      <li id="li_89D4145EE47A4C49A209C9DEFA7C3811"> 일광 절약 시간제 전환 시 잘못된 시간에 대해 데이터 웨어하우스 시간별 작업이 생성되는 버그를 수정했습니다(AN-140128). </li> 
...
* 이제 [조직 ID에](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) 연결된 사용자는 사용자 이름과 암호 대신 Adobe ID를 사용하여 Audience Manager UI에 로그인할 수 있습니다. (AAM-28161)
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>2017년 8월 8일에 출시된 AEM 6.3 CFP 6.3.0.2는 2017년 4월 AEM 6.3의 일반 가용성 이후 릴리스된 주요 고객 픽스를 포함하는 중요한 업데이트입니다. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM Forms에서 다음을 위한 템플릿을 시작했습니다. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Adobe에서는 고객 요구 사항을 단순화하고 동일한 정신을 유지하기 위한 끊임 없는 혁신을 통해 완전히 새로운 <a href="https://forums.adobe.com/community/experience-cloud/marketing-cloud/experience-manager?cid=AEMReleaseNoteJuly_1" format="https" scope="external">AEM Community</a>를 제공합니다 . </p> <p> <b>내용</b> ( <a href="https://helpx.adobe.com/content/dam/help/images/Marketing_Cloud/ATCE/AEMCommunity.mov?cid=cid=AEMReleaseNoteJuly_2" format="https" scope="external"> 비디오 </a>) 
     <ul id="ul_59971B55D0D8449FBECDA890CC9B50C4"> 
      ...
      <li id="li_AB94980C51FA4F1896EFFB76671420F3">AEM 리소스 및 지식을 공유합니다. </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Adobe Principal Product Manager인 Cynia Tillo가 제공하는 AEM Dynamic Media 6.3 아키텍처에 대해 알아봅니다. 1시간 세션이 2017년 8월 30일 수요일 오전 8시에 시작됩니다. <a href="https://www.meetup.com/AEM-Technologist-Group/events/241999511/" format="https" scope="external">여기</a>로 답변 주십시오 . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>최근 On-Demand 기술 세션 </p> </td> 
   <td colname="col3"> <p>월별 AEM 커뮤니티 전문가 시리즈 외에 "AEM을 위한 상태 확인 작성" 및 "AEM 배포를 위한 AEM 지속 우수 사례"와 같은 최근 AEM GEM을 모두 확인하십시오. 링크는 <a href="https://www.meetup.com/AEM-Technologist-Group/messages/boards/" format="https" scope="external">여기</a>에 게시됩니다 . </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이제 Adobe Advertising Cloud는 Yahoo에서 만든 Yahoo Gemini 공유 사이트 링크를 동기화하며 사이트 링크 클릭의 매출액을 관련 광고 및 키워드에 연결합니다. </p> <p>또한 대용량 시트에서 공유 사이트 링크를 편집할 수도 있습니다. "설명" 매개 변수는 아직 지원되지 않지만 Advertising Cloud에서는 기존 값을 변경하지 않습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Campaigns Beta 검색 </p> </td> 
   <td colname="col2"> <p>(허용되는 광고주만 베타) 새로운 기능은 다음과 같습니다. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(직접 액세스 클라이언트 관리자 및 관리자만) Adobe Advertising Cloud가 Audience Manager 세그먼트에 대한 메타데이터, 계층 데이터 및 고유한 대상 데이터를 검색 광고(&amp;);gt; 캠페인 베타 &amp;gt; 대상 보기. 광고주를 설정하려면 [검색 광고] &gt; [관리] &gt; [Audience Manager 설정]에서 Adobe Audience Manager에 대한 광고주의 파트너 ID를 입력합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
