...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>("모델을 모델링하고 하루 동안 검색을 최적화하는" 설정이 포함된 포트폴리오) 이제 Adobe Advertising Cloud는 입찰과 캠페인 예산을 변경할 때 매출 데이터를 고려합니다. 이전에는 데이터 클릭만 고려했습니다. </p> <p>이제 하루 중 실적이 높은 시기에 입찰이 증가됩니다. </p> </td> 
  </tr> 
  <tr> 
