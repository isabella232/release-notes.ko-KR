...
Marketing Cloud 솔루션용 [Android SDK 4.x](https://marketing.adobe.com/resources/help/ko_KR/mobile/android/) 및 SDK용 Marketing Cloud 솔루션용 [iOS SDK 4.x 설명서를](https://marketing.adobe.com/resources/help/ko_KR/mobile/ios/) 참조하십시오. 이전 릴리스의 릴리스 노트를 보려면 왼쪽 창에서 *이전 릴리스 노트*&#x200B;를 확장하십시오.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_DE987D7BAD144978AD6D163DD5C6C4FB"> 
      ...
      <li id="li_E40BD69A6A7649F18BB77F48FEB4B94C">고객이 사용자가 실행할 수 있는 할당된 예약된 리포트 빌더 보고서의 수를 조정할 수 없는 권한 문제를 수정했습니다. (AN-138801) </li> 
      <li id="li_E9CFBF452B14454098D23D1B67746BC0">Target과 분석 작업 공간/애드혹 분석용 Analytics 간 타겟 활동 전환에 대한 데이터 불일치를 수정했습니다. (AN-144251, AN-140582) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8C16C6ACD0B54F3CB097A5FC4C2E0FE6"> 
     <li id="li_57D83C770E6D4A7291A4DF790A8F9307">때로 2008 이전의 데이터를 포함한 분류 보고서의 배달을 방해했던 데이터 웨어하우스 문제를 수정했습니다(AN-143591). </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9A3691CC67074D219596D9FF3B2474F5"> 
     ...
     <li id="li_05944EB2B35A4D2D9AF866F324DBD80C">보고 API: 데이터 웨어하우스 보고서를 요청할 때 지표 ID가 null인 문제를 수정했습니다. (AN-145354) </li> 
...
DIL은 Audience Manager에 대한 API 데이터 수집 코드입니다. 7월 릴리스는 DIL을 버전 6.10으로 증가시킵니다. 이 릴리스에는 대상 게시 iFrame 호출의 효율성 향상을 통해 CPU 사용을 줄이는 데 도움이 되는 수정된 코드가 포함되어 있습니다. (MCID-419)
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>2017년 6월 23일 출시된 AEM 6.3 CFP 6.3.0.1은 2017년 4월 AEM 6.3의 일반 가용성 이후 릴리스된 주요 고객 픽스를 포함하는 중요한 업데이트입니다. </p> <p> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   <td colname="col2"> <p>AEM 기술자 회의 그룹 *가상 </p> </td> 
   <td colname="col3"> <p>예정된 AEM Gem을 최신 상태로 유지하고 AEM Community Expert 웨비나 및 로컬 AEM/Marketing Cloud/Experience Cloud 사용자 그룹 회의에 대해 문의하시겠습니까? </p> <p>온라인으로 전 세계에서 직접 이벤트 일정을 잡으려면 <a href="https://www.meetup.com/AEM-Technologist-Group/" format="https" scope="external">AEM 기술자 그룹 *가상</a>에 참여하십시오. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM에 대한 새로운 스트레스 테스트 및 벤치마크 도구에 대해 알아봅니다. On-Demand 방식으로 시청할 수 있습니다. </p> <p> <a href="https://bit.ly/AEMGEM62117" format="http" scope="external"> https://bit.ly/AEMGEM62117 </a> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>("매일 검색 모델링 및 최적화"로 설정된 포트폴리오) 이제 Adobe Advertising Cloud는 비속적인 트렌드에 맞추기 위해 입찰 및 캠페인 예산을 변경할 때 매출 데이터를 고려합니다. 이전에는 데이터 클릭만 고려했습니다. </p> <p>이제 하루 중 실적이 높은 시기에 입찰이 증가됩니다. </p> </td> 
  </tr> 
  <tr> 
